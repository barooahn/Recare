var UniteCssEditorRev = new function () {
    ...
    t.saveStylesInDb = function (handle, new_style, dialog_obj) {
        ...
        jQuery('input[name="css_padding[]"]').each(function (i) {
            data['idle']['padding'][i] = jQuery(this).val();
        });
        ...
        jQuery('input[name="css_border-radius[]"]').each(function (i) {
            data['idle']['border-radius'][i] = jQuery(this).val();
        });
        ...
        jQuery('input[name="hover_css_border-radius[]"]').each(function (i) {
            data['hover']['border-radius'][i] = jQuery(this).val();
        });
    ...
    t.compare_to_original = function () {
        ...
        if (typeof(orig_styles['params']) !== 'undefined') {
            ...
            t.set_state(idle, 'border-radius', 'input[name="css_border-radius[]"]', {
                0: '0',
                1: '0',
                2: '0',
                3: '0'
        ...
        if (typeof(orig_styles['hover']) !== 'undefined' && !jQuery.isEmptyObject(orig_styles['hover'])) {
            ...
            t.set_state(hover, 'border-radius', 'input[name="hover_css_border-radius[]"]', {
                0: '0',
                1: '0',
                2: '0',
                3: '0'
