var UniteAdminRev = new function () {
    ...
    t.showInfo = function (obj) {
        ...
        punchgs.TweenLite.fromTo(nt, 0.5, {
            y: -50,
            autoAlpha: 0,
            transformOrigin: "50% 50%",
            transformPerspective: 900,
            rotationX: -90
        }, {autoAlpha: 1, y: 0, rotationX: 0, ease: punchgs.Back.easeOut, delay: obj.showdelay});

        if (obj.hideon != "event") {
            nt.click(function () {
                punchgs.TweenLite.to(nt, 0.3, {
                    x: 200,
            ...
            if (obj.hidedelay != 0 && obj.hideon != "click")
                punchgs.TweenLite.to(nt, 0.3, {
                    ...
                    ease: punchgs.Power3.easeInOut,
                    autoAlpha: 0,
                    delay: obj.hidedelay + obj.showdelay,
                    onComplete: function () {
                        nt.remove()
                    }
                });
    ...
    t.initGoogleFonts = function () {
            ...
            jQuery('#font-dialog-wrap').dialog({
                ...
                buttons: [{
                    text: 'Add Font', click: function () {
                        ...
                        UniteAdminRev.ajaxRequest("add_google_fonts", data, function (response) {
                        }); //'#eg-font-add',
        ...
        jQuery('body').on('click', '.eg-font-edit', function () {
            if (confirm(rev_lang.really_change_font_sett)) {
                ...
                UniteAdminRev.ajaxRequest("edit_google_fonts", data, function (response) {
                }); //'#eg-font-add, .eg-font-edit, .eg-font-delete',
            }
