    ...
    <div class='wrap'>
        ...
        <div class="title_line" style="margin-bottom:10px">
            ...
            <a id="button_general_settings"
               class="button-secondary float_right mtop_10"><?php _e("Global Settings", 'revslider'); ?></a>
        </div>
        ...
        <div class="rs-dialog-embed-slider" style="display: none;">
            ...
            <div style="margin:5px 0px; padding-left: 55px;">
                <div style="font-size:14px;margin-bottom:10px;">
                    <strong><?php _e("Standard Embeding", 'revslider'); ?></strong></div>
                ...
                <div id="advanced-accord" style="display:none">
                    <?php _e("From the", 'revslider'); ?>
                    <b><?php _e("theme html", 'revslider'); ?></b> <?php _e("use", 'revslider'); ?>: <code>&lt?php
                        putRevSlider( '<span class="rs-example-alias">alias</span>' ); ?&gt</code><br>
                    <span><?php _e("To add the slider only to homepage use", 'revslider'); ?>: <code>&lt?php
                            putRevSlider('<span class="rs-example-alias"><?php echo $exampleID; ?></span>', 'homepage');
                            ?&gt</code></span></br>
                    <span><?php _e("To add the slider on specific pages or posts use", 'revslider'); ?>: <code>&lt?php
                            putRevSlider('<span class="rs-example-alias"><?php echo $exampleID; ?></span>', '2,10');
                            ?&gt</code></span></br>
                </div>
        ...
        if (!$revSliderAsTheme) {
            ...
            <div class="title_line nobgnopd">
                <div class="view_title"><?php _e("Version Information", 'revslider'); ?></div>
            </div>

            <div class="valid_big_padding"
                 style="border-top:1px solid #e5e5e5; padding:15px 15px 15px 80px; position:relative;overflow:hidden;background:#fff;">
                <div class="revgray valid_big_border"
                     style="left:0px;top:0px;position:absolute;height:100%;padding:27px 10px;"><i
                        style="color:#fff;font-size:25px" class="revicon-info-circled"></i></div>

                <?php _e("Installed Version", 'revslider'); ?>: <span
                    class="slidercurrentversion"><?php echo RevSliderGlobals::SLIDER_REVISION; ?></span><br>
                <?php
                if ($validated !== 'true' && version_compare(RevSliderGlobals::SLIDER_REVISION, $stable_version, '<')) {
                    ?>
                    <span class="slideravailableversion"><?php _e("Latest Stable Version", 'revslider'); ?>
                        : <?php echo $stable_version; ?></span><a href="update-core.php?checkforupdates=true"
                                                                  id="rs-check-updates"
                                                                  class="button-primary revpurple"><?php _e('Update to Stable (Free)', 'revslider'); ?></a>
                    <br>
                    <?php
                }
                ?>
                <span class="slideravailableversion"><?php _e("Latest Available Version", 'revslider'); ?>
                    : <?php echo $latest_version; ?></span><a class='button-primary revblue'
                                                              href='?page=revslider&checkforupdates=true'
                                                              id="rev_check_version"><?php _e("Check Version", 'revslider'); ?> </a>
        ...
        <div class="title_line nobgnopd">
            <div class="view_title"><?php _e("Requirements & Recommendations", 'revslider'); ?></div>
        </div>
        <div class="valid_big_padding"
             style="border-top:1px solid #e5e5e5; padding:15px 15px 15px 80px; position:relative;overflow:hidden;background:#fff;">
            <div class="revgray valid_big_border"
                 style="background:#3d566e;left:0px;top:0px;position:absolute;height:100%;padding:27px 10px;"><i
                    style="color:#fff !important;font-size:25px" class="eg-icon-thumbs-up"></i></div>
            ...
            ?> <a class='button-primary revblue' href='?page=revslider&checkforupdates=true' id="rev_check_version_1"
                  style="margin-left:15px"><?php _e("Check Now", 'revslider'); ?></a><br>
        ...
        if (!$revSliderAsTheme) {
            ...
            <div class="title_line nobgnopd">
                <div class="view_title"><span
                        style="margin-right:10px"><?php _e("Need Premium Support and Live Updates ?", 'revslider'); ?></span><a
                        style="vertical-align:middle" class='button-primary revblue' href='#'
                        id="benefitsbutton"><?php _e("Why is this Important ?", 'revslider'); ?> </a></div>
            </div>

            <div id="benefitscontent" class="valid_big_padding"
                 style="margin-top:10px;margin-bottom:10px;display:none;border:1px solid #e5e5e5; padding:15px 15px 15px 80px; position:relative;overflow:hidden;background-color:#fff;">
                <div class="revblue" style="left:0px;top:0px;position:absolute;height:100%;padding:27px 10px;"><i
                        style="color:#fff;font-size:25px" class="revicon-doc"></i></div>
                <h3> <?php _e("Benefits", 'revslider'); ?>:</h3>

                <p>
                    <strong><?php _e("Get Premium Support", 'revslider'); ?></strong><?php _e(" - We help you in case of Bugs, installation problems, and Conflicts with other plugins and Themes", 'revslider'); ?>
                    <br>
            ...
            VALIDATION
            -->
            <div id="tp-validation-box" class="valid_big_padding"
                 style="cursor:pointer; border-top:1px solid #e5e5e5; padding:15px 15px 15px 80px; position:relative;overflow:hidden;background:#fff">
            ...
            -->
            <div class="title_line nobgnopd">
                <div class="view_title"><?php _e("Information", 'revslider'); ?></div>
            </div>
        ...
        <!-- NEWSLETTER PART -->
        <div class="title_line nobgnopd">
            <div class="view_title"><span style="margin-right:10px"><?php _e('Newsletter', 'revslider'); ?></span><a
                    style="vertical-align:middle" class='button-primary revred' href='#'
                    id="why-subscribe"><?php _e("Why subscribe?", 'revslider'); ?></a></div>
        </div>

        <div id="eg-newsletter-wrapper">
            <div class="revred valid_big_border"
                 style="left:0px;top:0px;position:absolute;height:100%;padding:27px 10px;"><i style="font-size:25px"
                                                                                              class="iconttowhite eg-icon-mail"></i>
            </div>
            <div class="rtlmargintop105" style="margin-top:65px; margin-bottom:5px;">
                <span id="unsubscribe-text"
                      style="display: none;"><?php _e("Unsubscribe our newsletter", 'revslider'); ?></span><span
                    id="subscribe-text"><?php _e("Subscribe to our newsletter", 'revslider'); ?></span>: <input
                    type="text" value="" placeholder="<?php _e('Enter your E-Mail here', 'revslider'); ?>"
                    name="rs-email" style="width: 170px;"/>
                <span class="subscribe-newsletter-wrap"><a href="javascript:void(0);" class="button-primary revgreen"
                                                           id="subscribe-to-newsletter"><?php _e('Subscribe', 'revslider'); ?></a></span>
			<span class="unsubscribe-newsletter-wrap" style="display: none;">
				<a href="javascript:void(0);" class="button-primary revred"
                   id="unsubscribe-to-newsletter"><?php _e('Unsubscribe', 'revslider'); ?></a>
				<a href="javascript:void(0);" class="button-primary revgreen"
                   id="cancel-unsubscribe"><?php _e('Cancel', 'revslider'); ?></a>
			</span>
            </div>
            <a href="javascript:void(0);" id="activate-unsubscribe"
               style="font-size: 12px; color: #999; text-decoration: none;"><?php _e('unsubscibe from newsletter', 'revslider'); ?></a>

            <div id="why-subscribe-wrapper" style="display: none;">
                <div class="star_red"><strong
                        style="font-weight:700"><?php _e('Perks of subscribing to our Newsletter', 'revslider'); ?></strong>
                </div>
                <ul>
        ...
        <div class="title_line nobgnopd">
            <div class="view_title"><span style="margin-right:10px"><?php _e("Update History", 'revslider'); ?></span>
            </div>
        </div>

        <div class="valid_big_padding_2"
             style="border-top:1px solid #e5e5e5;  height:500px;padding:25px 15px 15px 80px; position:relative;overflow:hidden;background:#fff">
            <div class="revpurple valid_big_border"
                 style="left:0px;top:0px;position:absolute;height:100%;padding:27px 10px;"><i style="font-size:27px"
                                                                                              class="iconttowhite eg-icon-back-in-time"></i>
            </div>
            <div
                style="height:485px;overflow:scroll;width:100%;"><?php echo file_get_contents(RS_PLUGIN_PATH . 'release_log.html'); ?></div>
        </div>
    </div>

    <!-- Import slider dialog -->
    <div id="dialog_import_slider" title="<?php _e("Import Slider", 'revslider'); ?>" class="dialog_import_slider"
         style="display:none">
        <form action="<?php echo RevSliderBase::$url_ajax; ?>" enctype="multipart/form-data" method="post">
            ...
            <br><br>
            <span
                style="font-weight: 700;"><?php _e("Note: styles templates will be updated if they exist!", 'revslider'); ?></span><br><br>
            <table>
                <tr>
                    <td><?php _e("Custom Animations:", 'revslider'); ?></td>
                    <td><input type="radio" name="update_animations" value="true"
                               checked="checked"> <?php _e("overwrite", 'revslider'); ?></td>
                    <td><input type="radio" name="update_animations" value="false"> <?php _e("append", 'revslider'); ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td><input type="radio" name="update_navigations" value="true"
                               checked="checked"> <?php _e("overwrite", 'revslider'); ?></td>
                    <td><input type="radio" name="update_navigations" value="false"> <?php _e("append", 'revslider'); ?>
                    </td>
                </tr>
                <tr>
                    <td><?php _e("Static Styles:", 'revslider'); ?></td>
                    <td><input type="radio" name="update_static_captions"
                               value="true"> <?php _e("overwrite", 'revslider'); ?></td>
                    <td><input type="radio" name="update_static_captions"
                               value="false"> <?php _e("append", 'revslider'); ?></td>
                    <td><input type="radio" name="update_static_captions" value="none"
                               checked="checked"> <?php _e("ignore", 'revslider'); ?></td>
                </tr>
            </table>
            <br><br>
            <input type="submit" class="button-primary revblue tp-be-button rev-import-slider-button"
                   style="display: none;" value="<?php _e("Import Slider", 'revslider'); ?>">
        </form>
    </div>


    <div id="dialog_duplicate_slider" class="dialog_duplicate_layer" title="<?php _e('Duplicate', 'revslider'); ?>"
         style="display:none;">
        <div style="margin-top:14px">
            <span style="margin-right:15px"><?php _e('Title:', 'revslider'); ?></span><input id="rs-duplicate-animation"
                                                                                             type="text"
