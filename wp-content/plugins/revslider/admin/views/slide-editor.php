...
<script type="text/javascript">
	...
	if(!empty($googleFont)){
		if(is_array($googleFont)){
			foreach($googleFont as $key => $font){
				?>sgfamilies.push('<?php echo esc_attr($font); ?>');
    <?php
			}
		}else{
			?>sgfamilies.push('<?php echo esc_attr($googleFont); ?>');
    <?php
		}
	}
	...
	foreach($gf as $gfk => $gfv){
		...
		?>sgfamilies.push('<?php echo esc_attr($tcf); ?>');
    <?php
	}
...
<div class="wrap settings_wrap">
    ...
    <div class="title_line" style="margin-bottom:0px !important;">
        ...
        <a href="<?php echo RevSliderGlobals::LINK_HELP_SLIDE; ?>"
           class="button-primary float_right revblue mtop_10 mleft_10"
           target="_blank"><?php _e("Help", 'revslider'); ?></a>
    ...
    <div class="rs_breadcrumbs">
        ...
        <a class='breadcrumb-button'
           href="<?php echo self::getViewUrl(RevSliderAdmin::VIEW_SLIDER, "id=$sliderID"); ?>"><i
                class="eg-icon-cog"></i><?php _e('Slider Settings', 'revslider'); ?></a>
        <a class='breadcrumb-button selected' href="#"><i
                class="eg-icon-pencil-2"></i><?php _e('Slide Editor ', 'revslider'); ?>
            "<?php echo ' ' . $slider->getParam("title", ""); ?>"</a>
        ...
        <div class="rs-mini-toolbar">
            ...
            <div class="rs-toolbar-savebtn rs-mini-toolbar-button">
                <a class='button-primary revgreen' href='javascript:void(0)' id="<?php echo $savebtnid; ?>"><i
                        class="rs-icon-save-light"
                        style="display: inline-block;vertical-align: middle;width: 18px;height: 20px;background-repeat: no-repeat;"></i><span
                        class="mini-toolbar-text"><?php _e("Save Slide", 'revslider'); ?></span></a>
            </div>

            <div class="rs-toolbar-cssbtn rs-mini-toolbar-button">
                <a class='button-primary revpurple' href='javascript:void(0)' id='button_edit_css_global'><i class="">
                        &lt;/&gt;</i><span class="mini-toolbar-text"><?php _e("CSS Global", 'revslider'); ?></span></a>
            </div>
            ...
            <div class="rs-toolbar-slides rs-mini-toolbar-button">
                ...
                ?>
                <a class="button-primary revblue" href="<?php echo self::getViewUrl($slider_url, "id=$sliderID"); ?>"
                   id="link_edit_slides_t"><i class="revicon-cog"></i><span
                        class="mini-toolbar-text"><?php _e("Slider Settings", 'revslider'); ?></span> </a>

            </div>
            <div class="rs-toolbar-preview rs-mini-toolbar-button">
                <a class="button-primary revgray" href="javascript:void(0)" id="<?php echo $prevbtn; ?>"><i
    ...
    <div class="edit_slide_wrapper<?php echo ($slide->isStaticSlide()) ? ' rev_static_layers' : ''; ?>">
        ...
        <div id="dialog_template_insert" class="dialog_template_help" title="<?php _e('Insert Meta', 'revslider') ?>"
             style="display:none;">
            <ul class="rs-template-settings-tabs">
                ...
                switch ($slider_type) {
                    ...
                    case 'woocommerce':
                        ?>
                        <li data-content="#slide-post-template-entry" class="selected"><i style="height:45px"
                                                                                          class="rs-mini-layer-icon revicon-doc rs-toolbar-icon"></i><span><?php _e('Post', 'revslider'); ?></span>
                        </li>
                        <?php
                        if (RevSliderWooCommerce::isWooCommerceExists()) {
                            ?>
                            <li data-content="#slide-woocommerce-template-entry" class="selected"><i style="height:45px"
                                                                                                     class="rs-mini-layer-icon revicon-doc rs-toolbar-icon"></i><span><?php _e('WooCommerce', 'revslider'); ?></span>
                            </li>
                            <?php
                        }
                        if (RevSliderEventsManager::isEventsExists()) {
                            ?>
                            <li data-content="#slide-events-template-entry" class="selected"><i style="height:45px"
                                                                                                class="rs-mini-layer-icon revicon-doc rs-toolbar-icon"></i><span><?php _e('Events', 'revslider'); ?></span>
                            </li>
                            <?php
                        }
                        break;
                    case 'flickr':
                        ...
                        <li data-content="#slide-flickr-template-entry" class="selected"><i style="height:45px"
                                                                                            class="rs-mini-layer-icon eg-icon-flickr rs-toolbar-icon"></i><span><?php _e('Flickr', 'revslider'); ?></span>
                        </li>
                        <?php
                        break;
                    case 'instagram':
                        ...
                        <li data-content="#slide-instagram-template-entry" class="selected"><i style="height:45px"
                                                                                               class="rs-mini-layer-icon eg-icon-info rs-toolbar-icon"></i><span><?php _e('Instagram', 'revslider'); ?></span>
                        </li>
                        <?php
                        break;
                    case 'twitter':
                        ...
                        <li data-content="#slide-twitter-template-entry" class="selected"><i style="height:45px"
                                                                                             class="rs-mini-layer-icon eg-icon-twitter rs-toolbar-icon"></i><span><?php _e('Twitter', 'revslider'); ?></span>
                        </li>
                        <?php
                        break;
                    case 'facebook':
                        ...
                        <li data-content="#slide-facebook-template-entry" class="selected"><i style="height:45px"
                                                                                              class="rs-mini-layer-icon eg-icon-facebook rs-toolbar-icon"></i><span><?php _e('Facebook', 'revslider'); ?></span>
                        </li>
                        <?php
                        break;
                    case 'youtube':
                        ...
                        <li data-content="#slide-youtube-template-entry" class="selected"><i style="height:45px"
                                                                                             class="rs-mini-layer-icon eg-icon-youtube rs-toolbar-icon"></i><span><?php _e('YouTube', 'revslider'); ?></span>
                        </li>
                        <?php
                        break;
                    case 'vimeo':
                        ...
                        <li data-content="#slide-vimeo-template-entry" class="selected"><i style="height:45px"
                                                                                           class="rs-mini-layer-icon eg-icon-vimeo rs-toolbar-icon"></i><span><?php _e('Vimeo', 'revslider'); ?></span>
                        </li>
                        <?php
                        break;
                }
                ?>
                <li data-content="#slide-images-template-entry" class="selected"><i style="height:45px"
                                                                                    class="rs-mini-layer-icon eg-icon-picture-1 rs-toolbar-icon"></i><span><?php _e('Images', 'revslider'); ?></span>
                </li>
            </ul>
            ...
            switch ($slider_type) {
                ...
                case 'woocommerce':
                    ...
                    <table class="table_template_help" id="slide-images-template-entry" style="display: none;">
                        ...
                        foreach ($img_sizes as $img_handle => $img_name) {
                            ...
                            <tr>
                                <td>
                                    <a href="javascript:UniteLayersRev.insertTemplate('featured_image_url_<?php echo $img_handle; ?>')">{{featured_image_url_<?php echo $img_handle; ?>
                                        }}</a></td>
                                <td><?php _e("Featured Image URL", 'revslider');
                                    echo ' ' . $img_name; ?></td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="javascript:UniteLayersRev.insertTemplate('featured_image_<?php echo $img_handle; ?>')">{{featured_image_<?php echo $img_handle; ?>
                                        }}</a></td>
                                <td><?php _e("Featured Image &lt;img /&gt;", 'revslider');
                                    echo ' ' . $img_name; ?></td>
                            </tr>
                            <?php
                        }
                    ...
                    <table class="table_template_help" id="slide-woocommerce-template-entry" style="display: none;">
                        <tr>
                            <td><a href="javascript:UniteLayersRev.insertTemplate('wc_sku')">{{wc_sku}}</a></td>
                            <td><?php _e("SKU", 'revslider') ?></td>
                        </tr>
                        <tr>
                            <td>
                                <a href="javascript:UniteLayersRev.insertTemplate('wc_full_price')">{{wc_full_price}}</a>
                            </td>
                            <td><?php _e("Full Price", 'revslider') ?></td>
                        </tr>
                        <tr>
                            <td><a href="javascript:UniteLayersRev.insertTemplate('wc_price')">{{wc_price}}</a></td>
                            <td><?php _e("Single Price", 'revslider') ?></td>
                        </tr>
                        <tr>
                            <td><a href="javascript:UniteLayersRev.insertTemplate('wc_price_no_cur')">{{wc_price_no_cur}}</a>
                            </td>
                            <td><?php _e("Single Price without currency", 'revslider') ?></td>
                        </tr>
                        <tr>
                            <td><a href="javascript:UniteLayersRev.insertTemplate('wc_stock')">{{wc_stock}}</a></td>
                            <td><?php _e("In Stock", 'revslider') ?></td>
                        </tr>
                        <tr>
                            <td><a href="javascript:UniteLayersRev.insertTemplate('wc_stock_quantity')">{{wc_stock_quantity}}</a>
                            </td>
                            <td><?php _e("Stock Quantity", 'revslider') ?></td>
                        </tr>
                        <tr>
                            <td><a href="javascript:UniteLayersRev.insertTemplate('wc_rating_count')">{{wc_rating_count}}</a>
                            </td>
                            <td><?php _e("Number of Ratings", 'revslider') ?></td>
                        </tr>
                        <tr>
                            <td><a href="javascript:UniteLayersRev.insertTemplate('wc_review_count')">{{wc_review_count}}</a>
                            </td>
                            <td><?php _e("Number of Reviews", 'revslider') ?></td>
                        </tr>
                        <tr>
                            <td><a href="javascript:UniteLayersRev.insertTemplate('wc_rating')">{{wc_rating}}</a></td>
                            <td><?php _e("Text Rating", 'revslider') ?></td>
                        </tr>
                        <tr>
                            <td>
                                <a href="javascript:UniteLayersRev.insertTemplate('wc_star_rating')">{{wc_star_rating}}</a>
                            </td>
                            <td><?php _e("Star Rating", 'revslider') ?></td>
                        </tr>
                        <tr>
                            <td>
                                <a href="javascript:UniteLayersRev.insertTemplate('wc_categories')">{{wc_categories}}</a>
                            </td>
                            <td><?php _e("Categories", 'revslider') ?></td>
                        </tr>
                        <tr>
                            <td><a href="javascript:UniteLayersRev.insertTemplate('wc_tags')">{{wc_tags}}</a></td>
                            <td><?php _e("Tags", 'revslider') ?></td>
                        </tr>
                        <tr>
                            <td>
                                <a href="javascript:UniteLayersRev.insertTemplate('wc_add_to_cart')">{{wc_add_to_cart}}</a>
                            </td>
                            <td><?php _e("Add to Cart URL", 'revslider') ?></td>
                        </tr>
                        <tr>
                            <td><a href="javascript:UniteLayersRev.insertTemplate('wc_add_to_cart_button')">{{wc_add_to_cart_button}}</a>
                            </td>
                            <td><?php _e("Add to Cart Button", 'revslider') ?></td>
                        </tr>
                    </table>
                <?php } else { ?>
                    <?php if (RevSliderEventsManager::isEventsExists()) { ?>
                        <table class="table_template_help" id="slide-events-template-entry" style="display: none;">
                            <tr>
                                <td><a href="javascript:UniteLayersRev.insertTemplate('event_start_date')">{{event_start_date}}</a>
                                </td>
                                <td><?php _e("Event start date", 'revslider') ?></td>
                            </tr>
                            <tr>
                                <td><a href="javascript:UniteLayersRev.insertTemplate('event_end_date')">{{event_end_date}}</a>
                                </td>
                                <td><?php _e("Event end date", 'revslider') ?></td>
                            </tr>
                            <tr>
                                <td><a href="javascript:UniteLayersRev.insertTemplate('event_start_time')">{{event_start_time}}</a>
                                </td>
                                <td><?php _e("Event start time", 'revslider') ?></td>
                            </tr>
                            <tr>
                                <td><a href="javascript:UniteLayersRev.insertTemplate('event_end_time')">{{event_end_time}}</a>
                                </td>
                                <td><?php _e("Event end time", 'revslider') ?></td>
                            </tr>
                            <tr>
                                <td><a href="javascript:UniteLayersRev.insertTemplate('event_event_id')">{{event_event_id}}</a>
                                </td>
                                <td><?php _e("Event ID", 'revslider') ?></td>
                            </tr>
                            <tr>
                                <td><a href="javascript:UniteLayersRev.insertTemplate('event_location_name')">{{event_location_name}}</a>
                                </td>
                                <td><?php _e("Event location name", 'revslider') ?></td>
                            </tr>
                            <tr>
                                <td><a href="javascript:UniteLayersRev.insertTemplate('event_location_slug%')">{{event_location_slug}}</a>
                                </td>
                                <td><?php _e("Event location slug", 'revslider') ?></td>
                            </tr>
                            <tr>
                                <td><a href="javascript:UniteLayersRev.insertTemplate('event_location_address')">{{event_location_address}}</a>
                                </td>
                                <td><?php _e("Event location address", 'revslider') ?></td>
                            </tr>
                            <tr>
                                <td><a href="javascript:UniteLayersRev.insertTemplate('event_location_town')">{{event_location_town}}</a>
                                </td>
                                <td><?php _e("Event location town", 'revslider') ?></td>
                            </tr>
                            <tr>
                                <td><a href="javascript:UniteLayersRev.insertTemplate('event_location_state')">{{event_location_state}}</a>
                                </td>
                                <td><?php _e("Event location state", 'revslider') ?></td>
                            </tr>
                            <tr>
                                <td><a href="javascript:UniteLayersRev.insertTemplate('event_location_postcode')">{{event_location_postcode}}</a>
                                </td>
                                <td><?php _e("Event location postcode", 'revslider') ?></td>
                            </tr>
                            <tr>
                                <td><a href="javascript:UniteLayersRev.insertTemplate('event_location_region')">{{event_location_region}}</a>
                                </td>
                                <td><?php _e("Event location region", 'revslider') ?></td>
                            </tr>
                            <tr>
                                <td><a href="javascript:UniteLayersRev.insertTemplate('event_location_country')">{{event_location_country}}</a>
                                </td>
                                <td><?php _e("Event location country", 'revslider') ?></td>
                            </tr>
                        </table>
                    <?php }
                }
                ...
                case 'flickr':
                    ...
                    <table class="table_template_help" id="slide-images-template-entry" style="display: none;">
                        ...
                        foreach ($img_sizes as $img_handle => $img_name) {
                            ...
                            <tr>
                                <td>
                                    <a href="javascript:UniteLayersRev.insertTemplate('image_url_<?php echo sanitize_title($img_handle); ?>')">{{image_url_<?php echo sanitize_title($img_handle); ?>
                                        }}</a></td>
                                <td><?php _e("Image URL", 'revslider');
                                    echo ' ' . $img_name; ?></td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="javascript:UniteLayersRev.insertTemplate('image_<?php echo sanitize_title($img_handle); ?>')">{{image_<?php echo sanitize_title($img_handle); ?>
                                        }}</a></td>
                                <td><?php _e("Image &lt;img /&gt;", 'revslider');
                                    echo ' ' . $img_name; ?></td>
                            </tr>
                            <?php
                        }
                ...
                case 'instagram':
                    ...
                    <table class="table_template_help" id="slide-instagram-template-entry" style="display: none;">
                        <tr>
                            <td><a href="javascript:UniteLayersRev.insertTemplate('title')">{{title}}</a></td>
                            <td><?php _e("Title", 'revslider'); ?></td>
                        </tr>
                        <tr>
                            <td><a href="javascript:UniteLayersRev.insertTemplate('content')">{{content}}</a></td>
                            <td><?php _e("Content", 'revslider'); ?></td>
                        </tr>
                        <tr>
                            <td><a href="javascript:UniteLayersRev.insertTemplate('link')">{{link}}</a></td>
                            <td><?php _e("Link", 'revslider'); ?></td>
                        </tr>
                        <tr>
                            <td><a href="javascript:UniteLayersRev.insertTemplate('date')">{{date}}</a></td>
                            <td><?php _e("Date created", 'revslider'); ?></td>
                        ...
                        <tr>
                            ...
                            <td><?php _e('Number of Likes', 'revslider'); ?></td>
                        </tr>
                        <tr>
                            <td><a href="javascript:UniteLayersRev.insertTemplate('num_comments')">{{num_comments}}</a>
                            </td>
                ...
                case 'twitter':
                    ...
                    <table class="table_template_help" id="slide-twitter-template-entry" style="display: none;">
                        ...
                        <tr>
                            ...
                            <td><?php _e('Pulbishing Date', 'revslider'); ?></td>
                        </tr>
                        <tr>
                            <td><a href="javascript:UniteLayersRev.insertTemplate('author_name')">{{author_name}}</a>
                            </td>
                ...
                case 'facebook':
                    ...
                    <table class="table_template_help" id="slide-facebook-template-entry" style="display: none;">
                        ...
                        <tr>
                            ...
                            <td><?php _e('Last Modify Date', 'revslider'); ?></td>
                        </tr>
                        <tr>
                            <td><a href="javascript:UniteLayersRev.insertTemplate('author_name')">{{author_name}}</a>
                            </td>
                ...
                case 'youtube':
                    ...
                    <table class="table_template_help" id="slide-youtube-template-entry" style="display: none;">
                        ...
                        <tr>
                            <td><a href="javascript:UniteLayersRev.insertTemplate('excerpt')">{{excerpt}}</a></td>
                            <td><?php _e('Excerpt', 'revslider'); ?></td>
                        </tr>
                        <tr>
                            <td><a href="javascript:UniteLayersRev.insertTemplate('content')">{{content}}</a></td>
                            <td><?php _e('Content', 'revslider'); ?></td>
                ...
                case 'vimeo':
                    ...
                    <table class="table_template_help" id="slide-vimeo-template-entry" style="display: none;">
                        ...
                        <tr>
                            <td><a href="javascript:UniteLayersRev.insertTemplate('views')">{{views}}</a></td>
                            <td><?php _e('Number of Views', 'revslider'); ?></td>
                        </tr>
                        <tr>
                            <td><a href="javascript:UniteLayersRev.insertTemplate('num_comments')">{{num_comments}}</a>
                            </td>
        ...
        <div id="dialog_advanced_css" class="dialog_advanced_css" title="<?php _e('Advanced CSS', 'revslider'); ?>"
             style="display:none;">
            <div style="display: none;"><span id="rev-example-style-layer">example</span></div>
            <div class="first-css-area">
                <span class="advanced-css-title"
                      style="background:#e67e22"><?php _e('Style from Options', 'revslider'); ?><span
                        style="margin-left:15px;font-size:11px;font-style:italic">(<?php _e('Editable via Option Fields, Saved in the Class:', 'revslider'); ?>
            ...
            <div class="second-css-area">
                <span class="advanced-css-title"><?php _e('Additional Custom Styling', 'revslider'); ?><span
                        style="margin-left:15px;font-size:11px;font-style:italic">(<?php _e('Appended in the Class:', 'revslider'); ?>
                        <span class="current-advance-edited-class"></span>)</span></span>
                <textarea id="textarea_advanced_css_editor" rows="20" cols="81"></textarea>
            </div>
        </div>

        <div id="dialog_save_as_css" class="dialog_save_as_css" title="<?php _e('Save As', 'revslider'); ?>"
             style="display:none;">
            <div style="margin-top:14px">
                <span style="margin-right:15px"><?php _e('Save As:', 'revslider'); ?></span><input id="rs-save-as-css"
                                                                                                   type="text"
                                                                                                   name="rs-save-as-css"
                                                                                                   value=""/>
            </div>
        ...
        <div id="dialog_rename_css" class="dialog_rename_css" title="<?php _e('Rename CSS', 'revslider'); ?>"
             style="display:none;">
            <div style="margin-top:14px">
                <span style="margin-right:15px"><?php _e('Rename to:', 'revslider'); ?></span><input id="rs-rename-css"
                                                                                                     type="text"
                                                                                                     name="rs-rename-css"
                                                                                                     value=""/>
            </div>
        ...
        <div id="dialog_advanced_layer_css" class="dialog_advanced_layer_css"
             title="<?php _e('Layer Inline CSS', 'revslider'); ?>" style="display:none;">
            <div class="first-css-area">
                <span class="advanced-css-title"
                      style="background:#e67e22"><?php _e('Advanced Custom Styling', 'revslider'); ?><span
                        style="margin-left:15px;font-size:11px;font-style:italic">(<?php _e('Appended Inline to the Layer Markup', 'revslider'); ?>
                        )</span></span>
                <textarea id="textarea_template_css_editor_layer" name="textarea_template_css_editor_layer"></textarea>
            </div>
        </div>

        <div id="dialog_save_as_animation" class="dialog_save_as_animation" title="<?php _e('Save As', 'revslider'); ?>"
             style="display:none;">
            <div style="margin-top:14px">
                <span style="margin-right:15px"><?php _e('Save As:', 'revslider'); ?></span><input
                    id="rs-save-as-animation" type="text" name="rs-save-as-animation" value=""/>
            </div>
        </div>

        <div id="dialog_save_animation" class="dialog_save_animation" title="<?php _e('Save Under', 'revslider'); ?>"
             style="display:none;">
            <div style="margin-top:14px">
                <span style="margin-right:15px"><?php _e('Save Under:', 'revslider'); ?></span><input
...
-->
    ...
    <div id="dialog_rename_animation" class="dialog_rename_animation"
         title="<?php _e('Rename Animation', 'revslider'); ?>" style="display:none;">
        <div style="margin-top:14px">
            <span style="margin-right:15px"><?php _e('Rename to:', 'revslider'); ?></span><input
                id="rs-rename-animation" type="text" name="rs-rename-animation" value=""/>
        </div>
    </div>
