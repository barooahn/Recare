...
<div id="dialog_video" class="dialog-video" title="<?php _e('Add Video Layout', 'revslider'); ?>" style="display:none">
    ...
    <form name="video_dialog_form" onkeypress="return event.keyCode != 13;">
        ...
        <div id="video-dialog-wrap">
            <div id="video_dialog_tabs" class="box-closed tp-accordion disabled"
                 style="border-bottom:5px solid #ddd; background:#fff">
                <ul class="rs-layer-settings-tabs">
                    <li data-content="#rs-video-source" id="reset_video_dialog_tab" class="selected"><i
                            style="height:45px"
                            class="rs-mini-layer-icon eg-icon-export rs-toolbar-icon"></i><?php _e('Source', 'revslider'); ?>
                    </li>
                    <li data-content="#rs-video-size"><i style="height:45px; font-size:16px"
                                                         class="rs-mini-layer-icon eg-icon-resize-full-alt rs-toolbar-icon"></i><?php _e('Sizing', 'revslider'); ?>
                    </li>
                    <li data-content="#rs-video-settings"><i style="height:45px; font-size:16px"
                                                             class="rs-mini-layer-icon eg-icon-cog rs-toolbar-icon"></i><?php _e('Settings', 'revslider'); ?>
                    </li>
                    <li data-content="#rs-video-thumbnails"><i style="height:45px; font-size:16px"
                                                               class="rs-mini-layer-icon eg-icon-eye rs-toolbar-icon"></i><?php _e('Visibility', 'revslider'); ?>
                    </li>
                    <li data-content="#rs-video-arguments"><i style="height:45px; font-size:16px"
                                                              class="rs-mini-layer-icon eg-icon-th rs-toolbar-icon"></i><?php _e('Arguments', 'revslider'); ?>
                    </li>
                </ul>
        ...
        <div id="rs-video-source">
            ...
            <div id="video_block_vimeo" class="video-select-block" style="display:none;">
                ...
                <img id="vimeo_loader" src="<?php echo RS_PLUGIN_URL; ?>/admin/assets/images/loader.gif"
                     style="display:none">
            </div>
            ...
            <div id="video_block_youtube" class="video-select-block">
                ...
                <input type="button" style="vertical-align:middle" id="button_youtube_search"
                       class="button-regular video_search_button" value="search">
                <span class="video_example"><?php _e('example', 'revslider'); ?>
                    : <?php echo RevSliderGlobals::YOUTUBE_EXAMPLE_ID; ?></span>
                <img id="youtube_loader" src="<?php echo RS_PLUGIN_URL; ?>/admin/assets/images/loader.gif"
                     style="display:none">
            </div>
            ...
            <div id="video_block_html5" class="video-select-block" style="display:none;">
				...
				<span class="imgsrcchanger-div" style="margin-left:20px;">
					<a href="javascript:void(0)"
                       class="button-image-select-html5-video button-primary revblue"><?php _e('Set Image', 'revslider'); ?></a>
				</span>
				...
				<span class="vidsrcchanger-div" style="margin-left:20px;">
					<a href="javascript:void(0)" data-inptarget="html5_url_mp4"
                       class="button_change_video button-primary revblue"><?php _e('Set Video', 'revslider'); ?></a>
				</span>
        ...
        <div id="rs-video-settings" style="display:none">
            ...
            <div class="mb10">
                ...
                <input type="text" id="input_video_start_at"
                       style="width: 50px;"> <?php _e('i.e.: 0:17', 'revslider'); ?>
            </div>
        ...
        <div id="rs-video-arguments" style="display:none">
            <div>
                ...
                <input type="text" id="input_video_arguments" style="width:350px;" value=""
                       data-youtube="<?php echo RevSliderGlobals::DEFAULT_YOUTUBE_ARGUMENTS; ?>"
                       data-vimeo="<?php echo RevSliderGlobals::DEFAULT_VIMEO_ARGUMENTS; ?>">
            </div>
        </div>
        ...
        <div class="add-button-wrapper" style="margin-left:25px;">
            <a href="javascript:void(0)" class="button-primary revblue" id="button-video-add"
               data-textadd="<?php _e('Add This Video', 'revslider'); ?>"
               data-textupdate="<?php _e('Update Video', 'revslider'); ?>"><?php _e('Add This Video', 'revslider'); ?></a>
        </div>
    </form>
</div>