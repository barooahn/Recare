...
<div class="wrap settings_wrap">
    ...
    <div class="title_line" style="margin-bottom:0px !important">
        ...
        <div
            class="view_title"><?php echo ($is_edit) ? __("Edit Slider", 'revslider') : __("New Slider", 'revslider'); ?></div>
        <a href="<?php echo RevSliderGlobals::LINK_HELP_SLIDER; ?>"
           class="button-secondary float_right mtop_10 mleft_10" target="_blank"><?php _e("Help", 'revslider'); ?></a>
    ...
    <div class="rs_breadcrumbs">
        <div class="rs-breadcrumbs-wrapper">
            <a class='breadcrumb-button' href='<?php echo self::getViewUrl("sliders"); ?>'><i
                    class="eg-icon-th-large"></i><?php _e("All Sliders", 'revslider'); ?></a>
            <a class='breadcrumb-button selected' href="#"><i
                    class="eg-icon-cog"></i><?php _e('Slider Settings', 'revslider'); ?></a>
            <a class='breadcrumb-button' href="<?php echo $linksEditSlides; ?>"><i
                    class="eg-icon-pencil-2"></i><?php _e('Slide Editor', 'revslider'); ?></a>
        ...
        <div class="rs-mini-toolbar">
            <div class="rs-mini-toolbar-button rs-toolbar-savebtn">
                <a class='button-primary revgreen' href='javascript:void(0)' id="button_save_slider_t"><i
                        ...
                        class="mini-toolbar-text"><?php _e("Save Settings", 'revslider'); ?></span></a>
                <span id="loader_update_t" class="loader_round"
                      style="display:none;background-color:#27AE60 !important; color:#fff;padding: 5px 5px 6px 25px;margin-right: 5px;"><?php _e("updating...", 'revslider'); ?> </span>
            ...
            if (isset($linksEditSlides)) {
                ...
                <div class="rs-mini-toolbar-button rs-toolbar-slides">
                    <a class="button-primary revblue" href="<?php echo $linksEditSlides; ?>" id="link_edit_slides_t"><i
                            class="revicon-pencil-1"></i><span
                            class="mini-toolbar-text"><?php _e("Edit Slides", 'revslider'); ?></span></a>
                </div>
                <?php
            }
            ?>
            <div class="rs-mini-toolbar-button  rs-toolbar-preview">
                <a class="button-primary revgray" href="javascript:void(0)" id="button_preview_slider_t"><i
                        ...
                        class="mini-toolbar-text"><?php _e("Preview", 'revslider'); ?></span></a>
            </div>
            <div class="rs-mini-toolbar-button  rs-toolbar-delete">
                <a class='button-primary revred' id="button_delete_slider_t" href='javascript:void(0)'><i
                        ...
                        class="mini-toolbar-text"><?php _e("Delete Slider", 'revslider'); ?></span></a>
            </div>
            <div class="rs-mini-toolbar-button  rs-toolbar-close">
                <a class='button-primary revyellow' id="button_close_slider_edit_t"
                   href='<?php echo self::getViewUrl("sliders"); ?>'><i class="eg-icon-th-large"></i><span
                        class="mini-toolbar-text"><?php _e("All Sliders", 'revslider'); ?></span></a>
            </div>
        </div>
    </div>
    <script>
        ...
        <div class="settings_panel_left settings_wrapper">
            <form name="form_slider_main" id="form_slider_main" onkeypress="return event.keyCode != 13;">
                ...
                <div class="setting_box">
                    <h3><span
                            class="setting-step-number">1</span><span><?php _e("Content Source", 'revslider') ?></span>
                    </h3>
                        ...
                        <div class="source-selector-wrapper">
                            ...
                            <span class="rs-source-selector selected">
								...
								<input type="radio" id="source_type_3" value="gallery"
                                       name="source_type" <?php checked($source_type, 'gallery'); ?> />
							...
							<span class="rs-source-selector">
								...
								<input type="radio" id="source_type_3" value="flickr"
                                       name="source_type" <?php checked($source_type, 'flickr'); ?> />
							...
							<span class="rs-source-selector">
								...
								<input type="radio" id="source_type_4" value="instagram"
                                       name="source_type" <?php checked($source_type, 'instagram'); ?> />
							...
							<span class="rs-source-selector">
								...
								<input type="radio" id="source_type_5" value="woocommerce"
                                       name="source_type" <?php checked($source_type, 'woocommerce'); ?> />
							...
							<span class="rs-source-selector">
								...
								<input type="radio" id="source_type_6" value="twitter"
                                       name="source_type" <?php checked($source_type, 'twitter'); ?> />
							...
							<span class="rs-source-selector">
								...
								<input type="radio" id="source_type_7" value="facebook"
                                       name="source_type" <?php checked($source_type, 'facebook'); ?> />
							...
							<span class="rs-source-selector">
								...
								<input type="radio" id="source_type_8" value="youtube"
                                       name="source_type" <?php checked($source_type, 'youtube'); ?> />
							...
							<span class="rs-source-selector">
								...
								<input type="radio" id="source_type_9" value="vimeo"
                                       name="source_type" <?php checked($source_type, 'vimeo'); ?> />
                    ...
                    <div id="rs-instagram-settings-wrapper" class="rs-settings-wrapper">
                        <div style="width:50%;display:block;float:left;">
                            ...
                            <input type="text"
                                   ...
                                   title="<?php _e('Display this number of photos', 'revslider'); ?>">

                            <p>
                                <span class="rev-new-label"><?php _e('Access Token', 'revslider'); ?></span>
                                <input type="text"
                                       value="<?php echo RevSliderFunctions::getVal($arrFieldsParams, 'instagram-access-token', ''); ?>"
                                       name="instagram-access-token"
                                       title="<?php _e('Put in your Instagram Access Token', 'revslider'); ?>">
                            </p>

                            <p>
                                <span
                                    class="description"><?php _e('Get your Instagram Access Token <a target="_blank" href="http://www.pinceladasdaweb.com.br/instagram/access-token/">here</a>', 'revslider'); ?></span>
                            </p>
                        </div>
                        <div style="width:50%;display:block;float:left;">
                            ...
                            <input type="text"
                                   ...
                                   title="<?php _e('Put in the Instagram User ID', 'revslider'); ?>">

                            <p>
                                <span
                                    class="description"><?php _e('Find the Instagram User ID <a target="_blank" href="http://www.otzberg.net/iguserid/">here</a>', 'revslider'); ?></span>
                            </p>
                        </div>
                    </div>
                        ...
                        <div style="width:50%;display:block;float:left;">
                            ...
                            <p>
                                ...
                                <input type="text"
                                       ...
                                       name="flickr-api-key"
                                       title="<?php _e('Put in your Flickr API Key', 'revslider'); ?>">
                            </p>
                            <span
                                class="description"><?php _e('Read <a target="_blank" href="http://weblizar.com/get-flickr-api-key/">here</a> how to receive your Flickr API key', 'revslider'); ?></span>
                        </div>
                        <div style="width:50%;display:block;float:left;">
                            <span class="rev-new-label"><?php _e('Source', 'revslider'); ?></span>
                            <select name="flickr-type">
                                <option value="publicphotos"
                                        title="<?php _e('Display a user\'s public photos', 'revslider'); ?>" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'flickr-type', 'publicphotos'), 'publicphotos'); ?>> <?php _e('User Public Photos', 'revslider'); ?></option>
                                <option value="photosets"
                                        title="<?php _e('Display a certain photoset from a user', 'revslider'); ?>"<?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'flickr-type', 'publicphotos'), 'photosets'); ?>> <?php _e('User Photoset', 'revslider'); ?></option>
                                <option value="gallery"
                                        title="<?php _e('Display a gallery', 'revslider'); ?>"<?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'flickr-type', 'publicphotos'), 'gallery'); ?>> <?php _e('Gallery', 'revslider'); ?></option>
                                <option value="group"
                                        title="<?php _e('Display a group\'s photos', 'revslider'); ?>"<?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'flickr-type', 'publicphotos'), 'group'); ?>> <?php _e('Groups\' Photos', 'revslider'); ?></option>
                            </select>
                            ...
                            <div id="flickr-publicphotos-url-wrap">
                                <p>
                                    ...
                                    <input type="text"
                                           ...
                                           title="<?php _e('Put in the URL of the flickr User', 'revslider'); ?>">
                                </p>
                            </div>
                            <div id="flickr-photosets-wrap">
                                <p>
                                    ...
                                    <select name="flickr-photoset-select"
                                            title="<?php _e('Select the photoset to pull the data from ', 'revslider'); ?>">
                                    </select>
                                </p>
                            </div>
                            <div id="flickr-gallery-url-wrap">
                                <p>
                                    ...
                                    <input type="text"
                                           ...
                                           title="<?php _e('Put in the URL of the flickr Gallery', 'revslider'); ?>">
                                </p>
                            </div>
                            <div id="flickr-group-url-wrap">
                                <p>
                                    ...
                                    <input type="text"
                                           ...
                                           title="<?php _e('Put in the URL of the flickr Group', 'revslider'); ?>">
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="rs-facebook-settings-wrapper" class="rs-settings-wrapper">
                        <div style="width:50%;display:block;float:left;">
                            ...
                            <input type="text"
                                   ...
                                   name="facebook-count"
                                   title="<?php _e('Display this number of posts', 'revslider'); ?>">
                            ...
                            <p>
                                ...
                                <input type="text"
                                       ...
                                       title="<?php _e('Cache the stream for x seconds', 'revslider'); ?>">
                            </p>
                            ...
                            <p>
                                ...
                                <input type="text" value="<?php echo $facebook_page_url; ?>" name="facebook-page-url"
                                       id="facebook-page-url"
                                       title="<?php _e('Put in the URL/ID of the Facebook page', 'revslider'); ?>">
                            </p>
                        </div>
                        <div style="width:50%;display:block;float:left;">
                            <!--<span class="rev-new-label"><?php _e('Source', 'revslider'); ?></span>
                            ...
                            <input type="text"
                                   ...
                                   title="<?php _e('Put in the Facebook App ID', 'revslider'); ?>">
                            ...
                            <p>
                                ...
                                <input type="text"
                                       ...
                                       title="<?php _e('Put in the Facebook App secret', 'revslider'); ?>">
                            </p>
                        </div>
                    </div>
                    ...
                    <div id="rs-twitter-settings-wrapper" class="rs-settings-wrapper">
                        <div style="width:50%;display:block;float:left;">
                            ...
                            <input type="text"
                                   ...
                                   name="twitter-count"
                                   title="<?php _e('Display this number of tweets', 'revslider'); ?>">
                            ...
                            <p>
                                ...
                                <input type="text"
                                       ...
                                       title="<?php _e('Put in the Twitter Account to stream from', 'revslider'); ?>">
                            </p>

                            <p>
                                <span class="rev-new-label"><?php _e('Text Tweets', 'revslider'); ?></span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="twitter-image-only"
                                       name="twitter-image-only"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'twitter-image-only', 'off'), 'on'); ?> >
                            </p>

                            <p>
                                <span class="rev-new-label"><?php _e('Retweets', 'revslider'); ?></span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="twitter-include-retweets"
                                       name="twitter-include-retweets"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'twitter-include-retweets', 'off'), 'on'); ?> >
                            </p>

                            <p>
                                <span class="rev-new-label"><?php _e('Replies', 'revslider'); ?></span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="twitter-exclude-replies"
                                       name="twitter-exclude-replies"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'twitter-exclude-replies', 'off'), 'on'); ?> >
                            </p>
                        </div>
                        <div style="width:50%;display:block;float:left;">
                            ...
                            <input type="text"
                                   ...
                                   title="<?php _e('Put in your Twitter Consumer Key', 'revslider'); ?>">
                            ...
                            <p>
                                ...
                                <input type="text"
                                       ...
                                       title="<?php _e('Put in your Twitter Consumer Secret', 'revslider'); ?>">
                            </p>
                            ...
                            <p>
                                ...
                                <input type="text"
                                       ...
                                       title="<?php _e('Put in your Twitter Access Token', 'revslider'); ?>">
                            </p>
                            ...
                            <p>
                                ...
                                <input type="text"
                                       ...
                                       title="<?php _e('Put in your Twitter Access Secret', 'revslider'); ?>">
                            </p>
                            <span
                                class="description"><?php _e('Please <a target="_blank" href="https://dev.twitter.com/apps">register</a> your application with Twitter to get the values', 'revslider'); ?></span>
                        </div>
                    </div>

                    <div id="rs-youtube-settings-wrapper" class="rs-settings-wrapper">
                        <div
                            class="rs-notice-wrap stream-notice"><?php _e('The “YouTube Stream” content source is used to display a full stream of videos from a channel/playlist.<br> If you want to display a single youtube video, please select the content source “Default Slider” and add a video layer in the slide editor.', 'revslider'); ?></div>
                        <div style="width:50%;display:block;float:left;">
                            ...
                            <input type="text"
                                   ...
                                   name="youtube-count"
                                   title="<?php _e('Display this number of videos', 'revslider'); ?>">
                            ...
                            <p>
                                ...
                                <input type="text"
                                       ...
                                       name="youtube-api"
                                       title="<?php _e('Put in your YouTube API Key', 'revslider'); ?>">
                            </p>

                            <span
                                class="description"><?php _e('Find information about the YouTube API key <a target="_blank" href="https://developers.google.com/youtube/v3/getting-started#before-you-start">here</a>', 'revslider'); ?></span>
                        </div>
                        <div style="width:50%;display:block;float:left;">
                            ...
                            <input type="text"
                                   ...
                                   title="<?php _e('Put in the ID of the YouTube channel', 'revslider'); ?>">

                            <p>
                                <span class="rev-new-label"><?php _e('Source', 'revslider'); ?></span>
                                <select name="youtube-type-source">
                                    <option value="channel"
                                            title="<?php _e('Display the channel´s videos', 'revslider'); ?>" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'youtube-type-source', 'channel'), 'channel'); ?> > <?php _e('Channel', 'revslider'); ?> </option>
                                    <option value="playlist"
                                            title="<?php _e('Display a playlist', 'revslider'); ?>" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'youtube-type-source', 'channel'), 'playlist'); ?> > <?php _e('Playlist', 'revslider'); ?>    </option>
                                </select>
                            </p>
                            ...
                            <span
                                class="description"><?php _e('See how to find the Youtube channel ID <a target="_blank" href="https://support.google.com/youtube/answer/3250431?hl=en">here</a>', 'revslider'); ?></span>
                        </div>
                    </div>

                    <div id="rs-vimeo-settings-wrapper" class="rs-settings-wrapper">
                        <div
                            class="rs-notice-wrap stream-notice"><?php _e('The “Vimeo Stream” content source is used to display a full stream of videos from a user/album/group/channel.<br> If you want to display a single vimeo video, please select the content source “Default Slider” and add a video layer in the slide editor.', 'revslider'); ?></div>
                        <div style="width:50%;display:block;float:left;">
                            ...
                            <p>
                                ...
                                <select name="vimeo-type-source">
                                    <option name="vimeo-type-source" value="user"
                                            title="<?php _e('Display the user\'s videos', 'revslider'); ?>" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'vimeo-type-source', 'user'), 'user'); ?> > <?php _e('User', 'revslider'); ?></option>
                                    <option name="vimeo-type-source" value="album"
                                            title="<?php _e('Display an album', 'revslider'); ?>" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'vimeo-type-source', 'user'), 'album'); ?> > <?php _e('Album', 'revslider'); ?></option>
                                    <option name="vimeo-type-source" value="group"
                                            title="<?php _e('Display a group\'s videos', 'revslider'); ?>" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'vimeo-type-source', 'user'), 'group'); ?> > <?php _e('Group', 'revslider'); ?>    </option>
                                    <option name="vimeo-type-source" value="channel"
                                            title="<?php _e('Display a channel\'s videos', 'revslider'); ?>" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'vimeo-type-source', 'user'), 'channel'); ?> > <?php _e('Channel', 'revslider'); ?>    </option>
                                </select>
                            </p>
                        </div>
                        <div style="width:50%;display:block;float:left;">
                            <div id="vimeo-user-wrap" class="source-vimeo">
                                ...
                                <input type="text"
                                       ...
                                       name="vimeo-username"
                                       title="<?php _e('Either the shortcut URL or ID of the user', 'revslider'); ?>">
                            </div>
                            <div id="vimeo-group-wrap" class="source-vimeo">
                                ...
                                <input type="text"
                                       ...
                                       title="<?php _e('Either the shortcut URL or ID of the group', 'revslider'); ?>">
                            </div>
                            <div id="vimeo-album-wrap" class="source-vimeo">
                                ...
                                <input type="text"
                                       ...
                                       name="vimeo-albumid" title="<?php _e('The ID of the album', 'revslider'); ?>">
                            </div>
                            <div id="vimeo-channel-wrap" class="source-vimeo">
                                ...
                                <input type="text"
                                       ...
                                       title="<?php _e('Either the shortcut URL of the channel', 'revslider'); ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="rs-post-settings-wrapper" class="rs-settings-wrapper">
                        <div style="width:50%;display:block;float:left;">
                            <div class="rs-woocommerce-product-wrap" style="display: none;">
                                ...
                                //default
                                ?>
                                <select id="product_types" name="product_types" multiple size='2'
                                ...
                                <select id="product_category" name="product_category" multiple size='7'
                            ...
                            <div class="rs-specific-posts-wrap">
								...
								--><input type="text" class='regular-text'
                                          placeholder="<?php _e('coma separated | ex: 23,24,25', 'revslider'); ?>"
                                ...
                                <span class="rev-new-label"></span><a class="button-primary revblue"
                                                                      id="rev-fetch-popular-posts" style="width: 200px;"
                                                                      href="javascript:jQuery('#posts_list').val('<?php echo implode(',', $popular); ?>');void(0);"><i
                                        class="eg-icon-plus-circled"></i><?php _e('Add Popular Posts', 'revslider'); ?>
                                </a>
                                <span class="tp-clearfix"></span>
                                <span class="rev-new-label"></span><a class="button-primary revblue"
                                                                      id="rev-fetch-recent-posts" style="width: 200px;"
                                                                      href="javascript:jQuery('#posts_list').val('<?php echo implode(',', $recent); ?>');void(0);"><i
                                        class="eg-icon-plus-circled"></i><?php _e('Add Recent Posts', 'revslider'); ?>
                                </a>
                            </div>
                            <div class="rs-post-types-wrapper">
                                ...
                                <select id="fetch_type" name="fetch_type"
                                        style="width:181px; vertical-align: top; height:50px">
                                    <option
                                        value="cat_tag" <?php selected($fetch_type, 'cat_tag'); ?>><?php _e('Categories & Tags', 'revslider'); ?></option>
                                    <option
                                        value="related" <?php selected($fetch_type, 'related'); ?>><?php _e('Related', 'revslider'); ?></option>
                                    <option
                                        value="popular" <?php selected($fetch_type, 'popular'); ?>><?php _e('Popular', 'revslider'); ?></option>
                                    <option
                                        value="recent" <?php selected($fetch_type, 'recent'); ?>><?php _e('Recent', 'revslider'); ?></option>
                                    <option
                                        value="next_prev" <?php selected($fetch_type, 'next_prev'); ?>><?php _e('Next / Previous', 'revslider'); ?></option>
                                </select>
                        ...
                        <div style="width:50%;display:none;float:left;" class="rs-show-for-wc">
                            ...
                            <select id="product_sortby" name="product_sortby">
                                ...
                                foreach ($wc_sortby as $wc_val => $wc_name) {
                                    ?>
                                    <option
                                        value="<?php echo $wc_val; ?>" <?php selected($product_sortby, $wc_val); ?>><?php echo $wc_name; ?></option>
                                    <?php
                                }
                                ?>
                                <option
                                    value="ID" <?php selected($product_sortby, 'ID'); ?>><?php _e('Post ID', 'revslider'); ?></option>
                                <option
                                    value="date" <?php selected($product_sortby, 'date'); ?>><?php _e('Date', 'revslider'); ?></option>
                                <option
                                    value="title" <?php selected($product_sortby, 'title'); ?>><?php _e('Title', 'revslider'); ?></option>
                                <option
                                    value="name" <?php selected($product_sortby, 'name'); ?>><?php _e('Slug', 'revslider'); ?></option>
                                <option
                                    value="author" <?php selected($product_sortby, 'author'); ?>><?php _e('Author', 'revslider'); ?></option>
                                <option
                                    value="modified" <?php selected($product_sortby, 'modified'); ?>><?php _e('Last Modified', 'revslider'); ?></option>
                                <option
                                    value="comment_count" <?php selected($product_sortby, 'comment_count'); ?>><?php _e('Number Of Comments', 'revslider'); ?></option>
                                <option
                                    value="rand" <?php selected($product_sortby, 'rand'); ?>><?php _e('Random', 'revslider'); ?></option>
                                <option
                                    value="none" <?php selected($product_sortby, 'none'); ?>><?php _e('Unsorted', 'revslider'); ?></option>
                                <option
                                    value="menu_order" <?php selected($product_sortby, 'menu_order'); ?>><?php _e('Custom Order', 'revslider'); ?></option>
                            </select>
                            <span class="tp-clearfix"></span>
							...
							<span>
								<input type="radio" id="product_sort_direction_1" value="DESC"
                                       name="product_sort_direction" <?php checked($product_sort_direction, 'DESC'); ?> />
								<label for="product_sort_direction_1"
                                       style="cursor:pointer;"><?php _e('Descending', 'revslider'); ?></label>
								<input type="radio" style="margin-left:20px;" id="product_sort_direction_2" value="ASC"
                                       name="product_sort_direction" <?php checked($product_sort_direction, 'ASC'); ?> />
								<label for="product_sort_direction_2"
                                       style="cursor:pointer;"><?php _e('Ascending', 'revslider'); ?></label>
							</span>
                            <span class="tp-clearfix"></span>

                            <span class="rev-new-label"><?php _e('Max Products:', 'revslider'); ?></span>
                            <input type="text" class='small-text' id="max_slider_products" name="max_slider_products"
							...
							<span style="width: 201px; display: inline-block;"><?php _e('From', 'revslider'); ?> <input
                                    type="text" class='small-text' style="width: 50px !important; margin-right: 40px;"
                                    id="reg_price_from" name="reg_price_from"
                                    value="<?php echo RevSliderFunctions::getVal($arrFieldsParams, 'reg_price_from', ''); ?>"/>
                                <?php _e('To', 'revslider'); ?> <input type="text" class='small-text'
                                                                       style="width: 50px !important;" id="reg_price_to"
                                                                       name="reg_price_to"
							...
							<span style="width: 201px; display: inline-block;"><?php _e('From', 'revslider'); ?> <input
                                    type="text" class='small-text' style="width: 50px !important; margin-right: 40px;"
                                    id="sale_price_from" name="sale_price_from"
                            ...
                            <input type="checkbox" id="instock_only" name="instock_only" class="tp-moderncheckbox"
                                   data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'instock_only', 'off'), "on"); ?>>
                            <span class="tp-clearfix"></span>

                            <span class="rev-new-label"><?php _e('Featured Only:', 'revslider'); ?></span>
                            <input type="checkbox" id="featured_only" name="featured_only" class="tp-moderncheckbox"
                                   data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'featured_only', 'off'), "on"); ?>>
                            <span class="tp-clearfix"></span>
                        </div>
                            ...
                            <div id="post_sortby_row" valign="top">
                                <div class="rs-post-order-setting">
                                    ...
                                    <select id="post_sortby" name="post_sortby">
                                        <option
                                            value="ID" <?php selected($post_sortby, 'ID'); ?>><?php _e('Post ID', 'revslider'); ?></option>
                                        <option
                                            value="date" <?php selected($post_sortby, 'date'); ?>><?php _e('Date', 'revslider'); ?></option>
                                        <option
                                            value="title" <?php selected($post_sortby, 'title'); ?>><?php _e('Title', 'revslider'); ?></option>
                                        <option
                                            value="name" <?php selected($post_sortby, 'name'); ?>><?php _e('Slug', 'revslider'); ?></option>
                                        <option
                                            value="author" <?php selected($post_sortby, 'author'); ?>><?php _e('Author', 'revslider'); ?></option>
                                        <option
                                            value="modified" <?php selected($post_sortby, 'modified'); ?>><?php _e('Last Modified', 'revslider'); ?></option>
                                        <option
                                            value="comment_count" <?php selected($post_sortby, 'comment_count'); ?>><?php _e('Number Of Comments', 'revslider'); ?></option>
                                        <option
                                            value="rand" <?php selected($post_sortby, 'rand'); ?>><?php _e('Random', 'revslider'); ?></option>
                                        <option
                                            value="none" <?php selected($post_sortby, 'none'); ?>><?php _e('Unsorted', 'revslider'); ?></option>
                                        <option
                                            value="menu_order" <?php selected($post_sortby, 'menu_order'); ?>><?php _e('Custom Order', 'revslider'); ?></option>
                                        <?php
                                        if (RevSliderEventsManager::isEventsExists()) {
									...
									<span>
										<input type="radio" id="posts_sort_direction_1" value="DESC"
                                               name="posts_sort_direction" <?php checked($posts_sort_direction, 'DESC'); ?> />
										<label for="posts_sort_direction_1"
                                               style="cursor:pointer;"><?php _e('Descending', 'revslider'); ?></label>
										<input type="radio" style="margin-left:20px;" id="posts_sort_direction_2"
                                               value="ASC"
                                               name="posts_sort_direction" <?php checked($posts_sort_direction, 'ASC'); ?> />
                                ...
                                <input type="text" class='small-text' id="max_slider_posts" name="max_slider_posts"
                ...
                <div class="setting_box" style="background:#fff">
                    <h3><span
                            class="setting-step-number">2</span><span><?php _e("Slider Title & ShortCode", 'revslider') ?></span>
                    </h3>
                    ...
                    <div class="inside">
                        <div class="slidertitlebox">
							...
							<span class="one-third-container">
								<input placeholder='<?php _e("Enter your Slider Name here", 'revslider') ?>' type="text"
                                       class='regular-text' id="title" name="title"
                                       value="<?php echo RevSliderFunctions::getVal($arrFieldsParams, 'title', ''); ?>"/>
								<i class="input-edit-icon"></i>
								<span
                                    class="description"><?php _e("The title of the slider, example: Slider 1", 'revslider') ?></span>
							</span>

							<span class="one-third-container">
								<input placeholder='<?php _e("Enter your Slider Alias here", 'revslider') ?>'
                                       type="text" class='regular-text' id="alias" name="alias"
                                       value="<?php echo RevSliderFunctions::getVal($arrFieldsParams, 'alias', ''); ?>"/>
								<i class="input-edit-icon"></i>
								<span
                                    class="description"><?php _e("The alias for embedding your slider, example: slider1", 'revslider') ?></span>
							</span>
							...
							<span class="one-third-container">
								...
								<span
                                    class="description"><?php _e("Place the shortcode where you want to show the slider", 'revslider') ?></span>
							</span>
                        </div>
                ...
                <div class="setting_box">
                    ...
                    ?>
                    <h3><span
                            class="setting-step-number">3</span><span><?php _e("Select a Slider Type", 'revslider'); ?></span>
                    </h3>
                    ...
                    <div class="rs-slidetypeselector">
                        ...
                        <div data-mode="standardpreset"
                            ...
                            <input style="display: none;" type="radio" name="slider-type"
                                   value="standard" <?php checked($slider_type, 'standard'); ?> />
                        </div>
                        <div data-mode="heropreset"
                            ...
                            <input style="display: none;" type="radio" name="slider-type"
                                   value="hero" <?php checked($slider_type, 'hero'); ?> />
                        </div>
                        <div data-mode="carouselpreset"
                            ...
                            <input style="display: none;" type="radio" name="slider-type"
                                   value="carousel" <?php checked($slider_type, 'carousel'); ?> />
                        </div>
                    </div>
                    <span
                        class="preset-splitter readytoopen"><?php _e("Load a Preset from this Slider Type", 'revslider'); ?>
                ...
                <div class="setting_box" id="rs-slider-layout-cont">
                    <h3><span class="setting-step-number">4</span><span><?php _e("Slide Layout", 'revslider'); ?></span>
                    </h3>
                    ...
                    <div class="inside" style="padding:0px">
                            ...
                            <div class="rs-slidesize-selector">
                                ...
                                <div class="rs-slidersize">
                                    ...
                                    <input type="radio" id="slider_type_1" value="auto"
                                           name="slider_type" <?php checked($slider_type, 'auto'); ?> />
                                </div>
                                <div class="rs-slidersize">
                                    ...
                                    <input type="radio" id="slider_type_2" value="fullwidth"
                                           name="slider_type" <?php checked($slider_type, 'fullwidth'); ?> />
                                </div>
                                <div class="rs-slidersize selected">
                                    ...
                                    <input type="radio" id="slider_type_3" style="margin-left:20px" value="fullscreen"
                                           name="slider_type" <?php checked($slider_type, 'fullscreen'); ?> />
                                </div>
                        ...
                        <div id="layout-preshow">
                            <div class="rsp-desktop-view rsp-view-cell">
                                <div class="rsp-view-header">
                                    <?php _e('Desktop Large', 'revslider'); ?> <span
                                        class="rsp-cell-dimension"><?php _e('Max', 'revslider'); ?></span>
                                </div>
                                ...
                                <div class="slide-size-wrapper">
                                    ...
                                    <span class="relpos"><input id="width" name="width" type="text" style="width:120px"
                                                                class="textbox-small"
                                    ...
                                    <span
                                        class="description"><?php _e('Specify a layer grid size above', 'revslider'); ?></span>
                                    <span class="description"
                                          style="padding:20px 20px 0px; box-sizing:border-box;-moz-box-sizing:border-box;"><?php _e('Slider is always Linear Responsive till next Defined Grid size has been hit.', 'revslider'); ?></span>
                                </div>
                            </div>
                            <div class="rsp-macbook-view rsp-view-cell">
                                <div class="rsp-view-header">
                                    <?php _e('Notebook', 'revslider'); ?> <span
                                ...
                                <div class="slide-size-wrapper">
                                    ...
                                    <span class="rs-preset-label"
                                          style="display:inline-block; margin-right:15px;"><?php _e('Custom Grid Size', 'revslider'); ?></span>
									<span style="text-align:left">
										<input type="checkbox" class="tp-moderncheckbox"
                                               id="enable_custom_size_notebook" name="enable_custom_size_notebook"
                                               data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'enable_custom_size_notebook', 'off'), "on"); ?>>
									</span>
                                    <span class="description"
                                          style="padding:0px 20px 0px; box-sizing:border-box;-moz-box-sizing:border-box;"><?php _e('<br>If not defined, the next bigger Layer Grid Size is the basic of Linear Responsive calculations.', 'revslider'); ?></span>
                                </div>
                            </div>
                            <div class="rsp-tablet-view rsp-view-cell">
                                <div class="rsp-view-header">
                                    <?php _e('Tablet', 'revslider'); ?> <span
                                ...
                                <div class="slide-size-wrapper">
									...
									<span style="text-align:left">
										<input type="checkbox" class="tp-moderncheckbox" id="enable_custom_size_tablet"
                                               ...
                                               data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'enable_custom_size_tablet', 'off'), "on"); ?>>
									</span>
                                    <span class="description"
                                          style="padding:0px 20px 0px; box-sizing:border-box;-moz-box-sizing:border-box;"><?php _e('<br>If not defined, the next bigger Layer Grid Size is the basic of Linear Responsive calculations.', 'revslider'); ?></span>
                                </div>
                                ...
                                <div class="slide-size-wrapper">
									...
									<span style="text-align:left">
										<input type="checkbox" class="tp-moderncheckbox" id="enable_custom_size_iphone"
                                               ...
                                               data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'enable_custom_size_iphone', 'off'), "on"); ?>>
									</span>
                                    <span class="description"
                                          style="padding:0px 20px 0px; box-sizing:border-box;-moz-box-sizing:border-box;"><?php _e('<br>If not defined, the next bigger Layer Grid Size is the basic of Linear Responsive calculations.', 'revslider'); ?></span>
                                </div>
                        ...
                        <div class="buttonarea" id="removethisbuttonarea">
                            <a class="button-primary revblue" id="show_advanced_navigation" original-title=""><i
                                    class="revicon-cog"></i><?php _e("Show Advanced Size Options", 'revslider'); ?></a>
                        </div>
                        ...
                        <div class="inside" id="visual-sizing" style="display:none; padding:25px 20px;">
                            <div id="fullscreen-advanced-sizing">
								<span class="one-half-container" style="vertical-align:top">
									...
									<span
                                        class="rs-preset-label noopacity "><?php _e("Minimal Height of Slider (Optional)", 'revslider'); ?></span>
									...
									<span style="text-align:left; display:none;">
										<span class="rs-preset-label noopacity "
                                              style="display:inline-block;margin-right:20px"><?php _e("FullScreen Align Force", 'revslider'); ?> </span>
										<input type="checkbox" class="tp-moderncheckbox withlabel"
                                               id="full_screen_align_force" name="full_screen_align_force"
                                               data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'full_screen_align_force', 'off'), "on"); ?>>
										<span
                                            class="description"><?php _e("Layers align within the full slider instead of the layer grid.", 'revslider'); ?></span>
									</span>

									<span class="slidertitlebox limitedtablebox">
										<span class="one-half-container">
											<input placeholder="<?php _e("Min. Height", 'revslider'); ?>" type="text"
											...
											<i class="input-edit-icon"></i>
											<span
                                                class="description"><?php _e("The minimum height of the Slider in FullScreen mode.", 'revslider'); ?></span>
										</span>
									</span>
									<span style="clear:both;float:none; height:25px;display:block"></span>
									...
									<span style="text-align:left; padding:0px 20px;">
										<span class="rs-preset-label noopacity "
                                              style="display:inline-block;margin-right:20px"><?php _e("Disable Force FullWidth", 'revslider'); ?> </span>
										<input type="checkbox" class="tp-moderncheckbox withlabel" id="autowidth_force"
                                               name="autowidth_force"
                                               data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'autowidth_force', 'off'), "on"); ?>>
										<span class="description"
                                              style="padding:0px 20px;"><?php _e("Disable the FullWidth Force function, and allow to float the Fullheight slider horizontal.", 'revslider'); ?></span>
									</span>
								...
								<span class="one-half-container" style="vertical-align:top">
									<span
                                        class="rs-preset-label noopacity "><?php _e("Increase/Decrease Fullscreen Height (Optional)", 'revslider'); ?></span>
									<span style="clear:both;float:none; height:25px;display:block"></span>

									<span class="slidertitlebox limitedtablebox">
										<span class="one-full-container">
											<input placeholder="<?php _e("Containers", 'revslider'); ?>" type="text"
											...
											<i class="input-edit-icon"></i>
											<span
                                                class="description"><?php _e("Example: #header or .header, .footer, #somecontainer | Height of Slider will be decreased with the height of these Containers to fit perfect in the screen.", 'revslider'); ?></span>
										</span>
									</span>
									<span style="clear:both;float:none; height:25px;display:block"></span>
									<span class="slidertitlebox limitedtablebox">
										<span class="one-full-container">
											<input placeholder="<?php _e("PX or %", 'revslider'); ?>" type="text"
											...
											<i class="input-edit-icon"></i>
											<span
                                                class="description"><?php _e("Decrease/Increase height of Slider. Can be used with px and %. Positive/Negative values allowed. Example: 40px or 10%", 'revslider'); ?></span>
										</span>
									</span>
									<span style="clear:both;float:none; height:25px;display:block"></span>
                            ...
                            <div id="normal-advanced-sizing">
                                ...
                                <div class="slidertitlebox limitedtablebox" style="width:100%; max-width:100%">
									<span class="one-third-container" style="vertical-align:top">
										<span class="rs-preset-label noopacity"
                                              style="margin-top:12px;display:inline-block;margin-right:20px"><?php _e("Overflow Hidden", 'revslider'); ?> </span>
										<input type="checkbox" class="tp-moderncheckbox" id="main_overflow_hidden"
                                               name="main_overflow_hidden"
                                               data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'main_overflow_hidden', 'off'), "on"); ?>>
										<div style="clear:both;float:none; height:25px"></div>
										<span
                                            class="description"><?php _e("Adds overflow:hidden to the slider wrapping container which will hide / cut any overlapping elements. Mostly used in Carousel Sliders.", 'revslider'); ?></span>
									</span>

									<span class="one-third-container" style="vertical-align:top">
										<span class="rs-preset-label noopacity"
                                              style="margin-top:12px;display:inline-block;margin-right:20px"><?php _e("Respect Aspect Ratio", 'revslider'); ?> </span>
										<input type="checkbox" class="tp-moderncheckbox" id="auto_height"
                                               name="auto_height"
                                               data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'auto_height', 'off'), "on"); ?>>
										<div style="clear:both;float:none; height:25px"></div>
										<span
                                            class="description"><?php _e("It will keep aspect ratio and ignore max height of Layer Grid by upscaling. Layer Area will be vertical centered.", 'revslider'); ?></span>
									</span>

									<span class="one-third-container" style="vertical-align:top">
										<input placeholder="<?php _e("Min. Heigh (Optional)", 'revslider'); ?>"
										...
										<i class="input-edit-icon"></i>
										<span
                                            class="description"><?php _e("The minimum height of the Slider in FullWidth or Auto mode.", 'revslider'); ?></span>
										<span class="rs-show-on-auto">
											<input placeholder="<?php _e("Max. Width (Optional)", 'revslider'); ?>"
                                                   type="text" class="text-sidebar"
											...
											<span
                                                class="description"><?php _e("The maximum width of the Slider in Auto mode.", 'revslider'); ?></span>
										</span>
									</span>
                                </div>
                            </div>
                        ...
                        <script>
                            jQuery("document").ready(function () {
                                ...
                                function setLayoutDesign(element, bw, bh, sw, sh, bm, ww, mm, fh, tt) {
                                    ...
                                    punchgs.TweenLite.to(element.find('.rsp-grid'), 0.3, {
                                        top: o.gridtop,
                                        height: o.height,
                                        left: mm,
                                        ease: punchgs.Power3.easeInOut
                                    });
                                    punchgs.TweenLite.to(element.find('.rsp-dotted-line-hr-left'), 0.3, {
                                        left: o.left,
                                        ease: punchgs.Power3.easeInOut
                                    });
                                    punchgs.TweenLite.to(element.find('.rsp-dotted-line-hr-right'), 0.3, {
                                        right: o.right,
                                        ease: punchgs.Power3.easeInOut
                                    });
                                    if (fh === 1) {
                                    ...
                                    punchgs.TweenLite.to(element.find('.rsp-slide-bg'), 0.3, {
                                        top: o.tt,
                                        width: ww,
                                        left: 0 - mm,
                                        marginTop: o.mt,
                                    ...
                                    punchgs.TweenLite.to(element.find('.rsp-layer'), 0.3, {
                                        fontSize: o.mtp * 14,
                                        paddingTop: o.mtp * 3,
                                        paddingBottom: o.mtp * 3,
                                        paddingLeft: o.mtp * 5,
                                        paddingRight: o.mtp * 5,
                                        lineHeight: o.mtp * 14 + "px",
                                        ease: punchgs.Power3.easeInOut
                                    });
                        ...
                        <p style="display:none">
                            ...
                            <input type="checkbox" class="tp-moderncheckbox " id="force_full_width"
                                   ...
                                   data-unchecked="off" <?php checked($force_full_width, 'on'); ?>>
                ...
                <div class="setting_box">
                    <h3><span
                            class="setting-step-number">5</span><span><?php _e("Customize, Build & Implement", 'revslider'); ?></span>
                    </h3>
                        ...
                        <div class="slidertitlebox breakdownonmobile">
							<span class="one-third-container" style="text-align:center">
								<img style="width:100%; max-width:325px;"
                                     src="<?php echo RS_PLUGIN_URL; ?>/admin/assets/images/mainoptions/mini-customizeslide.jpg">
								<span class="cbi-title"><?php _e("Advanced Settings", 'revslider'); ?></span>
								<span class="description"
                                      style="text-align:center;min-height:60px;"><?php _e("Go for further customization using the advanced settings on the right of this configuration page.", 'revslider'); ?></span>
								<div style="float:none; clear:both; height:20px;display:block;"></div>
								<a class="button-primary revblue" href="#form_slider_params"><i
                                        class="revicon-cog"></i><?php _e("Scroll to Options", 'revslider'); ?></a>
							</span>

							<span class="one-third-container" style="text-align:center">
								<img style="width:100%;max-width:325px;"
                                     src="<?php echo RS_PLUGIN_URL; ?>/admin/assets/images/mainoptions/mini-editslide.jpg">
								<span class="cbi-title"><?php _e("Start Building Slides", 'revslider'); ?></span>
								<span class="description"
                                      style="text-align:center;min-height:60px;"><?php _e("Our drag and drop editor will make creating slide content an absolut breeze. This is where the magic happens!", 'revslider'); ?></span>
                                ...
                                if (isset($linksEditSlides)) {
                                    ...
                                    <a class="button-primary revblue" href="<?php echo $linksEditSlides; ?>"
                                       id="link_edit_slides"><i
                                            class="revicon-pencil-1"></i><?php _e("Edit Slides", 'revslider'); ?> </a>
                                    <?php
                                }
                                ?>
							</span>
							...
							<span class="one-third-container" style="text-align:center">
								<img style="width:100%;max-width:325px;"
                                     src="<?php echo RS_PLUGIN_URL; ?>/admin/assets/images/mainoptions/mini-implement.jpg"><span
                                    class="description"><?php _e("", 'revslider'); ?></span>
								<span class="cbi-title"><?php _e("Implement your Slider", 'revslider'); ?></span>
								<span class="description"
                                      style="text-align:center;min-height:60px;"><?php _e("There are several ways to add your slider to your wordpress post / page / etc.", 'revslider'); ?></span>
								<div style="float:none; clear:both; height:20px;"></div>

								<span class="button-primary revblue rs-embed-slider"><i
                                        class="eg-icon-plus-circled"></i><?php _e("Embed Slider", 'revslider'); ?> </span>
                    ...
                    <div class="buttonarea" style="background-color:#eee; text-align:center">
                        <a style="width:125px" class='button-primary revgreen' href='javascript:void(0)'
                           id="button_save_slider"><i class="rs-rp-accordion-icon rs-icon-save-light"
                                                      style="display: inline-block;vertical-align: middle;width: 18px;height: 20px;margin-right:5px;background-repeat: no-repeat;"></i><?php _e("Save Settings", 'revslider'); ?>
                        </a>
                        <span id="loader_update" class="loader_round"
                              style="display:none;background-color:#27AE60 !important; color:#fff;padding: 4px 5px 5px 25px;margin-right: 5px;"><?php _e("updating...", 'revslider'); ?> </span>
                        ...
                        <a style="width:125px" class='button-primary revred' id="button_delete_slider"
                           href='javascript:void(0)'><i
                                class="revicon-trash"></i><?php _e("Delete Slider", 'revslider'); ?></a>
                        ...
                        <a style="width:125px" class="button-primary revgray" href="javascript:void(0)"
                           id="button_preview_slider" title="<?php _e("Preview Slider", 'revslider'); ?>"><i
                                class="revicon-search-1"></i><?php _e("Preview", 'revslider'); ?></a>
                    </div>
                </div>
            ...
            if ($is_edit) {
                ...
                ?>
                <div class="setting_box" id="css-javascript-customs"
                     style="max-width:100%;position:relative;overflow:hidden">
                    <h3><span
                            class="setting-step-number">6</span><span><?php _e("Custom CSS / Javascript", 'revslider'); ?></span>
                    </h3>
            ...
            <script type="text/javascript">
                function drawToolBarPreview() {
                    ...
                    switch (jQuery('#show_timerbar').val()) {
                        case "top":
                            punchgs.TweenLite.set(tprogress, {
                                backgroundColor: jQuery('#progressbar_color').val(),
                                top: "0px",
                                bottom: "auto",
                    ...
                    if (jQuery('#enable_thumbnails').attr("checked") !== "checked") {
                        ...
                        jQuery('.toolbar-navigation-thumbs-bg').css({
                            background: jQuery('#thumbnails_wrapper_color').val(),
                            opacity: jQuery('#thumbnails_wrapper_opacity').val() / 100
                        });
                    ...
                    if (jQuery('#enable_tabs').attr("checked") !== "checked") {
                        ...
                        jQuery('.toolbar-navigation-tabs-bg').css({
                            background: jQuery('#tabs_wrapper_color').val(),
                            opacity: jQuery('#tabs_wrapper_opacity').val() / 100
                        });
            ...
            <div class="settings_wrapper closeallothers" id="form_slider_params_wrap">
                <form name="form_slider_params" id="form_slider_params" onkeypress="return event.keyCode != 13;">
                    ...
                    <div class="setting_box">
                        ...
                        <div class="inside" style="display:none;">
                            ...
                            <ul class="main-options-small-tabs" style="display:inline-block; ">
                                <li data-content="#general-slideshow"
                                    class="selected"><?php _e('Slideshow', 'revslider'); ?></li>
                                <li data-content="#general-defaults" class=""><?php _e('Defaults', 'revslider'); ?></li>
                                <li data-content="#general-progressbar"
                                    class="dontshowonhero"><?php _e('Progress Bar', 'revslider'); ?></li>
                                <li data-content="#general-firstslide"
                                    class="dontshowonhero"><?php _e('1st Slide', 'revslider'); ?></li>
                            ...
                            <div id="general-misc" style="display:none">
                                ...
                                if (RevSliderWpml::isWpmlExists()) {
                                    ?>
                                    <!-- MULTI LANGUANGE -->
                                    <span id="label_use_wpml" class="label"
                                          origtitle="<?php _e("Show multi language controls across the slider. Only available when wpml plugin exists.", 'revslider'); ?>"><?php _e("Use Multi Language (WPML)", 'revslider'); ?> </span>
                                    <input type="checkbox" class="tp-moderncheckbox withlabel" id="use_wpml"
                                           name="use_wpml"
                                           data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'use_wpml', 'off'), "on"); ?>>
                                ...
                                <div class="dontshowonhero">
                                    ...
                                    <span id="label_next_slide_on_window_focus" class="label"
                                          origtitle="<?php _e("Call next slide when inactive browser tab is focused again. Use this for avoid dissorted layers and broken timeouts after bluring the browser tab.", 'revslider'); ?>"><?php _e("Next Slide on Focus", 'revslider'); ?> </span>
                                    <input type="checkbox" class="tp-moderncheckbox withlabel"
                                           id="next_slide_on_window_focus" name="next_slide_on_window_focus"
                                           data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'next_slide_on_window_focus', 'off'), "on"); ?>>
                                ...
                                <div>
                                    ...
                                    <span id="label_disable_focus_listener" class="label"
                                          origtitle="<?php _e("This will disable the blur/focus behavior of the browser.", 'revslider'); ?>"><?php _e("Disable Blur/Focus behavior", 'revslider'); ?> </span>
                                    <input type="checkbox" class="tp-moderncheckbox withlabel"
                                           id="disable_focus_listener" name="disable_focus_listener"
                                           data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'disable_focus_listener', 'off'), "on"); ?>>
                            ...
                            <div id="general-defaults" style="display:none">
                                ...
                                <span class="label" id="label_delay"
                                      origtitle="<?php _e("The time one slide stays on the screen in Milliseconds. This is a Default Global value. Can be adjusted slide to slide also in the slide editor.", 'revslider'); ?>"><?php _e("Default Slide Duration", 'revslider'); ?> </span>
                                ...
                                <span id="label_start_js_after_delay" class="label"
                                      origtitle="<?php _e("Sets a delay before the Slider gets initialized", 'revslider'); ?>"><?php _e("Initialization Delay", 'revslider'); ?> </span>
                                ...
                                <div id="reset-to-default-inputs">
                                    <input type="checkbox" class="rs-ingore-save rs-reset-slide-setting"
                                           name="reset-slide_transition"/> <span id="label_def-slide_transition"
                                                                                 origtitle="<?php _e("Default transition by creating a new slide.", 'revslider'); ?>"
                                                                                 class="label"><?php _e('Transitions', 'revslider'); ?></span>
                                    ...
                                    <input type="checkbox" class="rs-ingore-save rs-reset-slide-setting"
                                           name="reset-transition_duration"/> <span id="label_def-transition_duration"
                                                                                    origtitle="<?php _e("Default transition duration by creating a new slide.", 'revslider'); ?>"
                                                                                    class="label"
                                                                                    origtitle=""><?php _e('Animation Duration', 'revslider'); ?></span>
                                    <input type="text" class="text-sidebar withlabel" id="def-transition_duration"
                                           name="def-transition_duration" value="<?php echo $def_trans_dur; ?>">
                                    <span><?php _e('ms', 'revslider'); ?></span>
                                    ...
                                    ?>
                                    <input type="checkbox" class="rs-ingore-save rs-reset-slide-setting"
                                           name="reset-image_source_type"/> <span id="label_def-image_source_type"
                                                                                  class="label"
                                                                                  origtitle="<?php _e("Default main image source size by creating a new slide.", 'revslider'); ?>"><?php _e('Image Source Size', 'revslider'); ?></span>
                                    ...
                                    ?>
                                    <input type="checkbox" class="rs-ingore-save rs-reset-slide-setting"
                                           name="reset-background_fit"/> <span id="label_background_fit"
                                                                               origtitle="<?php _e("Default background size by creating a new slide.", 'revslider'); ?>"
                                                                               class="label"><?php _e('Background Fit', 'revslider'); ?></span>
                                    <select id="def-background_fit" name="def-background_fit" style="max-width: 105px;"
                                            class="withlabel">
                                        <option value="cover"<?php selected($bgFit, 'cover'); ?>>cover</option>
                                        <option value="contain"<?php selected($bgFit, 'contain'); ?>>contain</option>
                                        <option value="percentage"<?php selected($bgFit, 'percentage'); ?>>(%, %)
                                        </option>
                                    ...
                                    <input type="checkbox" class="rs-ingore-save rs-reset-slide-setting"
                                           name="reset-bg_position"/> <span id="label_slide_bg_position"
                                                                            origtitle="<?php _e("Default background position by creating a new slide.", 'revslider'); ?>"
                                                                            class="label"><?php _e('Background Position', 'revslider'); ?></span>
                                    <select name="def-bg_position" id="slide_bg_position">
                                        <option value="center top"<?php selected($bgPosition, 'center top'); ?>>center
                                            top
                                        </option>
                                        <option value="center right"<?php selected($bgPosition, 'center right'); ?>>
                                            center right
                                        </option>
                                        <option value="center bottom"<?php selected($bgPosition, 'center bottom'); ?>>
                                            center bottom
                                        </option>
                                        <option value="center center"<?php selected($bgPosition, 'center center'); ?>>
                                            center center
                                        </option>
                                        <option value="left top"<?php selected($bgPosition, 'left top'); ?>>left top
                                        </option>
                                        <option value="left center"<?php selected($bgPosition, 'left center'); ?>>left
                                            center
                                        </option>
                                        <option value="left bottom"<?php selected($bgPosition, 'left bottom'); ?>>left
                                            bottom
                                        </option>
                                        <option value="right top"<?php selected($bgPosition, 'right top'); ?>>right
                                            top
                                        </option>
                                        <option value="right center"<?php selected($bgPosition, 'right center'); ?>>
                                            right center
                                        </option>
                                        <option value="right bottom"<?php selected($bgPosition, 'right bottom'); ?>>
                                            right bottom
                                        </option>
                                    </select>
                                    ...
                                    <span id="slide_bg_repeat"
                                          origtitle="<?php _e("Default background repeat by creating a new slide.", 'revslider'); ?>"
                                          class="label"><?php _e('Background Repeat', 'revslider'); ?></span>
                                    <select name="def-bg_repeat" id="slide_bg_repeat" style="margin-right:20px">
                                        <option value="no-repeat"<?php selected($bgRepeat, 'no-repeat'); ?>>no-repeat
                                        </option>
                                        <option value="repeat"<?php selected($bgRepeat, 'repeat'); ?>>repeat</option>
                                        <option value="repeat-x"<?php selected($bgRepeat, 'repeat-x'); ?>>repeat-x
                                        </option>
                                        <option value="repeat-y"<?php selected($bgRepeat, 'repeat-y'); ?>>repeat-y
                                        </option>
                                    </select>
                                    ...
                                    <span id="def-kenburn_effect"
                                          origtitle="<?php _e("Default Ken/Burn setting by creating a new slide.", 'revslider'); ?>"
                                          class="label"><?php _e('Ken Burns / Pan Zoom:', 'revslider'); ?></span>
                                    <input type="checkbox" class="tp-moderncheckbox withlabel" id="def-kenburn_effect"
                                    ...
                                    ?>>
                                        ...
                                        <span id="label_kb_start_fit"
                                              class="label"><?php _e('Start Fit: (in %):', 'revslider'); ?></span>
                                        ...
                                        <input type="checkbox" class="rs-ingore-save rs-reset-slide-setting"
                                               name="reset-kb_easing"/> <span id="label_kb_easing"
                                                                              class="label"><?php _e('Easing:', 'revslider'); ?></span>
                                        <select name="def-kb_easing">
                                            <option <?php selected($kb_easing, 'Linear.easeNone'); ?>
                                                value="Linear.easeNone">Linear.easeNone
                                            </option>
                                            <option <?php selected($kb_easing, 'Power0.easeIn'); ?>
                                                value="Power0.easeIn">Power0.easeIn (linear)
                                            </option>
                                            <option <?php selected($kb_easing, 'Power0.easeInOut'); ?>
                                                value="Power0.easeInOut">Power0.easeInOut (linear)
                                            </option>
                                            <option <?php selected($kb_easing, 'Power0.easeOut'); ?>
                                                value="Power0.easeOut">Power0.easeOut (linear)
                                            </option>
                                            <option <?php selected($kb_easing, 'Power1.easeIn'); ?>
                                                value="Power1.easeIn">Power1.easeIn
                                            </option>
                                            <option <?php selected($kb_easing, 'Power1.easeInOut'); ?>
                                                value="Power1.easeInOut">Power1.easeInOut
                                            </option>
                                            <option <?php selected($kb_easing, 'Power1.easeOut'); ?>
                                                value="Power1.easeOut">Power1.easeOut
                                            </option>
                                            <option <?php selected($kb_easing, 'Power2.easeIn'); ?>
                                                value="Power2.easeIn">Power2.easeIn
                                            </option>
                                            <option <?php selected($kb_easing, 'Power2.easeInOut'); ?>
                                                value="Power2.easeInOut">Power2.easeInOut
                                            </option>
                                            <option <?php selected($kb_easing, 'Power2.easeOut'); ?>
                                                value="Power2.easeOut">Power2.easeOut
                                            </option>
                                            <option <?php selected($kb_easing, 'Power3.easeIn'); ?>
                                                value="Power3.easeIn">Power3.easeIn
                                            </option>
                                            <option <?php selected($kb_easing, 'Power3.easeInOut'); ?>
                                                value="Power3.easeInOut">Power3.easeInOut
                                            </option>
                                            <option <?php selected($kb_easing, 'Power3.easeOut'); ?>
                                                value="Power3.easeOut">Power3.easeOut
                                            </option>
                                            <option <?php selected($kb_easing, 'Power4.easeIn'); ?>
                                                value="Power4.easeIn">Power4.easeIn
                                            </option>
                                            <option <?php selected($kb_easing, 'Power4.easeInOut'); ?>
                                                value="Power4.easeInOut">Power4.easeInOut
                                            </option>
                                            <option <?php selected($kb_easing, 'Power4.easeOut'); ?>
                                                value="Power4.easeOut">Power4.easeOut
                                            </option>
                                            <option <?php selected($kb_easing, 'Back.easeIn'); ?> value="Back.easeIn">
                                                Back.easeIn
                                            </option>
                                            <option <?php selected($kb_easing, 'Back.easeInOut'); ?>
                                                value="Back.easeInOut">Back.easeInOut
                                            </option>
                                            <option <?php selected($kb_easing, 'Back.easeOut'); ?> value="Back.easeOut">
                                                Back.easeOut
                                            </option>
                                            <option <?php selected($kb_easing, 'Bounce.easeIn'); ?>
                                                value="Bounce.easeIn">Bounce.easeIn
                                            </option>
                                            <option <?php selected($kb_easing, 'Bounce.easeInOut'); ?>
                                                value="Bounce.easeInOut">Bounce.easeInOut
                                            </option>
                                            <option <?php selected($kb_easing, 'Bounce.easeOut'); ?>
                                                value="Bounce.easeOut">Bounce.easeOut
                                            </option>
                                            <option <?php selected($kb_easing, 'Circ.easeIn'); ?> value="Circ.easeIn">
                                                Circ.easeIn
                                            </option>
                                            <option <?php selected($kb_easing, 'Circ.easeInOut'); ?>
                                                value="Circ.easeInOut">Circ.easeInOut
                                            </option>
                                            <option <?php selected($kb_easing, 'Circ.easeOut'); ?> value="Circ.easeOut">
                                                Circ.easeOut
                                            </option>
                                            <option <?php selected($kb_easing, 'Elastic.easeIn'); ?>
                                                value="Elastic.easeIn">Elastic.easeIn
                                            </option>
                                            <option <?php selected($kb_easing, 'Elastic.easeInOut'); ?>
                                                value="Elastic.easeInOut">Elastic.easeInOut
                                            </option>
                                            <option <?php selected($kb_easing, 'Elastic.easeOut'); ?>
                                                value="Elastic.easeOut">Elastic.easeOut
                                            </option>
                                            <option <?php selected($kb_easing, 'Expo.easeIn'); ?> value="Expo.easeIn">
                                                Expo.easeIn
                                            </option>
                                            <option <?php selected($kb_easing, 'Expo.easeInOut'); ?>
                                                value="Expo.easeInOut">Expo.easeInOut
                                            </option>
                                            <option <?php selected($kb_easing, 'Expo.easeOut'); ?> value="Expo.easeOut">
                                                Expo.easeOut
                                            </option>
                                            <option <?php selected($kb_easing, 'Sine.easeIn'); ?> value="Sine.easeIn">
                                                Sine.easeIn
                                            </option>
                                            <option <?php selected($kb_easing, 'Sine.easeInOut'); ?>
                                                value="Sine.easeInOut">Sine.easeInOut
                                            </option>
                                            <option <?php selected($kb_easing, 'Sine.easeOut'); ?> value="Sine.easeOut">
                                                Sine.easeOut
                                            </option>
                                            <option <?php selected($kb_easing, 'SlowMo.ease'); ?> value="SlowMo.ease">
                                                SlowMo.ease
                                            </option>
                                        </select>
										...
										*/
                                        ...
                                        <input type="checkbox" class="rs-ingore-save rs-reset-slide-setting"
                                               name="reset-kb_end_fit"/> <span id="label_kb_end_fit"
                                                                               class="label"><?php _e('End Fit: (in %):', 'revslider'); ?></span>
                                        ...
                                        <input type="checkbox" class="rs-ingore-save rs-reset-slide-setting"
                                               name="reset-kb_start_offset_x"/> <span id="label_kb_end_fit"
                                                                                      class="label"><?php _e('Start Offset X:', 'revslider'); ?></span>
                                        ...
                                        <input type="checkbox" class="rs-ingore-save rs-reset-slide-setting"
                                               name="reset-kb_start_offset_y"/> <span id="label_kb_end_fit"
                                                                                      class="label"><?php _e('Start Offset Y:', 'revslider'); ?></span>
                                        ...
                                        <input type="checkbox" class="rs-ingore-save rs-reset-slide-setting"
                                               name="reset-kb_end_offset_x"/> <span id="label_kb_end_fit"
                                                                                    class="label"><?php _e('End Offset X:', 'revslider'); ?></span>
                                        ...
                                        <input type="checkbox" class="rs-ingore-save rs-reset-slide-setting"
                                               name="reset-kb_end_offset_y"/> <span id="label_kb_end_fit"
                                                                                    class="label"><?php _e('End Offset Y:', 'revslider'); ?></span>
                                        ...
                                        <input type="checkbox" class="rs-ingore-save rs-reset-slide-setting"
                                               name="reset-kb_start_rotate"/> <span id="label_kb_end_fit"
                                                                                    class="label"><?php _e('Start Rotate:', 'revslider'); ?></span>
                                        ...
                                        <input type="checkbox" class="rs-ingore-save rs-reset-slide-setting"
                                               name="reset-kb_end_rotate"/> <span id="label_kb_end_fit"
                                                                                  class="label"><?php _e('End Rotate:', 'revslider'); ?></span>
                                        ...
                                        <input type="checkbox" class="rs-ingore-save rs-reset-slide-setting"
                                               name="reset-kb_duration"/> <span id="label_kb_duration"
                                                                                class="label"><?php _e('Duration (in ms):', 'revslider'); ?></span>
                                    ...
                                    <input type="button" id="reset_slide_button"
                                           value="<?php _e('Overwrite Selected Settings on all Slides', 'revslider'); ?>"
                            ...
                            <div id="general-firstslide" style="display:none">
                                <span id="label_start_with_slide_enable" class="label"
                                      origtitle="<?php _e("Activate Alternative 1st Slide.", 'revslider'); ?>"><?php _e("Activate Alt. 1st Slide", 'revslider'); ?></span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="start_with_slide_enable"
                                       name="start_with_slide_enable"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "start_with_slide_enable", "off"), "on"); ?>>
                                ...
                                <div id="start_with_slide_row">
                                    <span id="label_start_with_slide" class="label"
                                          origtitle="<?php _e("Start from a different slide instead of the first slide. I.e. good for preview / edit mode.", 'revslider'); ?>"><?php _e("Alternative 1st Slide", 'revslider'); ?> </span>
                                ...
                                <span id="label_first_transition_active" class="label"
                                      origtitle="<?php _e("If active, it will overwrite the first slide transition. Use it to get special transition for the first slide.", 'revslider'); ?>"><?php _e("First Transition Active", 'revslider'); ?> </span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="first_transition_active"
                                       name="first_transition_active"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "first_transition_active", "off"), "on"); ?>>

                                <div class="clear"></div>

                                <div id="first_transition_row" class="withsublabels">
                                    <span id="label_first_transition_type" class="label"
                                          origtitle="<?php _e("First slide transition type", 'revslider'); ?>"><?php _e("Transition Type", 'revslider'); ?> </span>
                                    ...
                                    <span id="label_first_transition_duration" class="label"
                                          origtitle="<?php _e("First slide transition duration.", 'revslider'); ?>"><?php _e("Transition Duration", 'revslider'); ?> </span>
                                    <input type="text" class="text-sidebar withlabel" id="first_transition_duration"
                                    ...
                                    <span id="label_first_transition_slot_amount" class="label"
                                          origtitle="<?php _e("The number of slots or boxes the slide is divided into.", 'revslider'); ?>"><?php _e("Transition Slot Amount", 'revslider'); ?> </span>
                                    <input type="text" class="text-sidebar withlabel" id="first_transition_slot_amount"
                            ...
                            <div id="general-slideshow" style="display:block;">
                                <div class="dontshowonhero">
                                    ...
                                    <span id="label_stop_on_hover" class="label"
                                          origtitle="<?php _e("Stops the Timer when mouse is hovering the slider.", 'revslider'); ?>"><?php _e("Stop Slide On Hover", 'revslider'); ?></span>
                                    <input type="checkbox" class="tp-moderncheckbox withlabel" id="stop_on_hover"
                                           name="stop_on_hover"
                                           data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'stop_on_hover', 'off'), "on"); ?>>

                                    <div class="clear"></div>

                                    <!-- Stop Slider -->
                                    <span class="label label-with-subsection" id="label_stop_slider"
                                          origtitle="<?php _e("Stops the slideshow after the predefined loop amount at the predefined slide.", 'revslider'); ?>"><?php _e("Stop Slider After ...", 'revslider'); ?> </span>
                                    <input type="checkbox" class="tp-moderncheckbox withlabel" id="stop_slider"
                                           name="stop_slider"
                                           data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'stop_slider', 'off'), 'on'); ?>>
                                    ...
                                    <div id="stopoptionsofslider" class="withsublabels">
                                        ...
                                        <span class="label " id="label_stop_after_loops"
                                              origtitle="<?php _e("Stops the slider after certain amount of loops. 0 related to the first loop.", 'revslider'); ?>"><?php _e("Amount of Loops", 'revslider'); ?> </span>
                                        ...
                                        <span class="label" id="label_stop_at_slide"
                                              origtitle="<?php _e("Stops the slider at the given slide", 'revslider'); ?>"><?php _e("At Slide", 'revslider'); ?> </span>
                                    ...
                                    <span id="label_shuffle" class="label"
                                          origtitle="<?php _e("Randomize the order of the slides at every Page reload.", 'revslider'); ?>"><?php _e("Shuffle / Random Mode", 'revslider'); ?> </span>
                                    <input type="checkbox" class="tp-moderncheckbox withlabel" id="shuffle"
                                           name="shuffle"
                                           data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'shuffle', 'off'), "on"); ?>>

                                    <div class="clearfix"></div>

                                    <!-- Loop Single Slide -->
                                    <span class="label" id="label_loop_slide"
                                          origtitle="<?php _e("If only one Slide is in the Slider, you can choose wether the Slide should loop or if it should stop. If only one Slide exist, slide will be duplicated !", 'revslider'); ?>"><?php _e("Loop Single Slide", 'revslider'); ?> </span>
                                    <input type="checkbox" class="tp-moderncheckbox withlabel" id="loop_slide"
                                           name="loop_slide"
                                           data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'loop_slide', 'off'), "on"); ?>>
                                ...
                                <span class="label label-with-subsection"
                                      origtitle="<?php _e("Allow to stop the Slider out of viewport.", 'revslider'); ?>"><?php _e("Stop Slider Out of ViewPort", 'revslider'); ?> </span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="label_viewport"
                                       name="label_viewport"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'label_viewport', 'off'), 'on'); ?>>
                                ...
                                <div id="viewportoptionsofslider"
                                    ...
                                    <select name="viewport_start">
                                        <option
                                            value="wait" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'viewport_start', 'wait'), "wait"); ?>><?php _e("Wait", 'revslider'); ?></option>
                                        <option
                                            value="pause" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'viewport_start', 'wait'), "pause"); ?>><?php _e("Pause", 'revslider'); ?></option>
                                    </select>

                                    <div class="clear"></div>

                                    <span class="label" origmedia="show"
                                          origtitle="<?php _e("Min. Size of Slider must be in Viewport before slide starts again.", 'revslider'); ?>"><?php _e("Area out of ViewPort:", 'revslider'); ?> </span>
                            ...
                            <div id="general-progressbar" style="display:none">
                                ...
                                <span class="label" id="label_enable_progressbar" origmedia='show'
                                      origtitle="<?php _e("Enable / disable progress var", 'revslider'); ?>"><?php _e("Progress Bar Active", 'revslider'); ?> </span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="enable_progressbar"
                                       name="enable_progressbar"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "enable_progressbar", "off"), "on"); ?>>

                                <div id="progressbar_settings">
                                    <!-- Show Progressbar -->
                                    <span class="label" id="label_show_timerbar" origmedia="show"
                                          origtitle="<?php _e("Position of the progress bar.", 'revslider'); ?>"><?php _e("Progress Bar Position", 'revslider'); ?> </span>
                                    <select id="show_timerbar" name="show_timerbar" class="withlabel">
                                        <option
                                            value="top" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'show_timerbar', 'top'), "top"); ?>><?php _e("Top", 'revslider'); ?></option>
                                        <option
                                            value="bottom" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'show_timerbar', 'top'), "bottom"); ?>><?php _e("Bottom", 'revslider'); ?></option>
                                    </select>
                                    ...
                                    <span class="label" id="label_progress_height" origmedia="show"
                                          origtitle="<?php _e("The height of the progress bar", 'revslider'); ?>"><?php _e("Progress Bar Heigth", 'revslider'); ?> </span>
                                    ...
                                    <span class="label" id="label_progress_opa" origmedia="show"
                                          origtitle="<?php _e("The opacity of the progress bar <br>(0 == Transparent, 100 = Solid color, 50 = 50% opacity etc...)", 'revslider'); ?>"><?php _e("Progress Bar Opacity", 'revslider'); ?> </span>
                                    <input type="text" class="text-sidebar withlabel" id="progress_opa"
                                           name="progress_opa"
                                           value="<?php echo RevSliderFunctions::getVal($arrFieldsParams, 'progress_opa', '15'); ?>">
                                    <span><?php _e("%", 'revslider'); ?></span>
                                    ...
                                    <span class="label" id="label_progressbar_color" origmedia="show"
                                          origtitle="<?php _e("Color of the progress bar.", 'revslider'); ?>"><?php _e("Progress Bar Color", 'revslider'); ?> </span>
                                    <input type="text"
                                           class="my-color-field rs-layer-input-field tipsy_enabled_top withlabel"
                                           title="<?php _e("Font Color", 'revslider'); ?>" id="progressbar_color"
                                           name="progressbar_color"
                                           value="<?php echo RevSliderFunctions::getVal($arrFieldsParams, 'progressbar_color', '#000000'); ?>"/>
                    ...
                    <div class="setting_box">
                        ...
                        <div class="inside" style="display:none">
                            <ul class="main-options-small-tabs" style="display:inline-block; ">
                                <li data-content="#visual-appearance"
                                    class="selected"><?php _e('Appearance', 'revslider'); ?></li>
                            ...
                            <div id="visual-mobile" style="display:none">
                                <span class="label" id="label_disable_on_mobile"
                                      origtitle="<?php _e("If this is enabled, the slider will not be loaded on mobile devices.", 'revslider'); ?>"><?php _e("Disable Slider on Mobile", 'revslider'); ?></span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="disable_on_mobile"
                                       name="disable_on_mobile"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "disable_on_mobile", "off"), "on"); ?>>

                                <div class="clear"></div>


                                <span class="label" id="label_disable_kenburns_on_mobile"
                                      origtitle="<?php _e("This will disable KenBurns on mobile devices to save performance", 'revslider'); ?>"><?php _e("Disable KenBurn On Mobile", 'revslider'); ?></span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel"
                                       id="disable_kenburns_on_mobile" name="disable_kenburns_on_mobile"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "disable_kenburns_on_mobile", "off"), "on"); ?>>
                                ...
                                <span class="label" id="label_hide_slider_under"
                                      origtitle="<?php _e("Hide the slider under the defined slider width. Value 0 will disable the function.", 'revslider'); ?>"><?php _e("Slider", 'revslider'); ?></span>
                                ...
                                <span class="label" id="label_hide_defined_layers_under" style="font-size:12px"
                                      origtitle="<?php _e("Hide the selected layers (set layers hide under in slide editor) under the defined slider width. Value 0 will disable the function.", 'revslider'); ?>"><?php _e("Predefined Layers", 'revslider'); ?></span>
                                ...
                                <span class="label" id="label_hide_all_layers_under"
                                      origtitle="<?php _e("Hide all layers under the defined slider width. Value 0 will disable the function.", 'revslider'); ?>"><?php _e("All Layers", 'revslider'); ?></span>
                            ...
                            <div id="visual-appearance" style="display:block">
                                <div class="hide_on_ddd_parallax">
                                    <span class="label " id="label_shadow_type" origmedia='show'
                                          origtitle="<?php _e("The Shadow display underneath the banner.", 'revslider'); ?>"><?php _e("Shadow Type", 'revslider'); ?> </span>
                                    <select id="shadow_type" class="withlabel" name="shadow_type">
                                        <option
                                            value="0" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'shadow_type', '0'), "0"); ?>><?php _e("No Shadow", 'revslider'); ?></option>
                                        <option
                                            value="1" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'shadow_type', '0'), "1"); ?>>
                                            1
                                        </option>
                                        <option
                                            value="2" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'shadow_type', '0'), "2"); ?>>
                                            2
                                        </option>
                                        <option
                                            value="3" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'shadow_type', '0'), "3"); ?>>
                                            3
                                        </option>
                                        <option
                                            value="4" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'shadow_type', '0'), "4"); ?>>
                                            4
                                        </option>
                                        <option
                                            value="5" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'shadow_type', '0'), "5"); ?>>
                                            5
                                        </option>
                                        <option
                                            value="6" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'shadow_type', '0'), "6"); ?>>
                                            6
                                        </option>
                                    </select>
                                ...
                                <span class="label" id="label_background_dotted_overlay" origmedia="show"
                                      origtitle="<?php _e("Show a dotted overlay over the slides.", 'revslider'); ?>"><?php _e("Dotted Overlay Size", 'revslider'); ?> </span>
                                <select id="background_dotted_overlay" name="background_dotted_overlay"
                                        class="withlabel">
                                    <option
                                        value="none" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'background_dotted_overlay', 'none'), "none"); ?>><?php _e("none", 'revslider'); ?></option>
                                    <option
                                        value="twoxtwo" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'background_dotted_overlay', 'none'), "twoxtwo"); ?>><?php _e("2 x 2 Black", 'revslider'); ?></option>
                                    <option
                                        value="twoxtwowhite" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'background_dotted_overlay', 'none'), "twoxtwowhite"); ?>><?php _e("2 x 2 White", 'revslider'); ?></option>
                                    <option
                                        value="threexthree" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'background_dotted_overlay', 'none'), "threexthree"); ?>><?php _e("3 x 3 Black", 'revslider'); ?></option>
                                    <option
                                        value="threexthreewhite" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'background_dotted_overlay', 'none'), "threexthreewhite"); ?>><?php _e("3 x 3 White", 'revslider'); ?></option>
                                </select>
                                ...
                                <span class="label" id="label_background_color" origmedia="showbg"
                                      origtitle="<?php _e("General background color for slider. Clear value to get transparent slider container.", 'revslider'); ?>"><?php _e("Background color", 'revslider'); ?> </span>
                                <input type="text"
                                       class="my-color-field rs-layer-input-field tipsy_enabled_top withlabel"
                                       title="<?php _e("Font Color", 'revslider'); ?>" id="background_color"
                                ...
                                <span class="label" id="label_padding" origmedia="showbg"
                                      origtitle="<?php _e("Padding around the slider. Together with background color shows as slider border.", 'revslider'); ?>"><?php _e("Padding as Border", 'revslider'); ?> </span>
                                ...
                                <span class="label" id="label_show_background_image" origmedia="showbg"
                                      origtitle="<?php _e("Use a general background image instead of general background color.", 'revslider'); ?>"><?php _e("Show Background Image", 'revslider'); ?> </span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="show_background_image"
                                       name="show_background_image"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'show_background_image', 'off'), "on"); ?>>

                                <div class="clear"></div>

                                <div id="background_settings" class="withsublabels">
                                    <span class="label" id="label_background_image" origmedia="showbg"
                                          origtitle="<?php _e("The source of the general background image.", 'revslider'); ?>"><?php _e("Background Image Url", 'revslider'); ?> </span>
                                    ...
                                    <a href="javascript:void(0)"
                                       class="button-image-select-bg-img button-primary revblue"><?php _e('Set', 'revslider'); ?></a>

                                    <div class="clear"></div>

                                    <span class="label" id="label_bg_fit" origmedia="showbg"
                                          origtitle="<?php _e("General background image size. Cover - always fill the container, cuts overlays. Contain- always fits image into slider.", 'revslider'); ?>"><?php _e("Background Fit", 'revslider'); ?> </span>
                                    <select id="bg_fit" name="bg_fit" class="withlabel">
                                        <option
                                            value="cover" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bg_fit', 'cover'), "cover"); ?>><?php _e("cover", 'revslider'); ?></option>
                                        <option
                                            value="contain" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bg_fit', 'cover'), "contain"); ?>><?php _e("contain", 'revslider'); ?></option>
                                        <option
                                            value="normal" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bg_fit', 'cover'), "normal"); ?>><?php _e("normal", 'revslider'); ?></option>
                                    </select>

                                    <div class="clear"></div>

                                    <span class="label" id="label_bg_repeat" origmedia="showbg"
                                          origtitle="<?php _e("General background image repeat attitude. Used for tiled images.", 'revslider'); ?>"><?php _e("Background Repeat", 'revslider'); ?> </span>
                                    <select id="bg_repeat" name="bg_repeat" class="withlabel">
                                        <option
                                            value="no-repeat" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bg_repeat', 'no-repeat'), "no-repeat"); ?>><?php _e("no-repeat", 'revslider'); ?></option>
                                        <option
                                            value="repeat" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bg_repeat', 'no-repeat'), "repeat"); ?>><?php _e("repeat", 'revslider'); ?></option>
                                        <option
                                            value="repeat-x" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bg_repeat', 'no-repeat'), "repeat-x"); ?>><?php _e("repeat-x", 'revslider'); ?></option>
                                        <option
                                            value="repeat-y" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bg_repeat', 'no-repeat'), "repeat-y"); ?>><?php _e("repeat-y", 'revslider'); ?></option>
                                    </select>

                                    <div class="clear"></div>

                                    <span class="label" id="label_bg_position" origmedia="showbg"
                                          origtitle="<?php _e("General background image position.  i.e. center center to always center vertical and horizontal the image in the slider background.", 'revslider'); ?>"><?php _e("Background Position", 'revslider'); ?> </span>
                                    <select id="bg_position" name="bg_position" class="withlabel">
                                        <option
                                            value="center top" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bg_position', 'center center'), "center top"); ?>><?php _e("center top", 'revslider'); ?></option>
                                        <option
                                            value="center right" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bg_position', 'center center'), "center right"); ?>><?php _e("center right", 'revslider'); ?></option>
                                        <option
                                            value="center bottom" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bg_position', 'center center'), "center bottom"); ?>><?php _e("center bottom", 'revslider'); ?></option>
                                        <option
                                            value="center center" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bg_position', 'center center'), "center center"); ?>><?php _e("center center", 'revslider'); ?></option>
                                        <option
                                            value="left top" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bg_position', 'center center'), "left top"); ?>><?php _e("left top", 'revslider'); ?></option>
                                        <option
                                            value="left center" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bg_position', 'center center'), "left center"); ?>><?php _e("left center", 'revslider'); ?></option>
                                        <option
                                            value="left bottom" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bg_position', 'center center'), "left bottom"); ?>><?php _e("left bottom", 'revslider'); ?></option>
                                        <option
                                            value="right top" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bg_position', 'center center'), "right top"); ?>><?php _e("right top", 'revslider'); ?></option>
                                        <option
                                            value="right center" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bg_position', 'center center'), "right center"); ?>><?php _e("right center", 'revslider'); ?></option>
                                        <option
                                            value="right bottom" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bg_position', 'center center'), "right bottom"); ?>><?php _e("right bottom", 'revslider'); ?></option>
                                    </select>
                            ...
                            <div id="visual-position" style="display:none;">
                                <span class="label" id="label_position"
                                      origtitle="<?php _e("The position of the slider within the parrent container. (float:left or float:right or with margin:0px auto;). We recomment do use always CENTER, since the slider will auto fill and grow with the wrapping container. Set any border,padding, floating etc. to the wrapping container where the slider embeded instead of using left/right here !", 'revslider'); ?>"><?php _e("Position on the page", 'revslider'); ?> </span>
                                <select id="position" class="withlabel" name="position">
                                    <option
                                        value="left" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'position', 'center'), "left"); ?>><?php _e("Left", 'revslider'); ?></option>
                                    <option
                                        value="center" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'position', 'center'), "center"); ?>><?php _e("Center", 'revslider'); ?></option>
                                    <option
                                        value="right" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'position', 'center'), "right"); ?>><?php _e("Right", 'revslider'); ?></option>
                                </select>
                                ...
                                <span class="label" id="label_margin_top"
                                      origtitle="<?php _e("The top margin of the slider wrapper div", 'revslider'); ?>"><?php _e("Margin Top", 'revslider'); ?> </span>
                                <input type="text" class="text-sidebar withlabel" id="margin_top" name="margin_top"
                                ...
                                <span class="label" id="label_margin_bottom"
                                      origtitle="<?php _e("The bottom margin of the slider wrapper div", 'revslider'); ?>"><?php _e("Margin Bottom", 'revslider'); ?> </span>
                                ...
                                <div id="leftrightmargins">
                                    <span class="label" id="label_margin_left"
                                          origtitle="<?php _e("The left margin of the slider wrapper div", 'revslider'); ?>"><?php _e("Margin Left", 'revslider'); ?> </span>
                                    ...
                                    <span class="label" id="label_margin_right"
                                          origtitle="<?php _e("The right margin of the slider wrapper div", 'revslider'); ?>"><?php _e("Margin Right", 'revslider'); ?> </span>
                            ...
                            <div id="visual-spinner" style="display:none;">
                                ...
                                <span class="label" id="label_use_spinner"
                                      origtitle="<?php _e("Select a Spinner for your Slider", 'revslider'); ?>"><?php _e("Choose Spinner", 'revslider'); ?> </span>
                                <select id="use_spinner" name="use_spinner" class="withlabel">
                                    <option
                                        value="-1" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "use_spinner", "0"), "-1"); ?>><?php _e("Off", 'revslider'); ?></option>
                                    <option
                                        value="0" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "use_spinner", "0"), "0"); ?>><?php _e("0", 'revslider'); ?></option>
                                    <option
                                        value="1" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "use_spinner", "0"), "1"); ?>><?php _e("1", 'revslider'); ?></option>
                                    <option
                                        value="2" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "use_spinner", "0"), "2"); ?>><?php _e("2", 'revslider'); ?></option>
                                    <option
                                        value="3" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "use_spinner", "0"), "3"); ?>><?php _e("3", 'revslider'); ?></option>
                                    <option
                                        value="4" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "use_spinner", "0"), "4"); ?>><?php _e("4", 'revslider'); ?></option>
                                    <option
                                        value="5" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "use_spinner", "0"), "5"); ?>><?php _e("5", 'revslider'); ?></option>
                                </select>

                                <div class="clear"></div>
                                <div id="spinner_color_row">
                                    <span id="label_spinner_color" class="label"
                                          origtitle="<?php _e("The Color the Spinner will be shown in", 'revslider'); ?>"><?php _e("Spinner Color", 'revslider'); ?> </span>
                                    <input type="text"
                                           class="my-color-field rs-layer-input-field tipsy_enabled_top withlabel"
                                           title="<?php _e("Font Color", 'revslider'); ?>" id="spinner_color"
                                           name="spinner_color"
                    ...
                    <div class="setting_box dontshowonhero" id="navigation-settings-wrapper">
                        ...
                        <div class="inside" style="display:none;">
                            <ul class="main-options-small-tabs" style="display:inline-block; ">
                                <li data-content="#navigation-arrows"
                                    class="selected"><?php _e('Arrows', 'revslider'); ?></li>
                            ...
                            <div id="navigation-arrows">
                                <span class="label" id="label_enable_arrows"
                                      origtitle="<?php _e("Enable / Disable Arrows", 'revslider'); ?>"><?php _e("Enable Arrows", 'revslider'); ?> </span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="enable_arrows"
                                       name="enable_arrows"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "enable_arrows", "off"), "on"); ?>>

                                <div id="nav_arrows_subs">

                                    <span class="label triggernavstyle" id="label_navigation_arrow_style"
                                          origtitle="<?php _e("Look of the navigation Arrows", 'revslider'); ?>"><?php _e("Arrows Style", 'revslider'); ?></span>
                                    <select id="navigation_arrow_style" name="navigation_arrow_style"
                                            class=" withlabel triggernavstyle">
                                        <option
                                            value="" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'navigation_arrow_style', 'round'), ''); ?>><?php _e('No Style', 'revslider'); ?></option>
                                        <?php
                                        if (!empty($arr_navigations)) {
                                            foreach ($arr_navigations as $cur_nav) {
                                                if (isset($cur_nav['markup']['arrows'])) {
                                                    ?>
                                                    <option
                                                        value="<?php echo esc_attr($cur_nav['handle']); ?>" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'navigation_arrow_style', 'round'), esc_attr($cur_nav['handle'])); ?>><?php echo esc_attr($cur_nav['name']); ?></option>
                                                    <?php
                                                }
                                            }
                                        }
                                    ...
                                    <span class="label" id="label_arrows_always_on"
                                          origtitle="<?php _e("Enable to make arrows always visible. Disable to hide arrows after the defined time.", 'revslider'); ?>"><?php _e("Always Show ", 'revslider'); ?></span>
                                    <select id="arrows_always_on" name="arrows_always_on"
                                        ...
                                        <option
                                            value="false" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'arrows_always_on', 'false'), "false"); ?>><?php _e("Yes", 'revslider'); ?></option>
                                        <option
                                            value="true" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'arrows_always_on', 'false'), "true"); ?>><?php _e("No", 'revslider'); ?></option>
                                    </select>
                                    ...
                                    <div id="hide_after_arrow">
                                        <span class="label" id="label_hide_arrows"
                                              origtitle="<?php _e("Time after the Arrows will be hidden(Default: 200 ms)", 'revslider'); ?>"><?php _e("Hide After", 'revslider'); ?></span>
                                        ...
                                        <span class="label" id="label_hide_arrows_mobile"
                                              origtitle="<?php _e("Time after the Arrows will be hidden on Mobile(Default: 1200 ms)", 'revslider'); ?>"><?php _e("Hide After on Mobile", 'revslider'); ?></span>
                                        <input type="text" class="text-sidebar withlabel" id="hide_arrows_mobile"
                                               name="hide_arrows_mobile"
                                    ...
                                    <span class="label" id="label_hide_arrows_on_mobile"
                                          origtitle="<?php _e("Force Hide Navigation Arrows under width", 'revslider'); ?>"><?php _e("Hide Under", 'revslider'); ?> </span>
                                    <input type="checkbox" class="tp-moderncheckbox withlabel showhidewhat_truefalse"
                                           ...
                                           data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "hide_arrows_on_mobile", "off"), "on"); ?>>

                                    <div class="clear"></div>

                                    <div id="hide_under_arrow" class="withsublabels">
                                        <span id="label_arrows_under_hidden" class="label"
                                              origtitle="<?php _e("If browser size goes below this value, then Navigation Arrows are hidden.", 'revslider'); ?>"><?php _e("Width", 'revslider'); ?> </span>
                                        <input type="text" class="text-sidebar withlabel" id="arrows_under_hidden"
                                               name="arrows_under_hidden"
                                    ...
                                    <span class="label" id="label_hide_arrows_over"
                                          origtitle="<?php _e("Force Hide Navigation over width", 'revslider'); ?>"><?php _e("Hide Over", 'revslider'); ?> </span>
                                    <input type="checkbox" class="tp-moderncheckbox withlabel showhidewhat_truefalse"
                                           data-showhidetarget="hide_over_arrow" id="hide_arrows_over"
                                           name="hide_arrows_over"
                                           data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "hide_arrows_over", "off"), "on"); ?>>

                                    <div class="clear"></div>

                                    <div id="hide_over_arrow" class="withsublabels">
                                        <span id="label_arrows_over_hidden" class="label"
                                              origtitle="<?php _e("If browser size goes over this value, then Navigation Arrows are hidden.", 'revslider'); ?>"><?php _e("Width", 'revslider'); ?> </span>
                                        <input type="text" class="text-sidebar withlabel" id="arrows_over_hidden"
                                               name="arrows_over_hidden"
                                    ...
                                    <span class="label" id="label_leftarrow_align_hor"
                                          origtitle="<?php _e("Horizontal position of the left arrow.", 'revslider'); ?>"><?php _e("Horizontal Align", 'revslider'); ?></span>
                                    <select id="leftarrow_align_hor" name="leftarrow_align_hor" class="withlabel">
                                        <option
                                            value="left" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "leftarrow_align_hor", "left"), "left"); ?>><?php _e("Left", 'revslider'); ?></option>
                                        <option
                                            value="center" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "leftarrow_align_hor", "left"), "center"); ?>><?php _e("Center", 'revslider'); ?></option>
                                        <option
                                            value="right" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "leftarrow_align_hor", "left"), "right"); ?>><?php _e("Right", 'revslider'); ?></option>
                                    </select>
                                    ...
                                    <span class="label" id="label_leftarrow_align_vert"
                                          origtitle="<?php _e("Vertical position of the left arrow.", 'revslider'); ?>"><?php _e("Vertical Align", 'revslider'); ?> </span>
                                    <select id="leftarrow_align_vert" name="leftarrow_align_vert" class="withlabel">
                                        <option
                                            value="top" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "leftarrow_align_vert", "center"), "top"); ?>><?php _e("Top", 'revslider'); ?></option>
                                        <option
                                            value="center" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "leftarrow_align_vert", "center"), "center"); ?>><?php _e("Center", 'revslider'); ?></option>
                                        <option
                                            value="bottom" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "leftarrow_align_vert", "center"), "bottom"); ?>><?php _e("Bottom", 'revslider'); ?></option>
                                    </select>

                                    <div class="clear"></div>

                                    <span id="label_leftarrow_offset_hor" class="label"
                                          origtitle="<?php _e("Offset from current horizontal position of of left arrow.", 'revslider'); ?>"><?php _e("Horizontal Offset", 'revslider'); ?> </span>
                                    ...
                                    <span id="label_leftarrow_offset_vert" class="label"
                                          origtitle="<?php _e("Offset from current vertical position of of left arrow.", 'revslider'); ?>"><?php _e("Vertical Offset", 'revslider'); ?> </span>
                                    ...
                                    <span class="label" id="label_rightarrow_align_hor"
                                          origtitle="<?php _e("Horizontal position of the right arrow.", 'revslider'); ?>"><?php _e("Horizontal Align", 'revslider'); ?> </span>
                                    <select id="rightarrow_align_hor" name="rightarrow_align_hor" class="withlabel">
                                        <option
                                            value="left" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "rightarrow_align_hor", "right"), "left"); ?>><?php _e("Left", 'revslider'); ?></option>
                                        <option
                                            value="center" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "rightarrow_align_hor", "right"), "center"); ?>><?php _e("Center", 'revslider'); ?></option>
                                        <option
                                            value="right" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "rightarrow_align_hor", "right"), "right"); ?>><?php _e("Right", 'revslider'); ?></option>
                                    </select>
                                    ...
                                    <span id="label_rightarrow_align_vert" class="label"
                                          origtitle="<?php _e("Vertical position of the right arrow.", 'revslider'); ?>"><?php _e("Vertical Align", 'revslider'); ?> </span>
                                    <select id="rightarrow_align_vert" name="rightarrow_align_vert" class="withlabel">
                                        <option
                                            value="top" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "rightarrow_align_vert", "center"), "top"); ?>><?php _e("Top", 'revslider'); ?></option>
                                        <option
                                            value="center" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "rightarrow_align_vert", "center"), "center"); ?>><?php _e("Center", 'revslider'); ?></option>
                                        <option
                                            value="bottom" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "rightarrow_align_vert", "center"), "bottom"); ?>><?php _e("Bottom", 'revslider'); ?></option>
                                    </select>
                                    ...
                                    <span id="label_rightarrow_offset_hor" class="label"
                                          origtitle="<?php _e("Offset from current horizontal position of of right arrow.", 'revslider'); ?>"><?php _e("Horizontal Offset", 'revslider'); ?> </span>
                                    ...
                                    <span id="label_rightarrow_offset_vert" class="label"
                                          origtitle="<?php _e("Offset from current vertical position of of right arrow.", 'revslider'); ?>"><?php _e("Vertical Offset", 'revslider'); ?></span>
                                    <input type="text" class="text-sidebar withlabel" id="rightarrow_offset_vert"
                            ...
                            <div id="navigation-bullets" style="display:none;">
                                ...
                                <span class="label" id="label_enable_bullets"
                                      origtitle="<?php _e("Enable / Disable Bullets", 'revslider'); ?>"><?php _e("Enable Bullets", 'revslider'); ?> </span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="enable_bullets"
                                       name="enable_bullets"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "enable_bullets", "off"), "on"); ?>>

                                <div id="nav_bullets_subs">

                                    <span class="label triggernavstyle" id="label_navigation_bullets_style"
                                          origtitle="<?php _e("Look of the Bullets", 'revslider'); ?>"><?php _e("Bullet Style", 'revslider'); ?></span>
                                    <select id="navigation_bullets_style" name="navigation_bullets_style"
                                            class="triggernavstyle withlabel">
                                        <option
                                            value="" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'navigation_bullets_style', 'round'), ''); ?>><?php _e('No Style', 'revslider'); ?></option>
                                        <?php
                                        if (!empty($arr_navigations)) {
                                            foreach ($arr_navigations as $cur_nav) {
                                                if (isset($cur_nav['markup']['bullets'])) {
                                                    ?>
                                                    <option
                                                        value="<?php echo esc_attr($cur_nav['handle']); ?>" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'navigation_bullets_style', 'round'), esc_attr($cur_nav['handle'])); ?>><?php echo esc_attr($cur_nav['name']); ?></option>
                                                    <?php
                                                }
                                            }
                                        }
                                    ...
                                    <span class="label" id="label_bullets_space"
                                          origtitle="<?php _e("Space between the bullets.", 'revslider'); ?>"><?php _e("Space", 'revslider'); ?></span>
                                    ...
                                    <span class="label" id="label_bullets_direction"
                                          origtitle="<?php _e("Direction of the Bullets. Vertical or Horizontal.", 'revslider'); ?>"><?php _e("Direction", 'revslider'); ?></span>
                                    <select id="bullets_direction" name="bullets_direction" class=" withlabel">
                                        <option
                                            value="horizontal" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bullets_direction', 'horizontal'), "horizontal"); ?>><?php _e("Horizontal", 'revslider'); ?></option>
                                        <option
                                            value="vertical" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bullets_direction', 'horizontal'), "vertical"); ?>><?php _e("Vertical", 'revslider'); ?></option>
                                    </select>
                                    ...
                                    <span class="label" id="label_bullets_always_on"
                                          origtitle="<?php _e("Enable to make bullets always visible. Disable to hide bullets after the defined time.", 'revslider'); ?>"><?php _e("Always Show", 'revslider'); ?></span>
                                    <select id="bullets_always_on" name="bullets_always_on"
                                            class=" withlabel showhidewhat_truefalse"
                                            data-showhidetarget="hide_after_bullets">
                                        <option
                                            value="false" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bullets_always_on', 'false'), "false"); ?>><?php _e("Yes", 'revslider'); ?></option>
                                        <option
                                            value="true" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bullets_always_on', 'false'), "true"); ?>><?php _e("No", 'revslider'); ?></option>
                                    </select>

                                    <div class="clear"></div>
                                    <div id="hide_after_bullets">
                                        <span class="label" id="label_hide_bullets"
                                              origtitle="<?php _e("Time after that the bullets will be hidden(Default: 200 ms)", 'revslider'); ?>"><?php _e("Hide After", 'revslider'); ?></span>
                                        ...
                                        <span class="label" id="label_hide_bullets_mobile"
                                              origtitle="<?php _e("Time after the bullets will be hidden on Mobile (Default: 1200 ms)", 'revslider'); ?>"><?php _e("Hide After on Mobile", 'revslider'); ?></span>
                                        <input type="text" class="text-sidebar withlabel" id="hide_bullets_mobile"
                                               name="hide_bullets_mobile"
                                    ...
                                    <span class="label" id="label_hide_bullets_on_mobile"
                                          origtitle="<?php _e("Force Hide Navigation Bullets under width", 'revslider'); ?>"><?php _e("Hide under Width", 'revslider'); ?> </span>
                                    <input type="checkbox" class="tp-moderncheckbox withlabel showhidewhat_truefalse"
                                           data-showhidetarget="hide_under_bullet" id="hide_bullets_on_mobile"
                                           name="hide_bullets_on_mobile"
                                           data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "hide_bullets_on_mobile", "off"), "on"); ?>>

                                    <div class="clear"></div>

                                    <div id="hide_under_bullet" class="withsublabels">
                                        <span id="label_bullets_under_hidden" class="label"
                                              origtitle="<?php _e("If browser size goes below this value, then Navigation bullets are hidden.", 'revslider'); ?>"><?php _e("Width", 'revslider'); ?> </span>
                                        <input type="text" class="text-sidebar withlabel" id="bullets_under_hidden"
                                               name="bullets_under_hidden"
                                    ...
                                    <span class="label" id="label_hide_bullets_over"
                                          origtitle="<?php _e("Force Hide Navigation Bullets over width", 'revslider'); ?>"><?php _e("Hide over Width", 'revslider'); ?> </span>
                                    <input type="checkbox" class="tp-moderncheckbox withlabel showhidewhat_truefalse"
                                           data-showhidetarget="hide_over_bullet" id="hide_bullets_over"
                                           name="hide_bullets_over"
                                           data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "hide_bullets_over", "off"), "on"); ?>>
                                    ...
                                    <div id="hide_over_bullet" class="withsublabels">
                                        <span id="label_bullets_over_hidden" class="label"
                                              origtitle="<?php _e("If browser size goes below this value, then Navigation bullets are hidden.", 'revslider'); ?>"><?php _e("Width", 'revslider'); ?> </span>
                                        <input type="text" class="text-sidebar withlabel" id="bullets_over_hidden"
                                               name="bullets_over_hidden"
                                    ...
                                    <span class="label" id="label_bullets_align_hor"
                                          origtitle="<?php _e("Horizontal position of bullets "); ?>"><?php _e("Horizontal Align", 'revslider'); ?></span>
                                    <select id="bullets_align_hor" name="bullets_align_hor" class=" withlabel">
                                        <option
                                            value="left" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bullets_align_hor', 'center'), "left"); ?>><?php _e("Left", 'revslider'); ?></option>
                                        <option
                                            value="center" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bullets_align_hor', 'center'), "center"); ?>><?php _e("Center", 'revslider'); ?></option>
                                        <option
                                            value="right" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bullets_align_hor', 'center'), "right"); ?>><?php _e("Right", 'revslider'); ?></option>
                                    </select>

                                    <div class="clear"></div>

                                    <span class="label" id="label_bullets_align_vert"
                                          origtitle="<?php _e("Vertical positions of bullets ", 'revslider'); ?>"><?php _e("Vertical Align", 'revslider'); ?></span>
                                    <select id="bullets_align_vert" name="bullets_align_vert" class="withlabel">
                                        <option
                                            value="top" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bullets_align_vert', 'bottom'), "top"); ?>><?php _e("Top", 'revslider'); ?></option>
                                        <option
                                            value="center" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bullets_align_vert', 'bottom'), "center"); ?>><?php _e("Center", 'revslider'); ?></option>
                                        <option
                                            value="bottom" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'bullets_align_vert', 'bottom'), "bottom"); ?>><?php _e("Bottom", 'revslider'); ?></option>
                                    </select>

                                    <div class="clear"></div>

                                    <span class="label" id="label_bullets_offset_hor"
                                          origtitle="<?php _e("Offset from current horizontal position.", 'revslider'); ?>"><?php _e("Horizontal Offset", 'revslider'); ?></span>
                                    ...
                                    <span class="label" id="label_bullets_offset_vert"
                                          origtitle="<?php _e("Offset from current Vertical  position.", 'revslider'); ?>"><?php _e("Vertical Offset", 'revslider'); ?></span>
                            ...
                            <div id="navigation-thumbnails" style="display:none;">
                                <span class="label" id="label_enable_thumbnails"
                                      origtitle="<?php _e("Enable / Disable Thumbnails", 'revslider'); ?>"><?php _e("Enable Thumbnails", 'revslider'); ?> </span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="enable_thumbnails"
                                       name="enable_thumbnails"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "enable_thumbnails", "off"), "on"); ?>>
                                ...
                                <div id="nav_thumbnails_subs">
                                    ...
                                    <span class="label" id="label_thumbnails_padding"
                                          origtitle="<?php _e("The wrapper div padding of thumbnails", 'revslider'); ?>"><?php _e("Wrapper Padding", 'revslider'); ?> </span>
                                    ...
                                    <span class="label" id="label_span_thumbnails_wrapper"
                                          origtitle="<?php _e("Span wrapper to full width or full height based on the direction selected", 'revslider'); ?>"><?php _e("Span Wrapper", 'revslider'); ?> </span>
                                    <input type="checkbox" class="tp-moderncheckbox withlabel"
                                           id="span_thumbnails_wrapper" name="span_thumbnails_wrapper"
                                           data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "span_thumbnails_wrapper", "off"), "on"); ?>>


                                    <span class="label" id="label_thumbnails_wrapper_color"
                                          origtitle="<?php _e("Thumbnails wrapper background color. For transparent leave empty.", 'revslider'); ?>"><?php _e("Wrapper color", 'revslider'); ?> </span>
                                    <input type="text"
                                           class="my-color-field rs-layer-input-field tipsy_enabled_top withlabel"
                                           title="<?php _e("Wrapper Color", 'revslider'); ?>"
                                           id="thumbnails_wrapper_color" name="thumbnails_wrapper_color"
                                           value="<?php echo RevSliderFunctions::getVal($arrFieldsParams, 'thumbnails_wrapper_color', 'transparent'); ?>"/>

                                    <div class="clear"></div>

                                    <span class="label" id="label_thumbnails_wrapper_opacity"
                                          origtitle="<?php _e("Opacity of the Wrapper container. 0 - transparent, 50 - 50% opacity...", 'revslider'); ?>"><?php _e("Wrapper Opacity", 'revslider'); ?></span>
                                    <input type="text" class="text-sidebar withlabel" id="thumbnails_wrapper_opacity"
                                           name="thumbnails_wrapper_opacity"
                                           value="<?php echo RevSliderFunctions::getVal($arrFieldsParams, 'thumbnails_wrapper_opacity', '100'); ?>">
                                    ...
                                    <span class="label triggernavstyle" id="label_thumbnails_style"
                                          origtitle="<?php _e("Style of the thumbnails.", 'revslider'); ?>"><?php _e("Thumbnails Style", 'revslider'); ?></span>
                                    <select id="thumbnails_style" name="thumbnails_style"
                                            class="triggernavstyle withlabel">
                                        <option
                                            value="" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'thumbnails_style', 'round'), ''); ?>><?php _e('No Style', 'revslider'); ?></option>
                                        <?php
                                        if (!empty($arr_navigations)) {
                                            foreach ($arr_navigations as $cur_nav) {
                                                if (isset($cur_nav['markup']['thumbs'])) {
                                                    ?>
                                                    <option
                                                        value="<?php echo esc_attr($cur_nav['handle']); ?>" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'thumbnails_style', 'round'), esc_attr($cur_nav['handle'])); ?>><?php echo esc_attr($cur_nav['name']); ?></option>
                                                    <?php
                                                }
                                            }
                                        }
                                    ...
                                    <span id="label_thumb_amount" class="label"
                                          origtitle="<?php _e("The amount of max visible Thumbnails in the same time. ", 'revslider'); ?>"><?php _e("Visible Thumbs Amount", 'revslider'); ?></span>
                                    ...
                                    <span class="label" id="label_thumbnails_space"
                                          origtitle="<?php _e("Space between the thumbnails.", 'revslider'); ?>"><?php _e("Space", 'revslider'); ?></span>
                                    ...
                                    <span class="label" id="label_thumbnail_direction"
                                          origtitle="<?php _e("Direction of the Thumbnails. Vertical or Horizontal.", 'revslider'); ?>"><?php _e("Direction", 'revslider'); ?></span>
                                    <select id="thumbnail_direction" name="thumbnail_direction" class=" withlabel">
                                        <option
                                            value="horizontal" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'thumbnail_direction', 'horizontal'), "horizontal"); ?>><?php _e("Horizontal", 'revslider'); ?></option>
                                        <option
                                            value="vertical" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'thumbnail_direction', 'horizontal'), "vertical"); ?>><?php _e("Vertical", 'revslider'); ?></option>
                                    </select>
                                    ...
                                    <span id="label_thumb_width" class="label"
                                          origtitle="<?php _e("The basic Width of one Thumbnail Container.", 'revslider'); ?>"><?php _e("Container Width", 'revslider'); ?></span>
                                    ...
                                    <span id="label_thumb_height" class="label"
                                          origtitle="<?php _e("The basic Height of one Thumbnail.", 'revslider'); ?>"><?php _e("Container Height", 'revslider'); ?></span>
                                    ...
                                    <span id="label_thumb_width_min" class="label"
                                          origtitle="<?php _e("The minimum width of the auto resized thumbs. Between Max and Min width the sizes are auto calculated).", 'revslider'); ?>"><?php _e("Min Container Width", 'revslider'); ?></span>
                                    ...
                                    <span class="label" id="label_thumbs_always_on"
                                          origtitle="<?php _e("Enable to make thumbnails always visible. Disable to hide thumbnails after the defined time.", 'revslider'); ?>"><?php _e("Always Show ", 'revslider'); ?></span>
                                    <select id="thumbs_always_on" name="thumbs_always_on"
                                            class=" withlabel showhidewhat_truefalse"
                                            data-showhidetarget="hide_after_thumbs">
                                        <option
                                            value="false" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'thumbs_always_on', 'false'), "false"); ?>><?php _e("Yes", 'revslider'); ?></option>
                                        <option
                                            value="true" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'thumbs_always_on', 'false'), "true"); ?>><?php _e("No", 'revslider'); ?></option>
                                    </select>
                                    ...
                                    <div id="hide_after_thumbs">
                                        <span class="label" id="label_hide_thumbs"
                                              origtitle="<?php _e("Time after that the thumbnails will be hidden(Default: 200 ms)", 'revslider'); ?>"><?php _e("Hide After", 'revslider'); ?></span>
                                        ...
                                        <span class="label" id="label_hide_thumbs_mobile"
                                              origtitle="<?php _e("Time after that the thumbnails will be hidden on Mobile (Default: 1200 ms)", 'revslider'); ?>"><?php _e("Hide After on Mobile", 'revslider'); ?></span>
                                        <input type="text" class="text-sidebar withlabel" id="hide_thumbs_mobile"
                                               name="hide_thumbs_mobile"
                                    ...
                                    <span class="label" id="label_hide_thumbs_on_mobile"
                                          origtitle="<?php _e("Force Hide Navigation Thumbnails under width", 'revslider'); ?>"><?php _e("Hide under Width", 'revslider'); ?> </span>
                                    <input type="checkbox" class="tp-moderncheckbox withlabel showhidewhat_truefalse"
                                           data-showhidetarget="hide_under_thumb" id="hide_thumbs_on_mobile"
                                           name="hide_thumbs_on_mobile"
                                           data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "hide_thumbs_on_mobile", "off"), "on"); ?>>

                                    <div class="clear"></div>

                                    <div id="hide_under_thumb" class="withsublabels">
                                        <span id="label_thumbs_under_hidden" class="label"
                                              origtitle="<?php _e("If browser size goes below this value, then Navigation thumbs are hidden.", 'revslider'); ?>"><?php _e("Width", 'revslider'); ?> </span>
                                        <input type="text" class="text-sidebar withlabel" id="thumbs_under_hidden"
                                               name="thumbs_under_hidden"
                                    ...
                                    <span class="label" id="label_hide_thumbs_over"
                                          origtitle="<?php _e("Force Hide Navigation Thumbnails under width", 'revslider'); ?>"><?php _e("Hide over Width", 'revslider'); ?> </span>
                                    <input type="checkbox" class="tp-moderncheckbox withlabel showhidewhat_truefalse"
                                           data-showhidetarget="hide_over_thumb" id="hide_thumbs_over"
                                           name="hide_thumbs_over"
                                           data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "hide_thumbs_over", "off"), "on"); ?>>
                                    ...
                                    <div id="hide_over_thumb" class="withsublabels">
                                        <span id="label_thumbs_over_hidden" class="label"
                                              origtitle="<?php _e("If browser size goes below this value, then Navigation thumbs are hidden.", 'revslider'); ?>"><?php _e("Width", 'revslider'); ?> </span>
                                        <input type="text" class="text-sidebar withlabel" id="thumbs_over_hidden"
                                               name="thumbs_over_hidden"
                                    ...
                                    <span class="label" id="label_thumbnails_inner_outer"
                                          origtitle="<?php _e("Put the thumbnails inside or outside of the slider container. Outside added thumbnails will decrease the size of the slider."); ?>"><?php _e("Inner / outer", 'revslider'); ?></span>
                                    <select id="thumbnails_inner_outer" name="thumbnails_inner_outer"
                                            class=" withlabel">
                                        <option
                                            value="inner" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'thumbnails_inner_outer', 'inner'), "inner"); ?>><?php _e("Inner Slider", 'revslider'); ?></option>
                                        <option
                                            value="outer-left" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'thumbnails_inner_outer', 'inner'), "outer-left"); ?>><?php _e("Outer Left", 'revslider'); ?></option>
                                        <option
                                            value="outer-right" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'thumbnails_inner_outer', 'inner'), "outer-right"); ?>><?php _e("Outer Right", 'revslider'); ?></option>
                                        <option
                                            value="outer-top" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'thumbnails_inner_outer', 'inner'), "outer-top"); ?>><?php _e("Outer Top", 'revslider'); ?></option>
                                        <option
                                            value="outer-bottom" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'thumbnails_inner_outer', 'inner'), "outer-bottom"); ?>><?php _e("Outer Bottom", 'revslider'); ?></option>
                                    ...
                                    <span class="label" id="label_thumbnails_align_hor"
                                          origtitle="<?php _e("Horizontal position of thumbnails"); ?>"><?php _e("Horizontal Align", 'revslider'); ?></span>
                                    <select id="thumbnails_align_hor" name="thumbnails_align_hor" class=" withlabel">
                                        <option
                                            value="left" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'thumbnails_align_hor', 'center'), "left"); ?>><?php _e("Left", 'revslider'); ?></option>
                                        <option
                                            value="center" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'thumbnails_align_hor', 'center'), "center"); ?>><?php _e("Center", 'revslider'); ?></option>
                                        <option
                                            value="right" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'thumbnails_align_hor', 'center'), "right"); ?>><?php _e("Right", 'revslider'); ?></option>
                                    </select>

                                    <div class="clear"></div>

                                    <span class="label" id="label_thumbnails_align_vert"
                                          origtitle="<?php _e("Vertical position of thumbnails", 'revslider'); ?>"><?php _e("Vertical Align", 'revslider'); ?></span>
                                    <select id="thumbnails_align_vert" name="thumbnails_align_vert" class="withlabel">
                                        <option
                                            value="top" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'thumbnails_align_vert', 'bottom'), "top"); ?>><?php _e("Top", 'revslider'); ?></option>
                                        <option
                                            value="center" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'thumbnails_align_vert', 'bottom'), "center"); ?>><?php _e("Center", 'revslider'); ?></option>
                                        <option
                                            value="bottom" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'thumbnails_align_vert', 'bottom'), "bottom"); ?>><?php _e("Bottom", 'revslider'); ?></option>
                                    </select>
                                    ...
                                    <span class="label" id="label_thumbnails_offset_vert"
                                          origtitle="<?php _e("Offset from current Vertical position.", 'revslider'); ?>"><?php _e("Vertical Offset", 'revslider'); ?></span>
                                    <input type="text" class="text-sidebar withlabel" id="thumbnails_offset_vert"
                                           name="thumbnails_offset_vert"
                            ...
                            <div id="navigation-tabs" style="display:none;">
                                ...
                                <span class="label" id="label_enable_tabs"
                                      origtitle="<?php _e("Enable / Disable navigation tabs.", 'revslider'); ?>"><?php _e("Enable Tabs", 'revslider'); ?> </span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="enable_tabs"
                                       name="enable_tabs"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "enable_tabs", "off"), "on"); ?>>
                                ...
                                <div id="nav_tabs_subs">
                                    ...
                                    <span class="label" id="label_tabs_padding"
                                          origtitle="<?php _e("The wrapper div padding of tabs.", 'revslider'); ?>"><?php _e("Wrapper Padding", 'revslider'); ?> </span>
                                    ...
                                    <span class="label" id="label_span_tabs_wrapper"
                                          origtitle="<?php _e("Span wrapper to full width or full height based on the direction selected.", 'revslider'); ?>"><?php _e("Span Wrapper", 'revslider'); ?> </span>
                                    <input type="checkbox" class="tp-moderncheckbox withlabel" id="span_tabs_wrapper"
                                           name="span_tabs_wrapper"
                                           data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "span_tabs_wrapper", "off"), "on"); ?>>


                                    <span class="label" id="label_tabs_wrapper_color"
                                          origtitle="<?php _e("Tabs wrapper background color. For transparent leave empty.", 'revslider'); ?>"><?php _e("Wrapper Color", 'revslider'); ?> </span>
                                    <input type="text"
                                           class="my-color-field rs-layer-input-field tipsy_enabled_top withlabel"
                                           title="<?php _e("Wrapper Color", 'revslider'); ?>" id="tabs_wrapper_color"
                                           name="tabs_wrapper_color"
                                           value="<?php echo RevSliderFunctions::getVal($arrFieldsParams, 'tabs_wrapper_color', 'transparent'); ?>"/>

                                    <div class="clear"></div>

                                    <span class="label" id="label_tabs_wrapper_opacity"
                                          origtitle="<?php _e("Opacity of the Wrapper container. 0 - transparent, 50 - 50% opacity...", 'revslider'); ?>"><?php _e("Wrapper Opacity", 'revslider'); ?></span>
                                    <input type="text" class="text-sidebar withlabel" id="tabs_wrapper_opacity"
                                           name="tabs_wrapper_opacity"
                                           value="<?php echo RevSliderFunctions::getVal($arrFieldsParams, 'tabs_wrapper_opacity', '5'); ?>">
                                    ...
                                    <span class="triggernavstyle label" id="label_tabs_style"
                                          origtitle="<?php _e("Style of the tabs.", 'revslider'); ?>"><?php _e("Tabs Style", 'revslider'); ?></span>
                                    <select id="tabs_style" name="tabs_style" class="triggernavstyle withlabel">
                                        <option
                                            value="" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'tabs_style', 'round'), ''); ?>><?php _e('No Style', 'revslider'); ?></option>
                                        <?php
                                        if (!empty($arr_navigations)) {
                                            foreach ($arr_navigations as $cur_nav) {
                                                if (isset($cur_nav['markup']['tabs'])) {
                                                    ?>
                                                    <option
                                                        value="<?php echo esc_attr($cur_nav['handle']); ?>" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'tabs_style', 'round'), esc_attr($cur_nav['handle'])); ?>><?php echo esc_attr($cur_nav['name']); ?></option>
                                                    <?php
                                                }
                                            }
                                        }
                                    ...
                                    <span id="label_tabs_amount" class="label"
                                          origtitle="<?php _e("The amount of max visible tabs in same time.", 'revslider'); ?>"><?php _e("Visible Tabs Amount", 'revslider'); ?></span>
                                    ...
                                    <span class="label" id="label_tabs_space"
                                          origtitle="<?php _e("Space between the tabs.", 'revslider'); ?>"><?php _e("Space", 'revslider'); ?></span>
                                    <input type="text" class="text-sidebar withlabel" id="tabs_space" name="tabs_space"
                                    ...
                                    <span class="label" id="label_tabs_direction"
                                          origtitle="<?php _e("Direction of the Tabs. Vertical or Horizontal.", 'revslider'); ?>"><?php _e("Direction", 'revslider'); ?></span>
                                    <select id="tabs_direction" name="tabs_direction" class=" withlabel">
                                        <option
                                            value="horizontal" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'tabs_direction', 'horizontal'), "horizontal"); ?>><?php _e("Horizontal", 'revslider'); ?></option>
                                        <option
                                            value="vertical" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'tabs_direction', 'horizontal'), "vertical"); ?>><?php _e("Vertical", 'revslider'); ?></option>
                                    </select>
                                    ...
                                    <span id="label_tabs_width" class="label"
                                          origtitle="<?php _e("The basic width of one tab.", 'revslider'); ?>"><?php _e("Tabs Width", 'revslider'); ?></span>
                                    <input type="text" class="text-sidebar withlabel" id="tabs_width" name="tabs_width"
                                    ...
                                    <span id="label_tabs_height" class="label"
                                          origtitle="<?php _e("the basic height of one tab.", 'revslider'); ?>"><?php _e("Tabs Height", 'revslider'); ?></span>
                                    ...
                                    <span id="label_tabs_width_min" class="label"
                                          origtitle="<?php _e("The minimum width of the auto resized Tabs. Between Max and Min width the sizes are auto calculated).", 'revslider'); ?>"><?php _e("Min. Tab Width", 'revslider'); ?></span>
                                    ...
                                    <span class="label" id="label_tabs_always_on"
                                          origtitle="<?php _e("Enable to make tabs always visible. Disable to hide tabs after the defined time.", 'revslider'); ?>"><?php _e("Always Show ", 'revslider'); ?></span>
                                    <select id="tabs_always_on" name="tabs_always_on"
                                            class=" withlabel showhidewhat_truefalse"
                                            data-showhidetarget="hide_after_tabs">
                                        <option
                                            value="false" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'tabs_always_on', 'false'), "false"); ?>><?php _e("Yes", 'revslider'); ?></option>
                                        <option
                                            value="true" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'tabs_always_on', 'false'), "true"); ?>><?php _e("No", 'revslider'); ?></option>
                                    </select>
                                    ...
                                    <div id="hide_after_tabs">
                                        <span class="label" id="label_hide_tabs"
                                              origtitle="<?php _e("Time after that the tabs will be hidden(Default: 200 ms)", 'revslider'); ?>"><?php _e("Hide  After", 'revslider'); ?></span>
                                        ...
                                        <span class="label" id="label_hide_tabs_mobile"
                                              origtitle="<?php _e("Time after that the tabs will be hidden on Mobile (Default: 1200 ms)", 'revslider'); ?>"><?php _e("Hide  After on Mobile", 'revslider'); ?></span>
                                    ...
                                    <span class="label" id="label_hide_tabs_on_mobile"
                                          origtitle="<?php _e("Force Hide Navigation tabs under width", 'revslider'); ?>"><?php _e("Hide under Width", 'revslider'); ?> </span>
                                    <input type="checkbox" class="tp-moderncheckbox withlabel showhidewhat_truefalse"
                                           data-showhidetarget="hide_under_tab" id="hide_tabs_on_mobile"
                                           name="hide_tabs_on_mobile"
                                           data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "hide_tabs_on_mobile", "off"), "on"); ?>>

                                    <div class="clear"></div>

                                    <div id="hide_under_tab" class="withsublabels">
                                        <span id="label_tabs_under_hidden" class="label"
                                              origtitle="<?php _e("If browser size goes below this value, then Navigation tabs are hidden.", 'revslider'); ?>"><?php _e("Width", 'revslider'); ?> </span>
                                    ...
                                    <span class="label" id="label_hide_tabs_over"
                                          origtitle="<?php _e("Force Hide Navigation tabs under width", 'revslider'); ?>"><?php _e("Hide over Width", 'revslider'); ?> </span>
                                    <input type="checkbox" class="tp-moderncheckbox withlabel showhidewhat_truefalse"
                                           data-showhidetarget="hide_over_tab" id="hide_tabs_over" name="hide_tabs_over"
                                           data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "hide_tabs_over", "off"), "on"); ?>>
                                    ...
                                    <span class="label" id="label_tabs_inner_outer"
                                          origtitle="<?php _e("Put the tabs inside or outside of the slider container. Outside added tabs will decrease the size of the slider."); ?>"><?php _e("Inner / outer", 'revslider'); ?></span>
                                    <select id="tabs_inner_outer" name="tabs_inner_outer" class=" withlabel">
                                        <option
                                            value="inner" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'tabs_inner_outer', 'inner'), "inner"); ?>><?php _e("Inner Slider", 'revslider'); ?></option>
                                        <option
                                            value="outer-left" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'tabs_inner_outer', 'inner'), "outer-left"); ?>><?php _e("Outer Left", 'revslider'); ?></option>
                                        <option
                                            value="outer-right" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'tabs_inner_outer', 'inner'), "outer-right"); ?>><?php _e("Outer Right", 'revslider'); ?></option>
                                        <option
                                            value="outer-top" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'tabs_inner_outer', 'inner'), "outer-top"); ?>><?php _e("Outer Top", 'revslider'); ?></option>
                                        <option
                                            value="outer-bottom" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'tabs_inner_outer', 'inner'), "outer-bottom"); ?>><?php _e("Outer Bottom", 'revslider'); ?></option>
                                    ...
                                    <span class="label" id="label_tabs_align_hor"
                                          origtitle="<?php _e("Horizontal position of tabs."); ?>"><?php _e("Horizontal Align", 'revslider'); ?></span>
                                    <select id="tabs_align_hor" name="tabs_align_hor" class=" withlabel">
                                        <option
                                            value="left" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'tabs_align_hor', 'center'), "left"); ?>><?php _e("Left", 'revslider'); ?></option>
                                        <option
                                            value="center" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'tabs_align_hor', 'center'), "center"); ?>><?php _e("Center", 'revslider'); ?></option>
                                        <option
                                            value="right" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'tabs_align_hor', 'center'), "right"); ?>><?php _e("Right", 'revslider'); ?></option>
                                    </select>

                                    <div class="clear"></div>

                                    <span class="label" id="label_tabs_align_vert"
                                          origtitle="<?php _e("Vertical position of tabs.", 'revslider'); ?>"><?php _e("Vertical Align", 'revslider'); ?></span>
                                    <select id="tabs_align_vert" name="tabs_align_vert" class="withlabel">
                                        <option
                                            value="top" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'tabs_align_vert', 'bottom'), "top"); ?>><?php _e("Top", 'revslider'); ?></option>
                                        <option
                                            value="center" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'tabs_align_vert', 'bottom'), "center"); ?>><?php _e("Center", 'revslider'); ?></option>
                                        <option
                                            value="bottom" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'tabs_align_vert', 'bottom'), "bottom"); ?>><?php _e("Bottom", 'revslider'); ?></option>
                                    </select>

                                    <div class="clear"></div>

                                    <span class="label" id="label_tabs_offset_hor"
                                          origtitle="<?php _e("Offset from current horizontal position of tabs.", 'revslider'); ?>"><?php _e("Horizontal Offset", 'revslider'); ?></span>
                                    ...
                                    <span class="label" id="label_tabs_offset_vert"
                                          origtitle="<?php _e("Offset from current vertical position of tabs.", 'revslider'); ?>"><?php _e("Vertical Offset", 'revslider'); ?></span>
                            ...
                            <div id="navigation-touch" style="display:none;">
                                ...
                                <span class="label" id="label_touchenabled"
                                      origtitle="<?php _e("Enable Swipe Function on touch devices", 'revslider'); ?>"><?php _e("Touch Enabled", 'revslider'); ?> </span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="touchenabled"
                                       name="touchenabled"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "touchenabled", "off"), "on"); ?>>

                                <div class="clear"></div>

                                <span class="label" id="label_drag_block_vertical"
                                      origtitle="<?php _e("Scroll below slider on vertical swipe", 'revslider'); ?>"><?php _e("Drag Block Vertical", 'revslider'); ?> </span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="drag_block_vertical"
                                       name="drag_block_vertical"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "drag_block_vertical", "off"), "on"); ?>>

                                <div class="clear"></div>

                                <span class="label" id="label_swipe_velocity"
                                      origtitle="<?php _e("Defines the sensibility of gestures. Smaller values mean a higher sensibility", 'revslider'); ?>"><?php _e("Swipe Treshhold (0 - 200)", 'revslider'); ?> </span>
                                ...
                                <span class="label" id="label_swipe_min_touches"
                                      origtitle="<?php _e("Defines how many fingers are needed minimum for swiping", 'revslider'); ?>"><?php _e("Swipe Min Finger", 'revslider'); ?> </span>
                                <input type="text" class="text-sidebar withlabel" id="swipe_min_touches"
                                       name="swipe_min_touches"
                                       value="<?php echo RevSliderFunctions::getVal($arrFieldsParams, "swipe_min_touches", "50"); ?>">

                                <div class="clear"></div>

                                <span class="label" id="label_swipe_direction"
                                      origtitle="<?php _e("Swipe Direction to swap slides?", 'revslider'); ?>"><?php _e("Swipe Direction", 'revslider'); ?></span>
                                <select id="swipe_direction" name="swipe_direction" class="withlabel">
                                    <option
                                        value="horizontal" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'swipe_direction', 'horizontal'), "horizontal"); ?>><?php _e("Horizontal", 'revslider'); ?></option>
                                    <option
                                        value="vertical" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'swipe_direction', 'horizontal'), "vertical"); ?>><?php _e("Vertical", 'revslider'); ?></option>
                                </select>
                            ...
                            <div id="navigation-keyboard" style="display:none;">
                                <span class="label" id="label_keyboard_navigation"
                                      origtitle="<?php _e("Allow/disallow to navigate the slider with keyboard.", 'revslider'); ?>"><?php _e("Keyboard Navigation", 'revslider'); ?></span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="keyboard_navigation"
                                       name="keyboard_navigation"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'keyboard_navigation', 'off'), "on"); ?>>

                                <div class="clear"></div>

                                <span class="label" id="label_keyboard_direction"
                                      origtitle="<?php _e("Keyboard Direction to swap slides (horizontal - left/right arrow, vertical - up/down arrow)?", 'revslider'); ?>"><?php _e("Key Direction", 'revslider'); ?></span>
                                <select id="keyboard_direction" name="keyboard_direction" class="withlabel">
                                    <option
                                        value="horizontal" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'keyboard_direction', 'horizontal'), "horizontal"); ?>><?php _e("Horizontal", 'revslider'); ?></option>
                                    <option
                                        value="vertical" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'keyboard_direction', 'horizontal'), "vertical"); ?>><?php _e("Vertical", 'revslider'); ?></option>
                                </select>

                                <div class="clear"></div>

                                <span class="label" id="label_mousescroll_navigation"
                                      origtitle="<?php _e("Allow/disallow to navigate the slider with Mouse Scroll.", 'revslider'); ?>"><?php _e("Mouse Scroll Navigation", 'revslider'); ?></span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="mousescroll_navigation"
                                       name="mousescroll_navigation"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'mousescroll_navigation', 'off'), "on"); ?>>
                            ...
                            <div id="navigation-miniimagedimensions"
                                ...
                                <span id="label_previewimage_width" class="label"
                                      origtitle="<?php _e("The basic Width of one Preview Image.", 'revslider'); ?>"><?php _e("Preview Image Width", 'revslider'); ?></span>
                                ...
                                <span id="label_previewimage_height" class="label"
                                      origtitle="<?php _e("The basic Height of one Preview Image.", 'revslider'); ?>"><?php _e("Preview Image Height", 'revslider'); ?></span>
                        ...
                        <div class="inside" style="display: none;">
                            ...
                            <ul class="main-options-small-tabs" style="display:inline-block; ">
                                <li data-content="#carousel-basics"
                                    class="selected"><?php _e('Basics', 'revslider'); ?></li>
                            ...
                            <div id="carousel-basics">
                                ...
                                <span class="label" id="label_carousel_infinity"
                                      origtitle="<?php _e("Infinity Carousel Scroll. No Endpoints exists at first and last slide if valuse is set to ON.", 'revslider'); ?>"><?php _e("Infinity Scroll", 'revslider'); ?> </span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="carousel_infinity"
                                       name="carousel_infinity"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_infinity', 'off'), 'on'); ?>>

                                <div class="clearfix"></div>

                                <!-- Carousel Spaces -->
                                <span class="label" id="label_carousel_space"
                                      origtitle="<?php _e("The horizontal gap/space between the slides", 'revslider'); ?>"><?php _e("Space between slides", 'revslider'); ?> </span>
                                ...
                                <span class="label" id="label_carousel_borderr"
                                      origtitle="<?php _e("The border radius of slides", 'revslider'); ?>"><?php _e("Border Radius", 'revslider'); ?> </span>
                                <input style="width:60px;min-width:60px;max-width:60px;" type="text"
                                       class="text-sidebar withlabel" id="carousel_borderr" name="carousel_borderr"
                                       value="<?php echo RevSliderFunctions::getVal($arrFieldsParams, 'carousel_borderr', '0'); ?>">

                                <!-- Border Radius Unit -->
                                <select style="width:45px;min-width:45px;max-width:45px;" id="carousel_borderr_unit"
                                        name="carousel_borderr_unit">
                                    <option
                                        value="px" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_borderr_unit', 'px'), "px"); ?>><?php _e("px", 'revslider'); ?></option>
                                    <option
                                        value="%" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_borderr_unit', 'px'), "%"); ?>><?php _e("%", 'revslider'); ?></option>
                                </select>
                                ...
                                <span class="label" id="label_carousel_padding_top"
                                      origtitle="<?php _e("The padding top of slides", 'revslider'); ?>"><?php _e("Padding Top", 'revslider'); ?> </span>
                                <input type="text" class="text-sidebar withlabel" id="carousel_padding_top"
                                       name="carousel_padding_top"
                                       value="<?php echo RevSliderFunctions::getVal($arrFieldsParams, 'carousel_padding_top', '0'); ?>"> <?php _e('px', 'revslider'); ?>

                                <span class="label" id="label_carousel_padding_bottom"
                                      origtitle="<?php _e("The padding bottom of slides", 'revslider'); ?>"><?php _e("Padding Bottom", 'revslider'); ?> </span>
                                <input type="text" class="text-sidebar withlabel" id="carousel_padding_bottom"
                                       name="carousel_padding_bottom"
                                       value="<?php echo RevSliderFunctions::getVal($arrFieldsParams, 'carousel_padding_bottom', '0'); ?>"> <?php _e('px', 'revslider'); ?>

                                <!-- Carousel Max Visible Items -->
                                <span class="label" id="label_carousel_maxitems"
                                      origtitle="<?php _e("The maximum visible items in same time.", 'revslider'); ?>"><?php _e("Max. Visible Items", 'revslider'); ?> </span>
                                <select id="carousel_maxitems" class="withlabel" name="carousel_maxitems">
                                    <option
                                        value="1" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_maxitems', '3'), "1"); ?>><?php _e("1", 'revslider'); ?></option>
                                    <option
                                        value="3" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_maxitems', '3'), "3"); ?>><?php _e("3", 'revslider'); ?></option>
                                    <option
                                        value="5" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_maxitems', '3'), "5"); ?>><?php _e("5", 'revslider'); ?></option>
                                    <option
                                        value="7" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_maxitems', '3'), "7"); ?>><?php _e("7", 'revslider'); ?></option>
                                    <option
                                        value="9" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_maxitems', '3'), "9"); ?>><?php _e("9", 'revslider'); ?></option>
                                    <option
                                        value="11" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_maxitems', '3'), "11"); ?>><?php _e("11", 'revslider'); ?></option>
                                    <option
                                        value="13" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_maxitems', '3'), "13"); ?>><?php _e("13", 'revslider'); ?></option>
                                    <option
                                        value="15" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_maxitems', '3'), "15"); ?>><?php _e("15", 'revslider'); ?></option>
                                    <option
                                        value="17" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_maxitems', '3'), "17"); ?>><?php _e("17", 'revslider'); ?></option>
                                    <option
                                        value="19" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_maxitems', '3'), "19"); ?>><?php _e("19", 'revslider'); ?></option>
                                </select>

                                <!-- Carousel Stretch Out -->
                                <span class="label" id="label_carousel_stretch"
                                      origtitle="<?php _e("Stretch carousel element width to the wrapping container width.  Using this you can see only 1 item in same time.", 'revslider'); ?>"><?php _e("Stretch Element", 'revslider'); ?> </span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="carousel_stretch"
                                       name="carousel_stretch"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_stretch', 'off'), 'on'); ?>>
                            ...
                            <div id="carousel-trans" style="display:none">
                                ...
                                <span class="label" id="label_carousel_fadeout"
                                      origtitle="<?php _e("All elements out of focus will get some Opacity value based on the Distance to the current focused element, or only the coming/leaving elements.", 'revslider'); ?>"><?php _e("Fade All Elements", 'revslider'); ?> </span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="carousel_fadeout"
                                       name="carousel_fadeout"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_fadeout', 'on'), "on"); ?>>
                                ...
                                <div id="carousel-fade-row" class="withsublabels">
                                    ...
                                    <span class="label" id="label_carousel_varyfade"
                                          origtitle="<?php _e("Fade is varying based on the distance to the focused element.", 'revslider'); ?>"><?php _e("Varying Fade", 'revslider'); ?> </span>
                                    <input type="checkbox" class="tp-moderncheckbox withlabel" id="carousel_varyfade"
                                           name="carousel_varyfade"
                                           data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_varyfade', 'off'), "on"); ?>>
                                ...
                                <span class="label label-with-subsection" id="label_carousel_rotation"
                                      origtitle="<?php _e("Rotation enabled/disabled for not focused elements.", 'revslider'); ?>"><?php _e("Rotation", 'revslider'); ?> </span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="carousel_rotation"
                                       name="carousel_rotation"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_rotation', 'off'), "on"); ?>>
                                ...
                                <div id="carousel-rotation-row" class="withsublabels">
                                    ...
                                    <span class="label" id="label_carousel_varyrotate"
                                          origtitle="<?php _e("Rotation is varying based on the distance to the focused element.", 'revslider'); ?>"><?php _e("Varying Rotation", 'revslider'); ?> </span>
                                    <input type="checkbox" class="tp-moderncheckbox withlabel" id="carousel_varyrotate"
                                           name="carousel_varyrotate"
                                           data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_varyrotate', 'off'), "on"); ?>>

                                    <div class="clearfix"></div>

                                    <!-- Carousel Max Rotation -->
                                    <span class="label" id="label_carousel_maxrotation"
                                          origtitle="<?php _e("The maximum rotation of the Side elements. Rotation will depend on the element distance to the current focused element. 0 will turn off the Rotation", 'revslider'); ?>"><?php _e("Max. Rotation", 'revslider'); ?> </span>
                                ...
                                <span class="label label-with-subsection" id="label_carousel_scale"
                                      origtitle="<?php _e("Scale enabled/disabled for not focused elements.", 'revslider'); ?>"><?php _e("Scale", 'revslider'); ?> </span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="carousel_scale"
                                       name="carousel_scale"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_scale', 'off'), "on"); ?>>
                                ...
                                <div id="carousel-scale-row" class="withsublabels">
                                    ...
                                    <span class="label" id="label_carousel_varyscale"
                                          origtitle="<?php _e("Scale is varying based on the distance to the focused element.", 'revslider'); ?>"><?php _e("Varying Scale", 'revslider'); ?> </span>
                                    <input type="checkbox" class="tp-moderncheckbox withlabel" id="carousel_varyscale"
                                           name="carousel_varyscale"
                                           data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_varyscale', 'off'), "on"); ?>>

                                    <div class="clearfix"></div>

                                    <!-- Carousel Min Scale Down -->
                                    <span class="label" id="label_carousel_scaledown"
                                          origtitle="<?php _e("The maximum scale down of the Side elements. Scale will depend on the element distance to the current focused element. Min value is 0 and max value is 100.", 'revslider'); ?>"><?php _e("Max. Scaledown", 'revslider'); ?> </span>
                            ...
                            <div id="carousel-aligns" style="display:none">
                                ...
                                <span class="label" id="label_carousel_hposition"
                                      origtitle="<?php _e("Horizontal Align of the Carousel.", 'revslider'); ?>"><?php _e("Horizontal Aligns", 'revslider'); ?> </span>
                                <select id="carousel_hposition" class="withlabel" name="carousel_hposition">
                                    <option
                                        value="left" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_hposition', 'center'), "left"); ?>><?php _e("Left", 'revslider'); ?></option>
                                    <option
                                        value="center" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_hposition', 'center'), "center"); ?>><?php _e("Center", 'revslider'); ?></option>
                                    <option
                                        value="right" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_hposition', 'center'), "right"); ?>><?php _e("Right", 'revslider'); ?></option>
                                </select>

                                <div class="clear"></div>

                                <span class="label" id="label_carousel_vposition"
                                      origtitle="<?php _e("Vertical Align of the Carousel.", 'revslider'); ?>"><?php _e("Vertical Aligns", 'revslider'); ?> </span>
                                <select id="carousel_vposition" class="withlabel" name="carousel_vposition">
                                    <option
                                        value="top" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_vposition', 'center'), "top"); ?>><?php _e("Top", 'revslider'); ?></option>
                                    <option
                                        value="center" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_vposition', 'center'), "center"); ?>><?php _e("Center", 'revslider'); ?></option>
                                    <option
                                        value="bottom" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, 'carousel_vposition', 'center'), "bottom"); ?>><?php _e("Bottom", 'revslider'); ?></option>
                                </select>
                    ...
                    <div class="setting_box">
                        ...
                        <div class="inside" style="display:none">
                            <span class="label" id="label_use_parallax"
                                  origtitle="<?php _e("Enabling this, will give you new options in the slides to create a unique parallax effect", 'revslider'); ?>"><?php _e("Enable Parallax / 3D", 'revslider'); ?> </span>
                            <input type="checkbox" class="tp-moderncheckbox withlabel" id="use_parallax"
                                   name="use_parallax"
                                   data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "use_parallax", "off"), "on"); ?>>
                            ...
                            <div id="parallax_settings_row">
                                ...
                                <span id="label_disable_parallax_mobile" class="label"
                                      origtitle="<?php _e("If set to on, parallax will be disabled on mobile devices to save performance", 'revslider'); ?>"><?php _e("Disable on Mobile", 'revslider'); ?> </span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="disable_parallax_mobile"
                                       name="disable_parallax_mobile"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "disable_parallax_mobile", "off"), "on"); ?>>

                                <div class="clear"></div>

                                <span class="label" id="label_ddd_parallax"
                                      origtitle="<?php _e("Enabling this, will build a ddd_Rotating World of your Slides.", 'revslider'); ?>"><?php _e("3D", 'revslider'); ?> </span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="ddd_parallax"
                                       name="ddd_parallax"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "ddd_parallax", "off"), "on"); ?>>
                                ...
                                <div class="show_on_ddd_parallax">
                                    ...
                                    <div class="withsublabels">
                                        <span class="label" id="label_ddd_parallax_shadow"
                                              origtitle="<?php _e("Enabling 3D Shadow", 'revslider'); ?>"><?php _e("3D Shadow", 'revslider'); ?> </span>
                                        <input type="checkbox" class="tp-moderncheckbox withlabel"
                                               id="ddd_parallax_shadow" name="ddd_parallax_shadow"
                                               data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "ddd_parallax_shadow", "off"), "on"); ?>>

                                        <div class="clear"></div>

                                        <span class="label" id="label_ddd_parallax_bgfreeze"
                                              origtitle="<?php _e("BG 3D Disabled", 'revslider'); ?>"><?php _e("3D Background Disabled", 'revslider'); ?> </span>
                                        <input type="checkbox" class="tp-moderncheckbox withlabel"
                                               id="ddd_parallax_bgfreeze" name="ddd_parallax_bgfreeze"
                                               data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "ddd_parallax_bgfreeze", "off"), "on"); ?>>

                                        <div class="clear"></div>

                                        <span class="label" id="label_ddd_parallax_overflow"
                                              origtitle="<?php _e("If option is enabled, all slides and Layers are cropped by the Slider sides.", 'revslider'); ?>"><?php _e("Slider Overflow Hidden", 'revslider'); ?> </span>
                                        <input type="checkbox" class="tp-moderncheckbox withlabel"
                                               id="ddd_parallax_overflow" name="ddd_parallax_overflow"
                                               data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "ddd_parallax_overflow", "off"), "on"); ?>>

                                        <div class="clear"></div>

                                        <span class="label" id="label_ddd_parallax_layer_overflow"
                                              origtitle="<?php _e("If option enabled, Layers are cropped by the Grid Layer Dimensions to avoid Floated 3d Texts and hide Elements outside of the Slider.", 'revslider'); ?>"><?php _e("Layers Overflow Hidden", 'revslider'); ?> </span>
                                        <input type="checkbox" class="tp-moderncheckbox withlabel"
                                               id="ddd_parallax_layer_overflow" name="ddd_parallax_layer_overflow"
                                               data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "ddd_parallax_layer_overflow", "off"), "on"); ?>>
                                        ...
                                        <span class="label" id="label_ddd_parallax_zcorrection"
                                              origtitle="<?php _e("Solves issues in Safari Browser. It will move layers along z-axis if BG Freeze enabled to avoid 3d Rendering issues", 'revslider'); ?>"><?php _e("3D Crop Fix (z)", 'revslider'); ?> </span>
                                        <input type="text" class="text-sidebar withlabel" id="ddd_parallax_zcorrection"
                                               name="ddd_parallax_zcorrection"
                                ...
                                <div class="withsublabels">
                                    <div class="hide_on_ddd_parallax">
                                        <span id="label_parallax_type" class="label"
                                              origtitle="<?php _e("Defines on what event type the parallax should react to", 'revslider'); ?>"><?php _e("Event", 'revslider'); ?></span>
                                        <select id="parallax_type" name="parallax_type" class="withlabel">
                                            <option
                                                value="mouse" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "parallax_type", "mouse"), "mouse"); ?>><?php _e("Mouse Move", 'revslider'); ?></option>
                                            <option
                                                value="scroll" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "parallax_type", "mouse"), "scroll"); ?>><?php _e("Scroll Position", 'revslider'); ?></option>
                                            <option
                                                value="mouse+scroll" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "parallax_type", "mouse"), "mouse+scroll"); ?>><?php _e("Move and Scroll", 'revslider'); ?></option>
                                        </select>

                                        <div class="clear"></div>

                                        <span id="label_parallax_origo" class="label"
                                              origtitle="<?php _e("Mouse Based parallax calculation Origo", 'revslider'); ?>"><?php _e("Parallax Origo", 'revslider'); ?></span>
                                        <select id="parallax_origo" name="parallax_origo" class="withlabel">
                                            <option
                                                value="enterpoint" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "parallax_origo", "enterpoint"), "enterpoint"); ?>><?php _e("Mouse Enter Point", 'revslider'); ?></option>
                                            <option
                                                value="slidercenter" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "parallax_origo", "enterpoint"), "slidercenter"); ?>><?php _e("Slider Center", 'revslider'); ?></option>
                                        </select>
                                    ...
                                    <span class="label" id="label_parallax_speed"
                                          origtitle="<?php _e("Parallax Speed for Mouse movents.", 'revslider'); ?>"><?php _e("Animation Speed", 'revslider'); ?> </span>
                                    <input type="text" class="text-sidebar withlabel" id="parallax_speed"
                                           name="parallax_speed"
                                ...
                                <div class="withsublabels">
										<span class="show_on_ddd_parallax">
											<span class="label" id="label_parallax_level_16"
                                                  origtitle="<?php _e("Defines the Strength of the 3D Rotation on the Background and Layer Groups.  The Higher the Value the stronger the effect.  All other Depth will offset this default value !", 'revslider'); ?>"><span><?php _e("Default 3D Depth", 'revslider'); ?></span> </span>
                                    ...
                                    <span class="label" id="label_parallax_level_1"
                                          origtitle="<?php _e("Defines the strength of the effect. The higher the value, the stronger the effect. In 3D World the smaller Value comes to the front, and the Higher Value goes to the Background. Set for BG in 3D World the highest value always. Elements with higher z-index should get smaller values to make the effect perfect.", 'revslider'); ?>"><span
                                            class="hide_on_ddd_parallax"><?php _e("Level Depth 1", 'revslider'); ?></span><span
                                            class="show_on_ddd_parallax"><?php _e("Depth 1", 'revslider'); ?></span></span>
                                    ...
                                    <span class="label" id="label_parallax_level_2"
                                          origtitle="<?php _e("Defines the strength of the effect. The higher the value, the stronger the effect. In 3D World the smaller Value comes to the front, and the Higher Value goes to the Background. Set for BG in 3D World the highest value always. Elements with higher z-index should get smaller values to make the effect perfect.", 'revslider'); ?>"><span
                                            class="hide_on_ddd_parallax"><?php _e("Level Depth 2", 'revslider'); ?></span><span
                                            class="show_on_ddd_parallax"><?php _e("Depth 2", 'revslider'); ?></span> </span>
                                    ...
                                    <span class="label" id="label_parallax_level_3"
                                          origtitle="<?php _e("Defines the strength of the effect. The higher the value, the stronger the effect. In 3D World the smaller Value comes to the front, and the Higher Value goes to the Background. Set for BG in 3D World the highest value always. Elements with higher z-index should get smaller values to make the effect perfect.", 'revslider'); ?>"><span
                                            class="hide_on_ddd_parallax"><?php _e("Level Depth 3", 'revslider'); ?></span><span
                                            class="show_on_ddd_parallax"><?php _e("Depth 3", 'revslider'); ?></span> </span>
                                    ...
                                    <span class="label" id="label_parallax_level_4"
                                          origtitle="<?php _e("Defines the strength of the effect. The higher the value, the stronger the effect. In 3D World the smaller Value comes to the front, and the Higher Value goes to the Background. Set for BG in 3D World the highest value always. Elements with higher z-index should get smaller values to make the effect perfect.", 'revslider'); ?>"><span
                                            class="hide_on_ddd_parallax"><?php _e("Level Depth 4", 'revslider'); ?></span><span
                                            class="show_on_ddd_parallax"><?php _e("Depth 4", 'revslider'); ?></span> </span>
                                    ...
                                    <span class="label" id="label_parallax_level_5"
                                          origtitle="<?php _e("Defines the strength of the effect. The higher the value, the stronger the effect. In 3D World the smaller Value comes to the front, and the Higher Value goes to the Background. Set for BG in 3D World the highest value always. Elements with higher z-index should get smaller values to make the effect perfect.", 'revslider'); ?>"><span
                                            class="hide_on_ddd_parallax"><?php _e("Level Depth 5", 'revslider'); ?></span><span
                                            class="show_on_ddd_parallax"><?php _e("Depth 5", 'revslider'); ?></span> </span>
                                    ...
                                    <span class="label" id="label_parallax_level_6"
                                          origtitle="<?php _e("Defines the strength of the effect. The higher the value, the stronger the effect. In 3D World the smaller Value comes to the front, and the Higher Value goes to the Background. Set for BG in 3D World the highest value always. Elements with higher z-index should get smaller values to make the effect perfect.", 'revslider'); ?>"><span
                                            class="hide_on_ddd_parallax"><?php _e("Level Depth 6", 'revslider'); ?></span><span
                                            class="show_on_ddd_parallax"><?php _e("Depth 6", 'revslider'); ?></span> </span>
                                    ...
                                    <span class="label" id="label_parallax_level_7"
                                          origtitle="<?php _e("Defines the strength of the effect. The higher the value, the stronger the effect. In 3D World the smaller Value comes to the front, and the Higher Value goes to the Background. Set for BG in 3D World the highest value always. Elements with higher z-index should get smaller values to make the effect perfect.", 'revslider'); ?>"><span
                                            class="hide_on_ddd_parallax"><?php _e("Level Depth 7", 'revslider'); ?></span><span
                                            class="show_on_ddd_parallax"><?php _e("Depth 7", 'revslider'); ?></span> </span>
                                    ...
                                    <span class="label" id="label_parallax_level_8"
                                          origtitle="<?php _e("Defines the strength of the effect. The higher the value, the stronger the effect. In 3D World the smaller Value comes to the front, and the Higher Value goes to the Background. Set for BG in 3D World the highest value always. Elements with higher z-index should get smaller values to make the effect perfect.", 'revslider'); ?>"><span
                                            class="hide_on_ddd_parallax"><?php _e("Level Depth 8", 'revslider'); ?></span><span
                                            class="show_on_ddd_parallax"><?php _e("Depth 8", 'revslider'); ?></span> </span>
                                    ...
                                    <span class="label" id="label_parallax_level_9"
                                          origtitle="<?php _e("Defines the strength of the effect. The higher the value, the stronger the effect. In 3D World the smaller Value comes to the front, and the Higher Value goes to the Background. Set for BG in 3D World the highest value always. Elements with higher z-index should get smaller values to make the effect perfect.", 'revslider'); ?>"><span
                                            class="hide_on_ddd_parallax"><?php _e("Level Depth 9", 'revslider'); ?></span><span
                                            class="show_on_ddd_parallax"><?php _e("Depth 9", 'revslider'); ?></span> </span>
                                    ...
                                    <span class="label" id="label_parallax_level_10"
                                          origtitle="<?php _e("Defines the strength of the effect. The higher the value, the stronger the effect. In 3D World the smaller Value comes to the front, and the Higher Value goes to the Background. Set for BG in 3D World the highest value always. Elements with higher z-index should get smaller values to make the effect perfect.", 'revslider'); ?>"><span
                                            class="hide_on_ddd_parallax"><?php _e("Level Depth 10", 'revslider'); ?></span><span
                                            class="show_on_ddd_parallax"><?php _e("Depth 10", 'revslider'); ?></span> </span>
                                    ...
                                    <span class="label" id="label_parallax_level_11"
                                          origtitle="<?php _e("Defines the strength of the effect. The higher the value, the stronger the effect. In 3D World the smaller Value comes to the front, and the Higher Value goes to the Background. Set for BG in 3D World the highest value always. Elements with higher z-index should get smaller values to make the effect perfect.", 'revslider'); ?>"><span
                                            class="hide_on_ddd_parallax"><?php _e("Level Depth 11", 'revslider'); ?></span><span
                                            class="show_on_ddd_parallax"><?php _e("Depth 11", 'revslider'); ?></span> </span>
                                    ...
                                    <span class="label" id="label_parallax_level_12"
                                          origtitle="<?php _e("Defines the strength of the effect. The higher the value, the stronger the effect. In 3D World the smaller Value comes to the front, and the Higher Value goes to the Background. Set for BG in 3D World the highest value always. Elements with higher z-index should get smaller values to make the effect perfect.", 'revslider'); ?>"><span
                                            class="hide_on_ddd_parallax"><?php _e("Level Depth 12", 'revslider'); ?></span><span
                                            class="show_on_ddd_parallax"><?php _e("Depth 12", 'revslider'); ?></span> </span>
                                    ...
                                    <span class="label" id="label_parallax_level_13"
                                          origtitle="<?php _e("Defines the strength of the effect. The higher the value, the stronger the effect. In 3D World the smaller Value comes to the front, and the Higher Value goes to the Background. Set for BG in 3D World the highest value always. Elements with higher z-index should get smaller values to make the effect perfect.", 'revslider'); ?>"><span
                                            class="hide_on_ddd_parallax"><?php _e("Level Depth 13", 'revslider'); ?></span><span
                                            class="show_on_ddd_parallax"><?php _e("Depth 13", 'revslider'); ?></span> </span>
                                    ...
                                    <span class="label" id="label_parallax_level_14"
                                          origtitle="<?php _e("Defines the strength of the effect. The higher the value, the stronger the effect. In 3D World the smaller Value comes to the front, and the Higher Value goes to the Background. Set for BG in 3D World the highest value always. Elements with higher z-index should get smaller values to make the effect perfect.", 'revslider'); ?>"><span
                                            class="hide_on_ddd_parallax"><?php _e("Level Depth 14", 'revslider'); ?></span><span
                                            class="show_on_ddd_parallax"><?php _e("Depth 14", 'revslider'); ?></span> </span>
                                    ...
                                    <span class="label" id="label_parallax_level_15"
                                          origtitle="<?php _e("Defines the strength of the effect. The higher the value, the stronger the effect. In 3D World the smaller Value comes to the front, and the Higher Value goes to the Background. Set for BG in 3D World the highest value always. Elements with higher z-index should get smaller values to make the effect perfect.", 'revslider'); ?>"><span
                                            class="hide_on_ddd_parallax"><?php _e("Level Depth 15", 'revslider'); ?></span><span
                                            class="show_on_ddd_parallax"><?php _e("Depth 15", 'revslider'); ?></span> </span>
                    ...
                    if (!empty($sliderID)) {
                        ...
                        <div class="setting_box">
                            ...
                            <div class="inside" style="display:none;">
                                ...
                                ?>
                                <span id="label_seo_optimization" class="label"
                                      origtitle="<?php _e('Define SEO Optimization for the Images in the Slider, useful if Lazy Load is on.', 'revslider'); ?>"><?php _e('SEO Optimization', 'revslider'); ?> </span>
                                <select id="seo_optimization" name="seo_optimization" class="withlabel">
                                    <option
                                        value="none" <?php selected($seo_opti, 'none'); ?>><?php _e("None", 'revslider'); ?></option>
                                    <option
                                        value="noscript" <?php selected($seo_opti, 'single'); ?>><?php _e("NoScript", 'revslider'); ?></option>
                                    <option
                                        value="noframe" <?php selected($seo_opti, 'smart'); ?>><?php _e("NoFrame", 'revslider'); ?></option>
                                </select>
                        ...
                        <div class="inside" style="display:none;">
                            <ul class="main-options-small-tabs" style="display:inline-block; ">
                                <li data-content="#problem-fallback"
                                    class="selected"><?php _e('Fallbacks', 'revslider'); ?></li>
                                <li id="phandling_menu" data-content="#problem-troubleshooting"
                                    class=""><?php _e('Troubleshooting', 'revslider'); ?></li>
                            </ul>
                            <div id="problem-fallback">
                                <span id="label_simplify_ie8_ios4" class="label"
                                      origtitle="<?php _e("Simplyfies the Slider on IOS4 and IE8", 'revslider'); ?>"><?php _e("Simplify on IOS4/IE8", 'revslider'); ?> </span>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="simplify_ie8_ios4"
                                       name="simplify_ie8_ios4"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "simplify_ie8_ios4", "off"), "on"); ?>>

                                <div class="clear"></div>

                                <div id="label_show_alternative_type" class="label"
                                     origtitle="<?php _e("Disables the Slider and load an alternative image instead", 'revslider'); ?>"><?php _e("Use Alternative Image", 'revslider'); ?> </div>
                                <select id="show_alternative_type" name="show_alternative_type" class="withlabel">
                                    <option
                                        value="off" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "show_alternative_type", "off"), "off"); ?>><?php _e("Off", 'revslider'); ?></option>
                                    <option
                                        value="mobile" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "show_alternative_type", "off"), "mobile"); ?>><?php _e("On Mobile", 'revslider'); ?></option>
                                    <option
                                        value="ie8" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "show_alternative_type", "off"), "ie8"); ?>><?php _e("On IE8", 'revslider'); ?></option>
                                    <option
                                        value="mobile-ie8" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "show_alternative_type", "off"), "mobile-ie8"); ?>><?php _e("On Mobile and IE8", 'revslider'); ?></option>
                                </select>
                                ...
                                <div class="enable_alternative_image">
                                    <div id="label_show_alternate_image" class="label"
                                         origtitle="<?php _e("The image that will be loaded instead of the slider.", 'revslider'); ?>"><?php _e("Alternate Image", 'revslider'); ?> </div>
                                    ...
                                    <a original-title="" href="javascript:void(0)"
                                       class="button-image-select-background-img button-primary revblue"><?php _e('Set', 'revslider'); ?></a>
                            ...
                            <div id="problem-troubleshooting" style="display:none;">
                                <div id="label_jquery_noconflict" class="label"
                                     origtitle="<?php _e("Turns on / off jquery noconflict mode. Try to enable this option if javascript conflicts exist on the page.", 'revslider'); ?>"><?php _e("JQuery No Conflict Mode", 'revslider'); ?> </div>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="jquery_noconflict"
                                       name="jquery_noconflict"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "jquery_noconflict", "off"), "on"); ?>>

                                <div class="clear"></div>

                                <span id="label_js_to_body" class="label"
                                      origtitle="<?php _e("Try this to fix some javascript conflicts of type: TypeError: tpj('#rev_slider_1_1').show().revolution is not a function", 'revslider'); ?>"><?php _e("Put JS Includes To Body", 'revslider'); ?> </span>
								<span id="js_to_body" class="withlabel">
									<input type="radio" id="js_to_body_1" value="true"
                                           name="js_to_body" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "js_to_body", "false"), "true"); ?>>
									<label for="js_to_body_1"
                                           style="cursor:pointer;margin-right:15px"><?php _e('On', 'revslider'); ?></label>
									<input type="radio" id="js_to_body_2" value="false"
                                           name="js_to_body" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "js_to_body", "false"), "false"); ?>>
									<label for="js_to_body_2"
                                           style="cursor:pointer;"><?php _e('Off', 'revslider'); ?></label>
								</span>

                                <div class="clear"></div>

                                <div id="label_output_type" class="label"
                                     origtitle="<?php _e("Activate a protection against wordpress output filters that adds html blocks to the shortcode output like P and BR.", 'revslider'); ?>"><?php _e("Output Filters Protection", 'revslider'); ?> </div>
                                <select id="output_type" name="output_type" style="max-width:105px" class="withlabel">
                                    <option
                                        value="none" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "output_type", "none"), "none"); ?>><?php _e("None", 'revslider'); ?></option>
                                    <option
                                        value="compress" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "output_type", "none"), "compress"); ?>><?php _e("By Compressing Output", 'revslider'); ?></option>
                                    <option
                                        value="echo" <?php selected(RevSliderFunctions::getVal($arrFieldsParams, "output_type", "none"), "echo"); ?>><?php _e("By Echo Output", 'revslider'); ?></option>
                                </select>

                                <div class="clear"></div>

                                <div id="label_jquery_debugmode" class="label phandlingstitle"
                                     origtitle="<?php _e("Turns on / off visible Debug Mode on Front End.", 'revslider'); ?>"><?php _e("Debug Mode", 'revslider'); ?> </div>
                                <input type="checkbox" class="tp-moderncheckbox withlabel" id="jquery_debugmode"
                                       name="jquery_debugmode"
                                       data-unchecked="off" <?php checked(RevSliderFunctions::getVal($arrFieldsParams, "jquery_debugmode", "off"), "on"); ?>>

                                <div class="clear"></div>

                                <div style="margin-top:15px"><a
                                        href="http://www.themepunch.com/faq/troubleshooting-tips-for-5-0/"
                                        target="_blank"><?php _e("Follow FAQ for Troubleshooting", 'revslider'); ?></a>
                                </div>
                            </div>
                        </div>
                        <script>
                        ...
                        <div class="inside" style="display:none">
                            ...
                            <div id="import-import">
                                <form name="import_slider_form" id="rs_import_slider_form"
                                    ...
                                    <span class="label label-with-subsection" id="label_update_animations"
                                          origtitle="<?php _e("Overwrite or append the custom animations due the new imported values ?", 'revslider'); ?>"><?php _e("Custom Animations", 'revslider'); ?> </span>
                                    <input class="withlabel" type="radio" name="update_animations" value="true"
                                           checked="checked"> <?php _e("overwrite", 'revslider') ?>
                                    <input class="withlabel" type="radio" name="update_animations"
                                           value="false"> <?php _e("append", 'revslider') ?>
                                    <div class="tp-clearfix"></div>

                                    <span class="label label-with-subsection" id="label_update_static_captions"
                                          origtitle="<?php _e("Overwrite or append the static styles due the new imported values ?", 'revslider'); ?>"><?php _e("Static Styles", 'revslider'); ?> </span>
                                    <input class="withlabel" type="radio" name="update_static_captions"
                                           value="true"> <?php _e("overwrite", 'revslider') ?>
                                    <input class="withlabel" type="radio" name="update_static_captions"
                                           value="false"> <?php _e("append", 'revslider') ?>
                                    <input class="withlabel" type="radio" name="update_static_captions" value="none"
                                           checked="checked"> <?php _e("ignore", 'revslider'); ?>
                                    <div class="tp-clearfix"></div>

                                    <div class="divide5"></div>
                                    <input type="submit" style="width:100%" class="button-primary revgreen"
                                           id="rs-submit-import-form"
                                           value="<?php _e('Import Slider', 'revslider'); ?>">
                                </form>
                                <div class="divide20"></div>
                                <div class="revred api-desc"
                                     style="padding:8px;color:#fff;font-weight:600;font-size:12px"><?php _e("Note! Style templates will be updated if they exist. Importing slider, will delete all the current slider settings and slides and replacing it with the imported content.", 'revslider') ?></div>

                            </div>

                            <div id="import-export" style="display:none">
                                <a id="button_export_slider" class='button-primary revgreen' href='javascript:void(0)'
                                   style="width:100%;text-align:center;"><?php _e("Export Slider", 'revslider') ?></a>

                                <div style="display: none;"><input type="checkbox"
                                                                   name="export_dummy_images"> <?php _e("Export with Dummy Images", 'revslider') ?>
                                </div>
                            </div>
                            ...
                            <div id="import-replace" style="display:none">
                                ...
                                <span class="label label-with-subsection" id="label_replace_url_from"
                                      origtitle="<?php _e("Replace all layer and backgorund image url's. example - replace from: http://localhost", 'revslider'); ?>"><?php _e("Replace From", 'revslider'); ?> </span>
                                ...
                                <span class="label label-with-subsection" id="label_replace_url_to"
                                      origtitle="<?php _e("Replace all layer and backgorund image url's. example - replace to: http://yoursite.com", 'revslider'); ?>"><?php _e("Replace To", 'revslider'); ?> </span>
                                ...
                                <a id="button_replace_url" class='button-primary revgreen' href='javascript:void(0)'
                                   style="width:100%; text-align:center;"><?php _e("Replace URL's", 'revslider') ?></a>

                                <div id="loader_replace_url" class="loader_round"
                                     style="display:none;"><?php _e("Replacing...", 'revslider') ?> </div>
                                <div id="replace_url_success" class="success_message" class="display:none;"></div>
                                <div class="divide20"></div>
                                <div class="revred api-desc"
                                     style="padding:8px;color:#fff;font-weight:600;font-size:12px"><?php _e("Note! The replace process is not reversible !", 'revslider') ?></div>
                            </div>
                        </div>
                    </div>
                    <?php
                        ...
                        <div class="inside" style="display:none">
                            <ul class="main-options-small-tabs" style="display:inline-block; ">
                                <li data-content="#api-method"
                                    class="selected"><?php _e('Methods', 'revslider'); ?></li>
                                <li data-content="#api-events" class=""><?php _e('Events', 'revslider'); ?></li>
                            </ul>
                            <div id="api-method">
                                <span class="label" id="label_apiapi1" style="min-width:130px"
                                      origtitle="<?php _e("Call this function to pause the slider.", 'revslider'); ?>"><?php _e("Pause Slider", 'revslider') ?>
                                    :</span>
                                <input type="text" style="width:180px" readonly class="api-input withlabel" id="apiapi1"
                                       value="<?php echo $api ?>.revpause();"></span>
                                <div class="tp-clearfix"></div>

                                <span class="label" id="label_apiapi2" style="min-width:130px"
                                      origtitle="<?php _e("Call this function to play the slider if it is paused.", 'revslider'); ?>"><?php _e("Resume Slider", 'revslider') ?>
                                    :</span>
                                <input type="text" style="width:180px" readonly class="api-input withlabel" id="apiapi2"
                                       value="<?php echo $api ?>.revresume();"></span>
                                <div class="tp-clearfix"></div>

                                <span class="label" id="label_apiapi3" style="min-width:130px"
                                      origtitle="<?php _e("Switch slider to previous slide.", 'revslider'); ?>"><?php _e("Previous Slide", 'revslider') ?>
                                    :</span>
                                <input type="text" style="width:180px" readonly class="api-input withlabel" id="apiapi3"
                                       value="<?php echo $api ?>.revprev();"></span>
                                <div class="tp-clearfix"></div>

                                <span class="label" id="label_apiapi4" style="min-width:130px"
                                      origtitle="<?php _e("Switch slider to next slide.", 'revslider'); ?>"><?php _e("Next Slide", 'revslider') ?>
                                    :</span>
                                <input type="text" style="width:180px" readonly class="api-input withlabel" id="apiapi4"
                                       value="<?php echo $api ?>.revnext();"></span>
                                <div class="tp-clearfix"></div>

                                <span class="label" id="label_apiapi5" style="min-width:130px"
                                      origtitle="<?php _e("Switch to the slide which is defined as parameter.", 'revslider'); ?>"><?php _e("Go To Slide", 'revslider') ?>
                                    :</span>
                                <input type="text" style="width:180px" readonly class="api-input withlabel" id="apiapi5"
                                       value="<?php echo $api ?>.revshowslide(2);"></span>
                                <div class="tp-clearfix"></div>

                                <span class="label" id="label_apiapi5" style="min-width:130px"
                                      origtitle="<?php _e("Switch to the slide which is defined as parameter.", 'revslider'); ?>"><?php _e("Go To Slide with ID", 'revslider') ?>
                                    :</span>
                                <input type="text" style="width:180px" readonly class="api-input withlabel" id="apiapi5"
                                ...
                                <span class="label" id="label_apiapi6" style="min-width:130px"
                                      origtitle="<?php _e("Get the amount of existing slides in the slider.", 'revslider'); ?>"><?php _e("Max Slides", 'revslider') ?>
                                    :</span>
                                <input type="text" style="width:180px" readonly class="api-input withlabel" id="apiapi6"
                                       value="<?php echo $api ?>.revmaxslide();"></span>
                                <div class="tp-clearfix"></div>

                                <span class="label" id="label_apiapi7" style="min-width:130px"
                                      origtitle="<?php _e("Get the current focused slide index.", 'revslider'); ?>"><?php _e("Current Slide", 'revslider') ?>
                                    :</span>
                                <input type="text" style="width:180px" readonly class="api-input withlabel" id="apiapi7"
                                       value="<?php echo $api ?>.revcurrentslide();"></span>
                                <div class="tp-clearfix"></div>

                                <span class="label" id="label_apiapi8" style="min-width:130px"
                                      origtitle="<?php _e("Get the previously played slide.", 'revslider'); ?>"><?php _e("Last Slide", 'revslider') ?>
                                    :</span>
                                <input type="text" style="width:180px" readonly class="api-input withlabel" id="apiapi8"
                                       value="<?php echo $api ?>.revlastslide();"></span>
                                <div class="tp-clearfix"></div>

                                <span class="label" id="label_apiapi9" style="min-width:130px"
                                      origtitle="<?php _e("Scroll page under the slider.", 'revslider'); ?>"><?php _e("External Scroll", 'revslider') ?>
                                    :</span>
                                <input type="text" style="width:180px" readonly class="api-input withlabel" id="apiapi9"
                                       value="<?php echo $api ?>.revscroll(offset);"></span>
                                <div class="tp-clearfix"></div>

                                <span class="label" id="label_apiapi10" style="min-width:130px"
                                      origtitle="<?php _e("Recalculate all positions, sizing etc in the slider.  This should be called i.e. if Slider was invisible and becomes visible without any window resize event.", 'revslider'); ?>"><?php _e("Redraw Slider", 'revslider') ?>
                                    :</span>
                                ...
                                <span class="label" id="label_apiapi11" style="min-width:130px"
                                      origtitle="<?php _e("Unbind all listeners, remove current animations and delete containers. Ready for Garbage collection.", 'revslider'); ?>"><?php _e("Kill Slider", 'revslider') ?>
                                    :</span>
                                <input type="text" style="width:180px" readonly class="api-input withlabel"
    ...
    //data.layer - <?php _e('Layer as jQuery Object', 'revslider'); ?>
            ...
            <div id="form_toolbar">
                    ...
                    <div class="toolbar-slider">
                        ...
                        <div class="toolbar-navigation-tabs">
                            ...
                            <div style="border-color:#fff" class="toolbar-navigation-tab"><span
                                    class="long-lorem-ipsum"></span><span class="short-lorem-ipsum"></span></div>
                ...
                <div class="toolbar-extended-info">
                    <i><?php _e('*Only Illustration, most changes are not visible.', 'revslider'); ?></i></div>
            </div>
        </div>
...
<div id="dialog-rs-add-new-setting-presets" title="<?php _e('Save Settings as Preset', 'revslider'); ?>"
     style="display:none;">
    <div class="settings_wrapper unite_settings_wide">
        ...
        <p><label><?php _e('Select Image', 'revslider'); ?></label> <input type="button" value="<?php _e('Select'); ?>"
...
<div class="rs-dialog-embed-slider" style="display: none;">
    ...
    <div style="margin:5px 0px; padding-left: 55px;">
        <div style="font-size:14px;margin-bottom:10px;"><strong><?php _e("Standard Embeding", 'revslider'); ?></strong>
        </div>
        <?php _e("For the", 'revslider'); ?>
        <b><?php _e("pages or posts editor", 'revslider'); ?></b> <?php _e("insert the shortcode:", 'revslider'); ?>
        <code class="rs-example-alias-1"></code>

        <div style="width:100%;height:10px"></div>
        <?php _e("From the", 'revslider'); ?>
        <b><?php _e("widgets panel", 'revslider'); ?></b> <?php _e("drag the \"Revolution Slider\" widget to the desired sidebar", 'revslider'); ?>
        <div style="width:100%;height:25px"></div>
        <div id="advanced-emeding" style="font-size:14px;margin-bottom:10px;">
            <strong><?php _e("Advanced Embeding", 'revslider'); ?></strong><i class="eg-icon-plus"></i></div>
        <div id="advanced-accord" style="display:none">
            <?php _e("From the", 'revslider'); ?>
            <b><?php _e("theme html", 'revslider'); ?></b> <?php _e("use", 'revslider'); ?>: <code>&lt?php putRevSlider(
                '<span class="rs-example-alias">alias</span>' ); ?&gt</code><br>
            <span><?php _e("To add the slider only to homepage use", 'revslider'); ?>: <code>&lt?php putRevSlider('<span
                        class="rs-example-alias"><?php echo $exampleID; ?></span>', 'homepage'); ?&gt</code></span></br>
            <span><?php _e("To add the slider on specific pages or posts use", 'revslider'); ?>: <code>&lt?php
                    putRevSlider('<span class="rs-example-alias"><?php echo $exampleID; ?></span>', '2,10'); ?&gt</code></span></br>
        </div>
...
<script type="text/html" id="tmpl-rs-preset-container">
    <span class="rs-preset-selector rs-preset-entry {{ data['type'] }} {{ data['class'] }} "
		...
		<span class="rs-preset-image"<# if( data['img'] !== '' ){ #> style="background-image: url({{ data['img'] }});"
            <# } #>>
                <# if( data['custom'] == true ){ #><span class="rev-update-preset"><i
                            class="revicon-pencil-1"></i></span><span class="rev-remove-preset"><i
                            class="revicon-cancel"></i></span>
                    <# } #>
		</span>
...
<script type="text/html" id="tmpl-rs-preset-googlefont">
    <div>
        <span class="label" style="min-width:100px"
              origtitle="<?php _e("Google Font String", 'revslider'); ?>"><?php _e("Font", 'revslider') ?>:</span>
