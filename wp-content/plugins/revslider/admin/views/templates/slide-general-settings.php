...
<div class="editor_buttons_wrapper  postbox unite-postbox"
     style="max-width:100% !important; min-width:1040px !important;">
    <div class="box-closed tp-accordion" style="border-bottom:5px solid #ddd;">
        <ul class="rs-slide-settings-tabs">
            <li data-content="#slide-main-image-settings-content" class="selected"><i style="height:45px"
                                                                                      class="rs-mini-layer-icon eg-icon-picture-1 rs-toolbar-icon"></i><span><?php _e("Main Background", 'revslider'); ?></span>
            </li>
            <li data-content="#slide-general-settings-content"><i style="height:45px"
                                                                  class="rs-mini-layer-icon rs-icon-chooser-2 rs-toolbar-icon"></i><?php _e("General Settings", 'revslider'); ?>
            </li>
            <li data-content="#slide-thumbnail-settings-content"><i style="height:45px"
                                                                    class="rs-mini-layer-icon eg-icon-flickr-1 rs-toolbar-icon"></i><?php _e("Thumbnail", 'revslider'); ?>
            </li>
            <li data-content="#slide-animation-settings-content" id="slide-animation-settings-content-tab"><i
                    style="height:45px"
                    class="rs-mini-layer-icon rs-icon-chooser-3 rs-toolbar-icon"></i><?php _e("Slide Animation", 'revslider'); ?>
            </li>
            <li data-content="#slide-seo-settings-content"><i style="height:45px"
                                                              class="rs-mini-layer-icon rs-icon-advanced rs-toolbar-icon"></i><?php _e("Link & Seo", 'revslider'); ?>
            </li>
            <li data-content="#slide-info-settings-content"><i style="height:45px; font-size:16px;"
                                                               class="rs-mini-layer-icon eg-icon-info-circled rs-toolbar-icon"></i><?php _e("Slide Info", 'revslider'); ?>
            </li>
        </ul>
        ...
        <form name="form_slide_params" id="form_slide_params" class="slide-main-settings-form">
            ...
            <div id="slide-main-image-settings-content" class="slide-main-settings-form">
                ...
                <ul class="rs-layer-main-image-tabs" style="display:inline-block; ">
                    ...
                    <li class="mainbg-sub-settings-selector"
                        data-content="#mainbg-sub-setting"><?php _e('Source Settings', 'revslider'); ?></li>
                    <li class="mainbg-sub-parallax-selector"
                        data-content="#mainbg-sub-parallax"><?php _e('Parallax / 3D', 'revslider'); ?></li>
                    <li class="mainbg-sub-kenburns-selector"
                        data-content="#mainbg-sub-kenburns"><?php _e('Ken Burns', 'revslider'); ?></li>
                </ul>
				...
				<span id="mainbg-sub-source" style="display:block">
					...
					<span class="diblock bg-settings-block">
                        ...
                        if ($slider_type == 'posts' || $slider_type == 'specific_posts' || $slider_type == 'woocommerce') {
                            ...
                            if ($slider_type == 'vimeo' || $slider_type == 'youtube' || $slider_type == 'instagram' || $slider_type == 'twitter') {
                                ...
                                <input type="radio" name="background_type" value="stream<?php echo $slider_type; ?>"
                                       ...
                                       data-bgtype="stream<?php echo $slider_type; ?>" <?php checked($bgType, 'stream' . $slider_type); ?>>
                                <span id="streamvideo_cover" class="streamvideo_cover"
									...
									<input type="checkbox" class="tp-moderncheckbox" id="stream_do_cover"
                                           ...
                                           data-unchecked="off" <?php checked($stream_do_cover, 'on'); ?>>
								</span>

                                <div class="tp-clearfix"></div>
                                <label><?php _e("Stream Video + Image", 'revslider'); ?></label>
                                <input type="radio" name="background_type" value="stream<?php echo $slider_type; ?>both"
                                       class="bgsrcchanger" data-callid="tp-bgimagewpsrc" data-imgsettings="on"
                                       data-bgtype="stream<?php echo $slider_type; ?>both" <?php checked($bgType, 'stream' . $slider_type . 'both'); ?>>
                                <span id="streamvideo_cover_both" class="streamvideo_cover_both"
									...
									<input type="checkbox" class="tp-moderncheckbox" id="stream_do_cover_both"
                                           ...
                                           data-unchecked="off" <?php checked($stream_do_cover_both, 'on'); ?>>
								</span>
                                <?php
                            }
                        } else {
						...
						<span id="tp-bgimagewpsrc" class="bgsrcchanger-div" style="display:none;margin-left:20px;">
							<a href="javascript:void(0)" id="button_change_image"
                               class="button-primary revblue"><?php _e("Change Image", 'revslider'); ?></a>
						</span>
						...
						<input type="radio" name="background_type" value="external" data-callid="tp-bgimageextsrc"
                               ...
                               id="radio_back_external" <?php checked($bgType, 'external'); ?>>
						...
						<span id="tp-bgimageextsrc" class="bgsrcchanger-div" style="display:none;margin-left:20px;">
							...
							<a href="javascript:void(0)" id="button_change_external"
                               class="button-primary revblue"><?php _e("Get External", 'revslider'); ?></a>
						</span>
						...
						<input type="radio" name="background_type" value="trans" data-callid="" class="bgsrcchanger"
                               data-bgtype="trans" id="radio_back_trans" <?php checked($bgType, 'trans'); ?>>
						<div class="tp-clearfix"></div>
						...
						<input type="radio" name="background_type" value="solid" data-callid="tp-bgcolorsrc"
                               ...
                               id="radio_back_solid" <?php checked($bgType, 'solid'); ?>>

                        <!-- THE COLOR SELECTOR -->
						<span id="tp-bgcolorsrc" class="bgsrcchanger-div" style="display:none;margin-left:20px;">
							<input type="text" name="bg_color" id="slide_bg_color" class="my-color-field"
						...
						<input type="radio" name="background_type" value="youtube" data-callid="tp-bgyoutubesrc"
                               ...
                               id="radio_back_youtube" <?php checked($bgType, 'youtube'); ?>>
						<div class="tp-clearfix"></div>
						...
						<span id="tp-bgyoutubesrc" class="bgsrcchanger-div" style="display:none; margin-left:20px;">
							...
							<input type="text" name="slide_bg_youtube" id="slide_bg_youtube"
                                   value="<?php echo $slideBGYoutube; ?>" <?php echo ($bgType != 'youtube') ? ' class="disabled"' : ''; ?>>
						...
						<input type="radio" name="background_type" value="vimeo" data-callid="tp-bgvimeosrc"
                               ...
                               id="radio_back_vimeo" <?php checked($bgType, 'vimeo'); ?>>
						<div class="tp-clearfix"></div>
						...
						<span id="tp-bgvimeosrc" class="bgsrcchanger-div" style="display:none; margin-left:20px;">
							...
							<input type="text" name="slide_bg_vimeo" id="slide_bg_vimeo"
                                   value="<?php echo $slideBGVimeo; ?>" <?php echo ($bgType != 'vimeo') ? ' class="disabled"' : ''; ?>>
						...
						<input type="radio" name="background_type" value="html5" data-callid="tp-bghtmlvideo"
                               ...
                               id="radio_back_htmlvideo" <?php checked($bgType, 'html5'); ?>>
						<div class="tp-clearfix"></div>
						...
						<span id="tp-bghtmlvideo" class="bgsrcchanger-div" style="display:none; margin-left:20px;">
							...
							<input type="text" name="slide_bg_html_ogv" id="slide_bg_html_ogv"
                                   value="<?php echo $slideBGhtmlogv; ?>" <?php echo ($bgType != 'html5') ? ' class="disabled"' : ''; ?>>
							<span class="vidsrcchanger-div" style="margin-left:20px;">
					...
					<span id="tp-bgimagesettings" class="bgsrcchanger-div" style="display:none;">
						...
						<p>
                            ...
                            <select id="alt_option" name="alt_option">
                                <option
                                    value="media_library" <?php selected($alt_option, 'media_library'); ?>><?php _e('From Media Library', 'revslider'); ?></option>
                                <option
                                    value="file_name" <?php selected($alt_option, 'file_name'); ?>><?php _e('From Filename', 'revslider'); ?></option>
                                <option
                                    value="custom" <?php selected($alt_option, 'custom'); ?>><?php _e('Custom', 'revslider'); ?></option>
                            </select>
                            <?php $alt_attr = RevSliderFunctions::getVal($slideParams, 'alt_attr', ''); ?>
                            <input style="<?php echo ($alt_option !== 'custom') ? 'display:none;' : ''; ?>" type="text"
                                   id="alt_attr" name="alt_attr" value="<?php echo $alt_attr; ?>">
                        </p>
					...
					<span id="video-settings" style="display: block;">
						<p>
                            <label for="video_force_cover"
                                   class="video-label"><?php _e('Force Cover:', 'revslider'); ?></label>
                            <input type="checkbox" class="tp-moderncheckbox" id="video_force_cover"
                                   name="video_force_cover"
                                   data-unchecked="off" <?php checked($video_force_cover, 'on'); ?>>
                        </p>
						<span id="video_dotted_overlay_wrap">
							...
							<select id="video_dotted_overlay" name="video_dotted_overlay" style="width:100px">
                                <option <?php selected($video_dotted_overlay, 'none'); ?>
                                    value="none"><?php _e('none', 'revslider'); ?></option>
                                <option <?php selected($video_dotted_overlay, 'twoxtwo'); ?>
                                    value="twoxtwo"><?php _e('2 x 2 Black', 'revslider'); ?></option>
                                <option <?php selected($video_dotted_overlay, 'twoxtwowhite'); ?>
                                    value="twoxtwowhite"><?php _e('2 x 2 White', 'revslider'); ?></option>
                                <option <?php selected($video_dotted_overlay, 'threexthree'); ?>
                                    value="threexthree"><?php _e('3 x 3 Black', 'revslider'); ?></option>
                                <option <?php selected($video_dotted_overlay, 'threexthreewhite'); ?>
                                    value="threexthreewhite"><?php _e('3 x 3 White', 'revslider'); ?></option>
                            </select>
						...
						<select id="video_ratio" name="video_ratio" style="width:100px">
                            <option <?php selected($video_ratio, '16:9'); ?>
                                value="16:9"><?php _e('16:9', 'revslider'); ?></option>
                            <option <?php selected($video_ratio, '4:3'); ?>
                                value="4:3"><?php _e('4:3', 'revslider'); ?></option>
                        </select>
						<p style="clear: both;"></p>
						<p>
                            <label for="video_ratio">
                            ...
                            <input type="text" value="<?php echo $video_start_at; ?>"
                                   name="video_start_at"> <?php _e('For Example: 00:17', 'revslider'); ?>
							<p style="clear: both;"></p>
                        </p>
                        <p>
                            <label for="video_ratio">
                            ...
                            <input type="text" value="<?php echo $video_end_at; ?>"
                                   name="video_end_at"> <?php _e('For Example: 02:17', 'revslider'); ?>
							<p style="clear: both;"></p>
                        </p>
                        <p>
                            <label for="video_loop"><?php _e('Loop Video:', 'revslider'); ?></label>
                            <select id="video_loop" name="video_loop" style="width: 200px;">
                                <option <?php selected($video_loop, 'none'); ?>
                                    value="none"><?php _e('Disable', 'revslider'); ?></option>
                                <option <?php selected($video_loop, 'loop'); ?>
                                    value="loop"><?php _e('Loop, Slide is paused', 'revslider'); ?></option>
                                <option <?php selected($video_loop, 'loopandnoslidestop'); ?>
                                    value="loopandnoslidestop"><?php _e('Loop, Slide does not stop', 'revslider'); ?></option>
                            </select>
                        </p>
						
						<p>
                            <label for="video_nextslide"><?php _e('Next Slide On End:', 'revslider'); ?></label>
                            <input type="checkbox" class="tp-moderncheckbox" id="video_nextslide" name="video_nextslide"
                                   data-unchecked="off" <?php checked($video_nextslide, 'on'); ?>>
                        </p>
						<p>
                            ...
                            <input type="checkbox" class="tp-moderncheckbox" id="video_force_rewind"
                                   ...
                                   data-unchecked="off" <?php checked($video_force_rewind, 'on'); ?>>
                        </p>
						...
						<p>
                            ...
                            <input type="checkbox" class="tp-moderncheckbox" id="video_mute" name="video_mute"
                                   data-unchecked="off" <?php checked($video_mute, 'on'); ?>>
                        </p>
						
						<p class="vid-rev-vimeo-youtube video_volume_wrapper">
                            <label for="video_volume"><?php _e('Video Volume:', 'revslider'); ?></label>
                            <input type="text" id="video_volume"
                                   name="video_volume" <?php echo esc_attr($video_volume); ?>>
                        </p>
						...
						<span id="vid-rev-youtube-options">
							<p>
                                ...
                                <select id="video_speed" name="video_speed" style="width:75px">
                                    <option <?php selected($video_speed, '0.25'); ?>
                                        value="0.25"><?php _e('0.25', 'revslider'); ?></option>
                                    <option <?php selected($video_speed, '0.50'); ?>
                                        value="0.50"><?php _e('0.50', 'revslider'); ?></option>
                                    <option <?php selected($video_speed, '1'); ?>
                                        value="1"><?php _e('1', 'revslider'); ?></option>
                                    <option <?php selected($video_speed, '1.5'); ?>
                                        value="1.5"><?php _e('1.5', 'revslider'); ?></option>
                                    <option <?php selected($video_speed, '2'); ?>
                                        value="2"><?php _e('2', 'revslider'); ?></option>
                                </select>
                            </p>
							<p>
                                <label><?php _e('Arguments YouTube:', 'revslider'); ?></label>
                                <input type="text" id="video_arguments" name="video_arguments" style="width:350px;"
                                       value="<?php echo esc_attr($video_arguments); ?>">
                            </p>
						</span>
						<p id="vid-rev-vimeo-options">
                            <label><?php _e('Arguments Vimeo:', 'revslider'); ?></label>
                            <input type="text" id="video_arguments_vim" name="video_arguments_vim" style="width:350px;"
                                   value="<?php echo esc_attr($video_arguments_vim); ?>">
                        </p>
					</span>
					...
					<span id="bg-setting-wrap">
						<p>
                            ...
                            <input type="text" name="bg_fit_x"
                                   style="min-width:54px;width:54px; <?php if ($bgFit != 'percentage') echo 'display: none; '; ?> width:60px;margin-right:10px"
						...
						<p>
                            <label for="slide_bg_position"
                                   id="bg-position-lbl"><?php _e('Background Position:', 'revslider'); ?></label>
							<span id="bg-start-position-wrapper">
								<select name="bg_position" id="slide_bg_position">
                                    <option value="center top"<?php selected($bgPosition, 'center top'); ?>>center top
                                    </option>
                                    <option value="center right"<?php selected($bgPosition, 'center right'); ?>>center
                                        right
                                    </option>
                                    <option value="center bottom"<?php selected($bgPosition, 'center bottom'); ?>>center
                                        bottom
                                    </option>
                                    <option value="center center"<?php selected($bgPosition, 'center center'); ?>>center
                                        center
                                    </option>
                                    ...
                                    <option value="right top"<?php selected($bgPosition, 'right top'); ?>>right top
                                    </option>
                                    <option value="right center"<?php selected($bgPosition, 'right center'); ?>>right
                                        center
                                    </option>
                                    <option value="right bottom"<?php selected($bgPosition, 'right bottom'); ?>>right
                                        bottom
                                    </option>
                                    <option value="percentage"<?php selected($bgPosition, 'percentage'); ?>>(x%, y%)
                                    </option>
                                </select>
								<input type="text" name="bg_position_x"
                                       style="min-width:54px;width:54px; <?php if ($bgPosition != 'percentage') echo 'display: none;'; ?>width:60px;margin-right:10px"
                        ...
                        if ($use_parallax == "off") {
                            ...
                            if ($parallaxisddd == "off") {
                                ...
                                <select name="slide_parallax_level" id="slide_parallax_level">
                                    <option
                                        value="-" <?php selected($slide_parallax_level, '-'); ?>><?php _e('No Parallax', 'revslider'); ?></option>
                                    <option value="1" <?php selected($slide_parallax_level, '1'); ?>>1 -
                                        (<?php echo $parallax_level[0]; ?>%)
                                    </option>
                                    <option value="2" <?php selected($slide_parallax_level, '2'); ?>>2 -
                                        (<?php echo $parallax_level[1]; ?>%)
                                    </option>
                                    <option value="3" <?php selected($slide_parallax_level, '3'); ?>>3 -
                                        (<?php echo $parallax_level[2]; ?>%)
                                    </option>
                                    <option value="4" <?php selected($slide_parallax_level, '4'); ?>>4 -
                                        (<?php echo $parallax_level[3]; ?>%)
                                    </option>
                                    <option value="5" <?php selected($slide_parallax_level, '5'); ?>>5 -
                                        (<?php echo $parallax_level[4]; ?>%)
                                    </option>
                                    <option value="6" <?php selected($slide_parallax_level, '6'); ?>>6 -
                                        (<?php echo $parallax_level[5]; ?>%)
                                    </option>
                                    <option value="7" <?php selected($slide_parallax_level, '7'); ?>>7 -
                                        (<?php echo $parallax_level[6]; ?>%)
                                    </option>
                                    <option value="8" <?php selected($slide_parallax_level, '8'); ?>>8 -
                                        (<?php echo $parallax_level[7]; ?>%)
                                    </option>
                                    <option value="9" <?php selected($slide_parallax_level, '9'); ?>>9 -
                                        (<?php echo $parallax_level[8]; ?>%)
                                    </option>
                                    <option value="10" <?php selected($slide_parallax_level, '10'); ?>>10 -
                                        (<?php echo $parallax_level[9]; ?>%)
                                    </option>
                                    <option value="11" <?php selected($slide_parallax_level, '11'); ?>>11 -
                                        (<?php echo $parallax_level[10]; ?>%)
                                    </option>
                                    <option value="12" <?php selected($slide_parallax_level, '12'); ?>>12 -
                                        (<?php echo $parallax_level[11]; ?>%)
                                    </option>
                                    <option value="13" <?php selected($slide_parallax_level, '13'); ?>>13 -
                                        (<?php echo $parallax_level[12]; ?>%)
                                    </option>
                                    <option value="14" <?php selected($slide_parallax_level, '14'); ?>>14 -
                                        (<?php echo $parallax_level[13]; ?>%)
                                    </option>
                                    <option value="15" <?php selected($slide_parallax_level, '15'); ?>>15 -
                                        (<?php echo $parallax_level[14]; ?>%)
                                    </option>
                                </select>
                            <?php } else {
                                if ($parallaxbgfreeze == "off") {
                                    ...
                                    <span
                                        style="display: inline-block;vertical-align: middle;line-height:32px"><i><?php _e('To Enable 3D Parallax for Background please change the Option "BG 3D Disabled" to "OFF" via the Slider Settings !', 'revslider'); ?></i></span>
                                    <?php
                                }
                            }
                        }
				...
				<span id="mainbg-sub-kenburns" style="display:none">
					<p>
                        ...
                        <input type="checkbox" class="tp-moderncheckbox withlabel" id="kenburn_effect"
                               name="kenburn_effect" data-unchecked="off" <?php checked($kenburn_effect, 'on'); ?>>
                    </p>
					<span
						...
						<p>
                            ...
                            <input style="min-width:54px;width:54px" type="text" name="kb_start_fit"
                                   value="<?php echo intval($kb_start_fit); ?>"/>
                            <label style="min-width:20px"><?php _e('To', 'revslider') ?></label>
                            <input style="min-width:54px;width:54px" type="text" name="kb_end_fit"
						...
						<p>
                            ...
                            <label style="min-width:40px"><?php _e('From', 'revslider'); ?></label>
                            <input style="min-width:54px;width:54px" type="text" name="kb_start_offset_x"
                                   value="<?php echo $kbStartOffsetX; ?>"/>
                            <label style="min-width:20px"><?php _e('To', 'revslider') ?></label>
                            <input style="min-width:54px;width:54px" type="text" name="kb_end_offset_x"
						...
						<p>
                            ...
                            <label style="min-width:40px"><?php _e('From', 'revslider'); ?></label>
                            <input style="min-width:54px;width:54px" type="text" name="kb_start_offset_y"
                                   value="<?php echo $kbStartOffsetY; ?>"/>
                            <label style="min-width:20px"><?php _e('To', 'revslider') ?></label>
                            <input style="min-width:54px;width:54px" type="text" name="kb_end_offset_y"
						...
						<p>
                            ...
                            <label style="min-width:40px"><?php _e('From', 'revslider'); ?></label>
                            <input style="min-width:54px;width:54px" type="text" name="kb_start_rotate"
                                   value="<?php echo $kbStartRotate; ?>"/>
                            <label style="min-width:20px"><?php _e('To', 'revslider') ?></label>
                            <input style="min-width:54px;width:54px" type="text" name="kb_end_rotate"
						...
						<p>
                            ...
                            <select name="kb_easing">
                                <option <?php selected($kb_easing, 'Linear.easeNone'); ?> value="Linear.easeNone">
                                    Linear.easeNone
                                </option>
                                <option <?php selected($kb_easing, 'Power0.easeIn'); ?> value="Power0.easeIn">
                                    Power0.easeIn (linear)
                                </option>
                                <option <?php selected($kb_easing, 'Power0.easeInOut'); ?> value="Power0.easeInOut">
                                    Power0.easeInOut (linear)
                                </option>
                                <option <?php selected($kb_easing, 'Power0.easeOut'); ?> value="Power0.easeOut">
                                    Power0.easeOut (linear)
                                </option>
                                <option <?php selected($kb_easing, 'Power1.easeIn'); ?> value="Power1.easeIn">
                                    Power1.easeIn
                                </option>
                                <option <?php selected($kb_easing, 'Power1.easeInOut'); ?> value="Power1.easeInOut">
                                    Power1.easeInOut
                                </option>
                                <option <?php selected($kb_easing, 'Power1.easeOut'); ?> value="Power1.easeOut">
                                    Power1.easeOut
                                </option>
                                <option <?php selected($kb_easing, 'Power2.easeIn'); ?> value="Power2.easeIn">
                                    Power2.easeIn
                                </option>
                                <option <?php selected($kb_easing, 'Power2.easeInOut'); ?> value="Power2.easeInOut">
                                    Power2.easeInOut
                                </option>
                                <option <?php selected($kb_easing, 'Power2.easeOut'); ?> value="Power2.easeOut">
                                    Power2.easeOut
                                </option>
                                <option <?php selected($kb_easing, 'Power3.easeIn'); ?> value="Power3.easeIn">
                                    Power3.easeIn
                                </option>
                                <option <?php selected($kb_easing, 'Power3.easeInOut'); ?> value="Power3.easeInOut">
                                    Power3.easeInOut
                                </option>
                                <option <?php selected($kb_easing, 'Power3.easeOut'); ?> value="Power3.easeOut">
                                    Power3.easeOut
                                </option>
                                <option <?php selected($kb_easing, 'Power4.easeIn'); ?> value="Power4.easeIn">
                                    Power4.easeIn
                                </option>
                                <option <?php selected($kb_easing, 'Power4.easeInOut'); ?> value="Power4.easeInOut">
                                    Power4.easeInOut
                                </option>
                                <option <?php selected($kb_easing, 'Power4.easeOut'); ?> value="Power4.easeOut">
                                    Power4.easeOut
                                </option>
                                <option <?php selected($kb_easing, 'Back.easeIn'); ?> value="Back.easeIn">Back.easeIn
                                </option>
                                <option <?php selected($kb_easing, 'Back.easeInOut'); ?> value="Back.easeInOut">
                                    Back.easeInOut
                                </option>
                                <option <?php selected($kb_easing, 'Back.easeOut'); ?> value="Back.easeOut">
                                    Back.easeOut
                                </option>
                                <option <?php selected($kb_easing, 'Bounce.easeIn'); ?> value="Bounce.easeIn">
                                    Bounce.easeIn
                                </option>
                                <option <?php selected($kb_easing, 'Bounce.easeInOut'); ?> value="Bounce.easeInOut">
                                    Bounce.easeInOut
                                </option>
                                <option <?php selected($kb_easing, 'Bounce.easeOut'); ?> value="Bounce.easeOut">
                                    Bounce.easeOut
                                </option>
                                <option <?php selected($kb_easing, 'Circ.easeIn'); ?> value="Circ.easeIn">Circ.easeIn
                                </option>
                                <option <?php selected($kb_easing, 'Circ.easeInOut'); ?> value="Circ.easeInOut">
                                    Circ.easeInOut
                                </option>
                                <option <?php selected($kb_easing, 'Circ.easeOut'); ?> value="Circ.easeOut">
                                    Circ.easeOut
                                </option>
                                <option <?php selected($kb_easing, 'Elastic.easeIn'); ?> value="Elastic.easeIn">
                                    Elastic.easeIn
                                </option>
                                <option <?php selected($kb_easing, 'Elastic.easeInOut'); ?> value="Elastic.easeInOut">
                                    Elastic.easeInOut
                                </option>
                                <option <?php selected($kb_easing, 'Elastic.easeOut'); ?> value="Elastic.easeOut">
                                    Elastic.easeOut
                                </option>
                                <option <?php selected($kb_easing, 'Expo.easeIn'); ?> value="Expo.easeIn">Expo.easeIn
                                </option>
                                <option <?php selected($kb_easing, 'Expo.easeInOut'); ?> value="Expo.easeInOut">
                                    Expo.easeInOut
                                </option>
                                <option <?php selected($kb_easing, 'Expo.easeOut'); ?> value="Expo.easeOut">
                                    Expo.easeOut
                                </option>
                                <option <?php selected($kb_easing, 'Sine.easeIn'); ?> value="Sine.easeIn">Sine.easeIn
                                </option>
                                <option <?php selected($kb_easing, 'Sine.easeInOut'); ?> value="Sine.easeInOut">
                                    Sine.easeInOut
                                </option>
                                <option <?php selected($kb_easing, 'Sine.easeOut'); ?> value="Sine.easeOut">
                                    Sine.easeOut
                                </option>
                                <option <?php selected($kb_easing, 'SlowMo.ease'); ?> value="SlowMo.ease">SlowMo.ease
                                </option>
                            </select>
                        </p>
						<p>
            ...
            <div id="slide-general-settings-content" style="display:none">
                ...
                <p style="display:none">
                    ...
                    <span
                        class="description"><?php _e("The title of the slide, will be shown in the slides list.", 'revslider'); ?></span>
                </p>
                ...
                <p>
                    ...
                    <span
                        class="description"><?php _e("A new delay value for the Slide. If no delay defined per slide, the delay defined via Options (9000ms) will be used.", 'revslider'); ?></span>
                </p>
                ...
                <p>
                    ...
                    <select id="state" name="state">
                        <option
                            value="published"<?php selected($state, 'published'); ?>><?php _e("Published", 'revslider'); ?></option>
                        <option
                            value="unpublished"<?php selected($state, 'unpublished'); ?>><?php _e("Unpublished", 'revslider'); ?></option>
                    </select>
                    <span
                        class="description"><?php _e("The state of the slide. The unpublished slide will be excluded from the slider.", 'revslider'); ?></span>
                </p>
                ...
                if (isset($slider) && $slider->isInited()) {
                    ...
                    if ($isWpmlExists && $useWpml == "on") {
                        ...
                        <p>
                            ...
                            <span
                                class="description"><?php _e("The language of the slide (uses WPML plugin).", 'revslider'); ?></span>
                        </p>
                        <?php
                    }
                }
                ...
                <p>
                    ...
                    <span
                        class="description"><?php _e("If set, slide will be visible after the date is reached.", 'revslider'); ?></span>
                </p>
                ...
                <p>
                    ...
                    <span
                        class="description"><?php _e("If set, slide will be visible till the date is reached.", 'revslider'); ?></span>
                </p>
                ...
                <p style="display:none">
					...
					<span style="display:inline-block; width:200px; margin-right:20px;">
						<input type="checkbox" class="tp-moderncheckbox withlabel" id="save_performance"
                               name="save_performance" data-unchecked="off" <?php checked($save_performance, "on"); ?>>
					</span>
                    <span
                        class="description"><?php _e("Slide End Transition will first start when last Layer has been removed.", 'revslider'); ?></span>
                </p>
            ...
            <div id="slide-thumbnail-settings-content" style="display:none">
                    ...
                    <div style="display:inline-block; vertical-align: top;">
                        <div id="slide_thumb_button_preview" class="setting-image-preview"><?php
                            if (intval($slide_thumb) > 0) {
                                ?>
                                <div
                                    style="width:100px;height:70px;background:url('<?php echo admin_url('admin-ajax.php'); ?>?action=revslider_show_image&amp;img=<?php echo $slide_thumb; ?>&amp;w=100&amp;h=70&amp;t=exact'); background-position:center center; background-size:cover;"></div>
                                <?php
                            } elseif ($slide_thumb !== '') {
                                ?>
                                <div
                                    style="width:100px;height:70px;background:url('<?php echo $slide_thumb; ?>'); background-position:center center; background-size:cover;"></div>
                                <?php
                            }
                            ?></div>
                        ...
                        <input type="button" id="slide_thumb_button_remove"
                               ...
                               class="button-image-remove button-primary revred" value="Remove" original-title="">
                        <span
                            class="description"><?php _e("Slide Thumbnail. If not set - it will be taken from the slide image.", 'revslider'); ?></span>
                    </div>
                </div>
                ...
                <p>
                    ...
                    <select name="thumb_dimension">
                        <option
                            value="slider" <?php selected($thumb_dimension, 'slider'); ?>><?php _e('From Slider Settings', 'revslider'); ?></option>
                        <option
                            value="orig" <?php selected($thumb_dimension, 'orig'); ?>><?php _e('Original Size', 'revslider'); ?></option>
                    </select>
                    <span
                        class="description"><?php _e("Width and height of thumbnails can be changed in the Slider Settings -> Navigation -> Thumbs tab.", 'revslider'); ?></span>
                </p>
                ...
                <p style="display:none;" class="show_on_thumbnail_exist">
					...
					<span style="display:inline-block; width:200px; margin-right:20px;line-height:27px">
						<input type="checkbox" class="tp-moderncheckbox" id="thumb_for_admin" name="thumb_for_admin"
                               data-unchecked="off" <?php checked($thumb_for_admin, 'on'); ?>>
					</span>
                    <span
                        class="description"><?php _e("Use the Thumbnail also for Admin purposes. This will use the selected Thumbnail to represent the Slide in all Slider Admin area.", 'revslider'); ?></span>
                </p>
            </div>
                ...
                <div id="slide_transition_row">
                    ...
                    <div id="slide_transition" multiple="" size="1" style="z-index: 100;">
                        ...
                        <div class="slide-trans-cur-selected-settings">
                            ...
                            <input type="text" class="small-text input-deepselects" id="slot_amount" name="slot_amount"
                                   value="<?php echo $slot_amount[0]; ?>" data-selects="1||Random||Custom||Default"
                                   data-svalues="1||random||3||default" data-icons="thumbs-up||shuffle||wrench||key">
                            <span class="tp-clearfix"></span>
                            <span
                                class="description"><?php _e("# of slots/boxes the slide is divided into.", 'revslider'); ?></span>
                            <span class="tp-clearfix"></span>
                            ...
                            <input type="text" class="small-text input-deepselects" id="transition_rotation"
                                   name="transition_rotation" value="<?php echo $transition_rotation[0]; ?>"
                            ...
                            <span class="tp-clearfix"></span>
                            <span
                                class="description"><?php _e("Start Rotation of Transition (deg).", 'revslider'); ?></span>
                            <span class="tp-clearfix"></span>
                            ...
                            <input type="text" class="small-text input-deepselects" id="transition_duration"
                                   name="transition_duration" value="<?php echo $transition_duration[0]; ?>"
                                   data-selects="300||Random||Custom||Default" data-svalues="500||random||650||default"
                                   data-icons="thumbs-up||shuffle||wrench||key">
                            <span class="tp-clearfix"></span>
                            <span
                                class="description"><?php _e("The duration of the transition.", 'revslider'); ?></span>
                            <span class="tp-clearfix"></span>
                            ...
                            <span class="tp-clearfix"></span>
                            <span
                                class="description"><?php _e("The easing of Appearing transition.", 'revslider'); ?></span>
                            <span class="tp-clearfix"></span>
                            ...
                            <span class="tp-clearfix"></span>
                            <span
                                class="description"><?php _e("The easing of Disappearing transition.", 'revslider'); ?></span>
            ...
            <div id="slide-info-settings-content" style="display:none">
                ...
                <p>
                    <?php _e('Parameter', 'revslider');
                    echo ' ' . $i; ?> <input type="text" name="params_<?php echo $i; ?>"
                                             value="<?php echo stripslashes(esc_attr(RevSliderFunctions::getVal($slideParams, 'params_' . $i, ''))); ?>">
                    <?php _e('Max. Chars', 'revslider'); ?> <input type="text" style="width: 50px; min-width: 50px;"
                                                                   name="params_<?php echo $i; ?>_chars"
                                                                   value="<?php echo esc_attr(RevSliderFunctions::getVal($slideParams, 'params_' . $i . '_chars', 10, RevSlider::FORCE_NUMERIC)); ?>">
                    <?php if ($slider_type !== 'gallery') { ?><i class="eg-icon-pencil rs-param-meta-open"
                                                                 data-curid="<?php echo $i; ?>"></i><?php } ?>
                </p>
                <?php
                }
                ?>
                ...
                <p>
                    ...
                    <span
                        class="description"><?php _e('Define a description here to show at the navigation if enabled in Slider Settings', 'revslider'); ?></span>
                </p>
            </div>
            ...
            <div id="slide-seo-settings-content" style="display:none">
                ...
                <p>
                    ...
                    <span
                        class="description"><?php _e('Adds a unique class to the li of the Slide like class="rev_special_class" (add only the classnames, seperated by space)', 'revslider'); ?></span>
                </p>
                ...
                <p>
                    ...
                    <span
                        class="description"><?php _e('Adds a unique ID to the li of the Slide like id="rev_special_id" (add only the id)', 'revslider'); ?></span>
                </p>
                ...
                <p>
                    ...
                    <span
                        class="description"><?php _e('Add as many attributes as you wish here. (i.e.: data-layer="firstlayer" data-custom="somevalue").', 'revslider'); ?></span>
                </p>
                ...
                <p>
                    ...
                    <select id="enable_link" name="enable_link">
                        <option
                            value="true"<?php selected($enable_link, 'true'); ?>><?php _e("Enable", 'revslider'); ?></option>
                        <option
                            value="false"<?php selected($enable_link, 'false'); ?>><?php _e("Disable", 'revslider'); ?></option>
                    </select>
                    <span
                        class="description"><?php _e('Link the Full Slide to an URL or Action.', 'revslider'); ?></span>
                </p>
                ...
                <div class="rs-slide-link-setting-wrapper">
                    ...
                    <p>
						...
						<span style="display:inline-block; width:200px; margin-right:20px;">
							<input type="radio" id="link_type_1" value="regular"
                                   name="link_type"<?php checked($enable_link, 'regular'); ?>><span
                                style="line-height:30px; vertical-align: middle; margin:0px 20px 0px 10px;"><?php _e('Regular', 'revslider'); ?></span>
							<input type="radio" id="link_type_2" value="slide"
                                   name="link_type"<?php checked($enable_link, 'slide'); ?>><span
                                style="line-height:30px; vertical-align: middle; margin:0px 20px 0px 10px;"><?php _e('To Slide', 'revslider'); ?></span>
						</span>
                        <span
                            class="description"><?php _e('Regular - Link to URL,  To Slide - Call a Slide Action', 'revslider'); ?></span>
                    </p>
                    ...
                    <div class="rs-regular-link-setting-wrap">
                        ...
                        <p>
                            ...
                            <span
                                class="description"><?php _e('A link on the whole slide pic (use {{link}} or {{meta:somemegatag}} in template sliders to link to a post or some other meta)', 'revslider'); ?></span>
                        </p>
                        ...
                        <p>
                            ...
                            <select id="link_open_in" name="link_open_in">
                                <option
                                    value="same"<?php selected($link_open_in, 'same'); ?>><?php _e('Same Window', 'revslider'); ?></option>
                                <option
                                    value="new"<?php selected($link_open_in, 'new'); ?>><?php _e('New Window', 'revslider'); ?></option>
                            </select>
                    ...
                    <p>
						...
						<span style="display:inline-block; width:200px; margin-right:20px;">
							<input type="radio" id="link_pos_1" value="front"
                                   name="link_pos"<?php checked($link_pos, 'front'); ?>><span
                                style="line-height:30px; vertical-align: middle; margin:0px 20px 0px 10px;"><?php _e('Front', 'revslider'); ?></span>
							<input type="radio" id="link_pos_2" value="back"
                                   name="link_pos"<?php checked($link_pos, 'back'); ?>><span
                                style="line-height:30px; vertical-align: middle; margin:0px 20px 0px 10px;"><?php _e('Back', 'revslider'); ?></span>
						</span>
                        <span
                            class="description"><?php _e('The z-index position of the link related to layers', 'revslider'); ?></span>
                    </p>
                </div>
            </div>
