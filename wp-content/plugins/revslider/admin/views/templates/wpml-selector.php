...
<div id="rev_lang_list">
    <div class="slide_langs_selector editor_buttons_wrapper  postbox unite-postbox"
         style="margin-bottom:20px; max-width:100% !important; min-width:1040px !important;">
        <div class="slide-main-settings-form" style="padding:15px;">

            <label style="display:inline-block; margin-right:15px;"><?php _e("Choose slide language", 'revslider'); ?>
                :</label>
            ...
            <ul class="list_slide_icons" style="display:inline-block; vertical-align: middle; margin-bottom:0px;">
                ...
                ?>
                <li>
                    <div id="icon_add_lang_<?php echo $slideID; ?>" class="icon_slide_lang_add" data-operation="add"
                         data-slideid="<?php echo $slideID; ?>"
                         data-origid="<?php echo $parent_id; ?>" <?php echo $addItemStyle; ?>></div>
                    <div class="icon_lang_loader loader_round" style="display:none"></div>
                </li>
            </ul>
        </div>
