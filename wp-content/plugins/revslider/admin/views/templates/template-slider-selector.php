        ...
        <div class="revolution-template-switcher">
            ...
            if (!empty($author_template_slider) && is_array($author_template_slider)) {
                foreach ($author_template_slider as $name => $v) {
                    ?>
                    <span data-showgroup="revolution-<?php echo sanitize_title($name); ?>"
                          class="revolution-templatebutton"><?php echo esc_attr($name); ?></span>
                    <?php
                }
            }
            ?>
...
<div id="dialog_import_template_slider" title="<?php _e("Import Template Slider", 'revslider'); ?>"
    ...
    <form action="<?php echo RevSliderBase::$url_ajax; ?>" enctype="multipart/form-data" method="post">
        ...
        <span style="margin-top:45px;display:block"><input type="submit"
                                                           ...
                                                           value="<?php _e("Import Template Slider", 'revslider'); ?>"></span>
        <span class="tp-clearfix"></span>
        <span
            style="font-weight: 700;"><?php _e("Note: style templates will be updated if they exist!", 'revslider'); ?></span>
        <table style="display: none;">
            ...
            <tr>
                ...
                <td><input type="radio" name="update_static_captions" value="false"> <?php _e("append", 'revslider'); ?>
                </td>
...
<div id="dialog_import_template_slider_from" title="<?php _e("Import Template Slider", 'revslider'); ?>"
