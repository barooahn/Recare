            ...
            foreach ($arrSlides as $slide) {
                ...
                <li id="slidelist_item_<?php echo $slideid; ?>" class="ui-state-default">
						...
						<span class="slide-col col-order">
                            ...
                            if ($state == "published") {
                                ...
                                <div class="icon_state state_published" data-slideid="<?php echo $slideid; ?>"
                                     title="<?php _e("Unpublish Slide", 'revslider'); ?>"></div>
                                <?php
                            } else {
                                ?>
                                <div class="icon_state state_unpublished" data-slideid="<?php echo $slideid; ?>"
                                     title="<?php _e("Publish Slide", 'revslider'); ?>"></div>
                                <?php
                            }
                            ?>

                            <div class="icon_slide_preview" title="<?php _e('Preview Slide', 'revslider'); ?>"
						...
						<span class="slide-col col-name">
							...
							<a class='button-primary revgreen' href='<?php echo $urlEditSlide; ?>'
                               style="width:120px; "><i
                                    class="revicon-pencil-1"></i><?php _e("Edit Slide", 'revslider'); ?></a>
						</span>
                            ...
                            switch ($bgType) {
                                ...
                                case "image":
                                    ...
                                    <div id="slide_image_<?php echo $slideid; ?>"
                                         ...
                                         class="slide_image"
                                         title="<?php _e('Slide Image - Click to change', 'revslider'); ?>"></div>
                                    <?php
                                    break;
                                case "solid":
						...
						<span class="slide-col col-operations">
							...
							<span class="loader_round loader_delete"
                                  style="display:none;"><?php _e("Deleting Slide...", 'revslider'); ?></span>
							<a id="button_duplicate_slide_<?php echo $slideid ?>" style="width:120px; "
                               class='button-primary revyellow button_duplicate_slide' href='javascript:void(0)'><i
                                    class="revicon-picture"></i><?php _e("Duplicate", 'revslider'); ?></a>
                            <?php
                            ...
                            <a id="button_copy_slide_<?php echo $slideid; ?>" class='<?php echo $copyButtonClass; ?>'
                               title="<?php echo $copyButtonTitle; ?>" style="width:120px; "
                               href='javascript:void(0)'><i
                                    class="revicon-picture"></i><?php _e("Copy / Move", 'revslider'); ?></a>
							<span class="loader_round loader_copy mtop_10 mleft_20 display_block"
                                  style="display:none;"><?php _e("Working...", 'revslider'); ?></span>
						</span>
