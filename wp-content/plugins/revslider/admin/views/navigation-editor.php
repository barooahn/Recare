...
<div class='wrap'>
    ...
    <div class="setting_box navig" style="margin-bottom: 20px;">
        <h3><span class="setting-step-number">1</span><span
                style="max-width: 400px;"><?php _e('Select the Navigation Category to Edit', 'revslider'); ?></span> <a
                original-title="" class="button-primary revblue" id="rs-add-new-navigation-element"
                href="javascript:void(0);"><?php _e('Add New', 'revslider'); ?></a></h3>
        ...
        <div class="table-titles">
            ...
            <div class="rs-nav-table-cell rs-nav-table-title"
                 style="width:auto;text-align:left;padding:0px 20px;"><?php _e('Actions', 'revslider'); ?></div>
        </div>
    ...
    <div class="setting_box navig" style="margin-bottom: 20px;">
        <div class="rs-editing-wrapper" style="display: none;">
            <h3 style="border:0;"><span class="setting-step-number">2</span><span
                    style="max-width: 400px;"><?php _e('Editing', 'revslider'); ?> <span
                        class="rs-nav-editing-title"></span></span> <a href="javascript:void(0);"
                                                                       class="button-primary revred rs-remove-nav-element"><?php _e('Remove', 'revslider'); ?></a>
            </h3>

            <div class="rs-editing-markups-wrap">
                <div class="rs-markup-selector">
                    <div class="rs-selector-title"><?php _e('Markup', 'revslider'); ?></div>
                    <span class="rs-editor-open-field"><i class="revicon-list-add"></i></span>
                </div>
                        ...
                        <div style="padding: 20px;" class="closemeshowhide">
                            <div class="helper-wrappers">
                                ...
                                <ul class="rs-element-list">
                                    ...
                                    <li><span class="libtn"><?php _e('Parameters', 'revslider'); ?><span
                                                class="more-values-available"></span></span>
                                        <ul style="display: none;" class="rs-element-add">
                                            <li data-call="params_special" data-paramid="title"><span
                                                    class="libtn"><?php _e('Slide Title', 'revslider'); ?></span></li>
                                            <li data-call="params_special" data-paramid="description"><span
                                                    class="libtn"><?php _e('Slide Description', 'revslider'); ?></span>
                                            </li>
                                            <?php
                                            for ($i = 1; $i <= 10; $i++) {
                                                ?>
                                                <li data-call="params_markup" data-paramid="<?php echo $i; ?>"><span
                                                        class="libtn"><?php _e('Parameter ', 'revslider'); ?><?php echo $i; ?></span>
                                                </li>
                                                <?php
                                            }
                                            ?>
                ...
                <div class="rs-css-selector open">
                    <div class="rs-selector-title"><?php _e('CSS', 'revslider'); ?></div>
                    <span class="rs-editor-open-field"><i class="revicon-list-add"></i></span>
                </div>
                    ...
                    <div class="rs-css-elements">
                        <div style="padding: 20px;" class="closemeshowhide">
                            <div class="helper-wrappers rea-open">
                                <h4><span class="libtn"><?php _e('Style Helper', 'revslider'); ?><span
                                            class="more-values-available"></span></span></h4>
                                <ul class="rs-element-list collapsable" style="display:block">
                                    <li data-call="color_value"><span
                                            class="libtn"><?php _e('Color Value', 'revslider'); ?><span
                                                class="more-values-available"></span></span>
                                        ...
                                        <div style="display: none;" class="rs-element-add rs-element-add-color">
                                            ...
                                            <a href="javascript:void(0);" id="rs-add-css-color"
                                               class="button-primary revblue"
                                               original-title=""><?php _e('Add', 'revslider'); ?></a>
                                        </div>
                                    </li>
                                    <li data-call="border_radius"><span
                                            class="libtn"><?php _e('Border Radius', 'revslider'); ?><span
                                                class="more-values-available"></span></span>

                                        <div style="display: none;" class="rs-element-add rs-element-add-border-radius">
                                            <label><?php _e('Top Left', 'revslider'); ?></label>
                                            <input class="rs-small-input" type="text" name="rs-border-radius-top-left"
                                                   value="1"></td>
                                            <label><?php _e('Top Right', 'revslider'); ?></label>
                                            <input class="rs-small-input" type="text" name="rs-border-radius-top-right"
                                                   value="1"></td>
                                            <label><?php _e('Bottom Right', 'revslider'); ?></label>
                                            <input class="rs-small-input" type="text"
                                                   name="rs-border-radius-bottom-right" value="1"></td>
                                            <label><?php _e('Bottom Left', 'revslider'); ?></label>
                                            <input class="rs-small-input" type="text"
                                                   name="rs-border-radius-bottom-left" value="1"></td>
                                            <span class="tp-clearfix"></span>
                                            <a href="javascript:void(0);" id="rs-add-css-border-radius"
                                               class="button-primary revblue"
                                               original-title=""><?php _e('Add', 'revslider'); ?></a>
                                        </div>
                                    </li>
                                    <li data-call="border"><span class="libtn"><?php _e('Border', 'revslider'); ?><span
                                                class="more-values-available"></span></span>
                                        ...
                                        <div style="display: none;" class="rs-element-add rs-element-add-border">
                                            ...
                                            <input class="rs-small-input" type="text" name="rs-border-opacity"
                                                   value="100">
                                            <span class="tp-clearfix"></span>
                                            <input type="text" name="rs-border-color" class="my-color-field"
                                                   value="#000000">
                                            <span class="tp-clearfix"></span>
                                            <a href="javascript:void(0);" id="rs-add-css-border"
                                               class="button-primary revblue"
                                               original-title=""><?php _e('Add', 'revslider'); ?></a>
                                        </div>
                                    </li>
                                    <li data-call="text_shadow"><span
                                            class="libtn"><?php _e('Text-Shadow', 'revslider'); ?><span
                                                class="more-values-available"></span></span>

                                        <div style="display: none;" class="rs-element-add rs-element-add-text-shadow">
                                            <label><?php _e('Angle', 'revslider'); ?></label>
                                            <input class="rs-small-input" type="text" name="rs-text-shadow-angle"
                                                   value="0">
                                            <label><?php _e('Distance', 'revslider'); ?></label>
                                            <input class="rs-small-input" type="text" name="rs-text-shadow-distance"
                                                   value="0">
                                            <label><?php _e('Blur', 'revslider'); ?></label>
                                            <input class="rs-small-input" type="text" name="rs-text-shadow-blur"
                                                   value="0">
                                            <label><?php _e('Opacity', 'revslider'); ?></label>
                                            <input class="rs-small-input" type="text" name="rs-text-shadow-opacity"
                                                   value="100">
                                            <span class="tp-clearfix"></span>
                                            <input type="text" name="rs-text-shadow-color" class="my-color-field"
                                                   value="#000000">
                                            <span class="tp-clearfix"></span>
                                            <a href="javascript:void(0);" id="rs-add-css-text-shadow"
                                               class="button-primary revblue"
                                               original-title=""><?php _e('Add', 'revslider'); ?></a>
                                        </div>
                                    </li>
                                    <li data-call="box_shadow"><span
                                            class="libtn"><?php _e('Box-Shadow', 'revslider'); ?><span
                                                class="more-values-available"></span></span>

                                        <div style="display: none;" class="rs-element-add rs-element-add-box-shadow">
                                            <label><?php _e('Angle', 'revslider'); ?></label>
                                            <input class="rs-small-input" type="text" name="rs-box-shadow-angle"
                                                   value="0">
                                            <label><?php _e('Distance', 'revslider'); ?></label>
                                            <input class="rs-small-input" type="text" name="rs-box-shadow-distance"
                                                   value="0">
                                            <label><?php _e('Blur', 'revslider'); ?></label>
                                            <input class="rs-small-input" type="text" name="rs-box-shadow-blur"
                                                   value="0">
                                            <label><?php _e('Opacity', 'revslider'); ?></label>
                                            <input class="rs-small-input" type="text" name="rs-box-shadow-opacity"
                                                   value="100">
                                            <span class="tp-clearfix"></span>
                                            <input type="text" name="rs-box-shadow-color" class="my-color-field"
                                                   value="#000000">
                                            <span class="tp-clearfix"></span>
                                            <a href="javascript:void(0);" id="rs-add-css-box-shadow"
                                               class="button-primary revblue"
                                               original-title=""><?php _e('Add', 'revslider'); ?></a>
                                        </div>
                                    </li>
                                    <li data-call="font_families"><span
                                            class="libtn"><?php _e('Font Family', 'revslider'); ?><span
                                                class="more-values-available"></span></span>
                                        ...
                                        <div style="display: none;" class="rs-element-add rs-element-add-box-shadow">
                                            <select name="rs-font-family" style="width: 160px">
                                                ...
                                                foreach ($font_families as $handle => $name) {
                                                    ?>
                                                    <option
                                                        value="<?php echo esc_attr($name['label']); ?>"><?php echo esc_attr($name['label']); ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
                                            <a href="javascript:void(0);" id="rs-add-css-font-family"
                                               class="button-primary revblue"
                                               original-title=""><?php _e('Add', 'revslider'); ?></a>
                                        </div>
                                    </li>
            ...
            <div class="rs-editing-preview-wrap">
                ...
                <input id="rs-preview-color-changer" type="text" name="rs-preview-color" class="bg-color-field"
                       value="#000000">
				...
				<span class="little-sizes">
                    ...
                    <input class="rs-small-input" type="text" name="rs-test-width" value="160"
                           style="width:45px !important; margin-right:15px;">
                    <?php _e('Suggested Height:', 'revslider'); ?>
                    <input class="rs-small-input" type="text" name="rs-test-height" value="160"
    ...
    <a class="button-primary revgreen" id="rs-save-navigation-style" href="javascript:void(0);"><i
            class="rs-icon-save-light"></i><?php _e('Save All Changes', 'revslider'); ?></a>


    <script type="text/javascript">
        var rs_navigations = jQuery.parseJSON(<?php echo RevSliderFunctions::jsonEncodeForClientSide($navigs); ?>) || [];
        ...
        jQuery(document).ready(function () {
            ...
            var rs_cm_markup_editor = CodeMirror.fromTextArea(document.getElementById("rs-cm-markup"), {
                ...
                mode: 'text/html',
                onChange: function () {
                    rs_cm_modified('markup', rs_cm_markup_editor);
                    drawEditor();
                },
            ...
            var rs_cm_css_editor = CodeMirror.fromTextArea(document.getElementById("rs-cm-css"), {
                ...
                mode: 'css',
                onChange: function () {
                    rs_cm_modified('css', rs_cm_css_editor);
                    drawEditor();
                },
                onCursorActivity: function () {
            ...
            var previewNav = function (sbut, mclass, the_css, the_markup, settings) {
                ...
                } else if (sbut.hasClass("rs-nav-bullets-edit")) {
                    bp.show();
                ...
                } else if (sbut.hasClass("rs-nav-tabs-edit")) {
                    tabp.show();
                    var t = '<style>' + the_css + '</style>';
                ...
                } else if (sbut.hasClass("rs-nav-thumbs-edit")) {
                    thumbp.show();
                    var t = '<style>' + the_css + '</style>';
            ...
            function changeTabThumbSize() {
                ...
                tabp.find('.tp-tab').css({
                    width: jQuery('input[name="rs-test-width"]').val(),
                    height: jQuery('input[name="rs-test-height"]').val()
                });
                thumbp.find('.tp-thumb').css({
                    width: jQuery('input[name="rs-test-width"]').val(),
                    height: jQuery('input[name="rs-test-height"]').val()
                });
            }
            ...
            jQuery('body').on('click', '.rs-nav-arrows-edit, .rs-nav-bullets-edit, .rs-nav-thumbs-edit, .rs-nav-tabs-edit', function () {
                ...
                if ((typeof(cur_edit['css']) == 'undefined' || typeof(cur_edit['css'][cur_edit_type]) == 'undefined') || (typeof(cur_edit['markup']) == 'undefined' || typeof(cur_edit['markup'][cur_edit_type]) == 'undefined')) {
                    ...
                    if (!confirm(rev_lang.create_this_nav_element)) {
                        ...
                        rs_navigations[key]['settings']['width'] = {
                            "thumbs": "160",
                            "arrows": "160",
                            "bullets": "160",
                            "tabs": "160"
                        };
                        rs_navigations[key]['settings']['height'] = {
                            "thumbs": "160",
                            "arrows": "160",
                            "bullets": "160",
                            "tabs": "160"
                ...
                cur_edit.settings = cur_edit.settings === undefined || typeof(cur_edit.settings) === 'string' ? {
                    width: {
                        "thumbs": "160",
                        "arrows": "160",
                        "bullets": "160",
                        "tabs": "160"
                    }, height: {"thumbs": "160", "arrows": "160", "bullets": "160", "tabs": "160"}
                } : cur_edit.settings;
                cur_edit.settings.width = cur_edit.settings.width === undefined || typeof(cur_edit.settings.width) === 'string' ? {
                    "thumbs": "160",
                    "arrows": "160",
                    "bullets": "160",
                    "tabs": "160"
                } : cur_edit.settings.width;
                cur_edit.settings.height = cur_edit.settings.height === undefined || typeof(cur_edit.settings.height) === 'string' ? {
                    "thumbs": "160",
                    "arrows": "160",
                    "bullets": "160",
                    "tabs": "160"
                } : cur_edit.settings.height;
            ...
            jQuery('body').on('mouseenter', '.rs-nav-arrows-edit, .rs-nav-bullets-edit, .rs-nav-thumbs-edit, .rs-nav-tabs-edit', function () {
                ...
                punchgs.TweenLite.set(jQuery('#preview-nav-wrapper'), {
                    top: tt,
                    left: ll,
                    autoAlpha: 1,
                    overwrite: "all"
                ...
                if (rs_current_editing !== false && cur_edit_type !== false) {
                    for (var key in rs_navigations) {
                        if (rs_navigations[key]['id'] == rs_current_editing) {
                            ...
                            rs_navigations[key]['settings'] = rs_navigations[key]['settings'] === undefined || typeof(rs_navigations[key]['settings']) === 'string' ? {
                                width: {
                                    "thumbs": "160",
                                    "arrows": "160",
                                    "bullets": "160",
                            ...
                            } : rs_navigations[key]['settings'];

                            rs_navigations[key]['settings'].width = rs_navigations[key]['settings'].width === undefined || typeof(rs_navigations[key]['settings'].width) === 'string' ? {
                                "thumbs": "160",
                                "arrows": "160",
                                "bullets": "160",
                                "tabs": "160"
                            } : rs_navigations[key]['settings'].width;
                            rs_navigations[key]['settings'].height = rs_navigations[key]['settings'].height === undefined || typeof(rs_navigations[key]['settings'].height) === 'string' ? {
                                "thumbs": "160",
                                "arrows": "160",
                                "bullets": "160",
                                "tabs": "160"
...
<script type="text/html" id="tmpl-rs-navigation-wrap">
    <div class="rs-nav-table-row rs-nav-entry-wrap" id="rs-nav-table-{{ data['id'] }}">
        ...
        <div class="rs-nav-table-cell" style="position: relative;">
            <span class="rs-nav-name-edit-wrap" style="display: none;"><input class="regular-text"
                                                                              name="navigation-name" type="text"
                                                                              value="{{ data['name'] }}"/> <i
                    class="input-edit-icon rs-edit-navigation-name"></i></span>
            <span class="rs-nav-name-wrap"><span class="rs-nav-name-text">{{ data['name'] }}</span> <# if ( data.edit ) { #>
        ...
        <div class="rs-nav-table-cell">
            <# if ( data.edit ) { #><a href="javascript:void(0);" class="rs-nav-delete"><i
                        class="revicon-trash"></i></a>
                <# } #>
        </div>
        <div class="rs-nav-table-cell"><a href="javascript:void(0);" class="rs-nav-duplicate"><i
                    class="revicon-picture"></i></a></div>
        ...
        <div class="rs-nav-table-cell">
            <# if ( data.edit ) { #><a href="javascript:void(0);" class="rs-nav-save"><i class="revicon-arrows-ccw"></i></a>
                <# } #>
        </div>
