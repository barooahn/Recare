...
class RevSliderFront extends RevSliderBaseFront
{
    ...
    public static function putJavascript()
    {
        ...
        ?>
        <script type='text/javascript' <?php echo $js_defer; ?>
                src='<?php echo $urlPlugin; ?>js/jquery.themepunch.tools.min.js?rev=<?php echo $slver; ?>'></script>
        <script type='text/javascript' <?php echo $js_defer; ?>
                src='<?php echo $urlPlugin; ?>js/jquery.themepunch.revolution.min.js?rev=<?php echo $slver; ?>'></script>
        <?php
    }
