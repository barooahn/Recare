...
!function () {
    ...
    var e = jQuery.fn.revolution, t = e.is_mobile();
    jQuery.extend(!0, e, {
        animcompleted: function (a, t) {
            ...
            var o = "carousel" === t.sliderType ? 0 : t.width / 2 - t.gridwidth[t.curWinRange] * t.bw / 2, r = 0, d = a.data("index");
            ...
            var T = b, L = h(n, r, "in", !0), W = n.data("_pw") || n.closest(".tp-parallax-wrap"), C = n.data("_lw") || n.closest(".tp-loop-wrap"), j = n.data("_mw") || n.closest(".tp-mask-wrap"), R = n.data("responsive") || "on", I = n.data("responsive_offset") || "on", k = n.data("basealign") || "grid", _ = "grid" === k ? r.width : r.ulw, z = "grid" === k ? r.height : r.ulh, Q = jQuery("body").hasClass("rtl");
            if (n.data("_pw") || (n.data("_pw", W), n.data("_lw", C), n.data("_mw", j)), "fullscreen" == r.sliderLayout && (w = z / 2 - r.gridheight[r.curWinRange] * r.bh / 2), ("on" == r.autoHeight || void 0 != r.minHeight && r.minHeight > 0) && (w = r.conh / 2 - r.gridheight[r.curWinRange] * r.bh / 2), 0 > w && (w = 0), r.debugMode) {
                n.closest("li").find(".helpgrid").css({top: w + "px", left: u + "px"});
            ...
            if ("off" == M || _ < r.hideCaptionAtLimit && "on" == n.data("captionhidden") || _ < r.hideAllCaptionAtLimit ? n.addClass("tp-hidden-caption") : n.removeClass("tp-hidden-caption"), n.data("layertype", "html"), 0 > u && (u = 0), void 0 != n.data("thumbimage") && void 0 == n.data("videoposter") && n.data("videoposter", n.data("thumbimage")), n.hasClass("tp-videolayer") && void 0 != n.data("videoposter") && ("on" == n.data("posterOnMobile") || "on" == n.data("posteronmobile")) && t) {
                var O = p(n.data("videowidth"), r)[r.curWinRange] || p(n.data("videowidth"), r) || "auto", H = p(n.data("videoheight"), r)[r.curWinRange] || p(n.data("videoheight"), r) || "auto";
                O = parseFloat(F), H = parseFloat(A), n.append('<div class="tp-videoposter" style="position:absolute;top:0px;left:0px;width:100%;height:100%;background-image:url(' + n.data("videoposter") + '); background-size:cover;background-position:center center;"></div>'), n.css("100%" != O ? {
                    minWidth: O + "px",
                    minHeight: H + "px"
                } : {width: "100%", height: "100%"}), n.removeClass("tp-videolayer")
            }
            if (n.find("img").length > 0) {
                var B = n.find("img");
                n.data("layertype", "image"), 0 == B.width() && B.css({width: "auto"}), 0 == B.height() && B.css({height: "auto"}), void 0 == B.data("ww") && B.width() > 0 && B.data("ww", B.width()), void 0 == B.data("hh") && B.height() > 0 && B.data("hh", B.height());
                var F = B.data("ww"), A = B.data("hh"), D = "slide" == k ? r.ulw : r.gridwidth[r.curWinRange], P = "slide" == k ? r.ulh : r.gridheight[r.curWinRange], F = p(B.data("ww"), r)[r.curWinRange] || p(B.data("ww"), r) || "auto", A = p(B.data("hh"), r)[r.curWinRange] || p(B.data("hh"), r) || "auto", X = "full" === F || "full-proportional" === F, Y = "full" === A || "full-proportional" === A;
                if ("full-proportional" === F) {
                    var V = B.data("owidth"), N = B.data("oheight");
            ...
            if ("slide" === k && (u = 0, w = 0), n.hasClass("tp-videolayer") || n.find("iframe").length > 0 || n.find("video").length > 0) {
                ...
                var B = n.find("iframe") ? n.find("iframe") : B = n.find("video"), $ = n.find("iframe") ? !1 : !0, G = n.hasClass("coverscreenvideo");
                B.css({display: "block"}), void 0 == n.data("videowidth") && (n.data("videowidth", B.width()), n.data("videoheight", B.height()));
                var U, F = p(n.data("videowidth"), r)[r.curWinRange] || p(n.data("videowidth"), r) || "auto", A = p(n.data("videoheight"), r)[r.curWinRange] || p(n.data("videoheight"), r) || "auto";
            ...
            var J = n.outerHeight(), K = n.css("backgroundColor");
            ...
            var ee = 0 == ae.voa.length ? 0 : ae.voa, te = 0 == ae.hoa.length ? 0 : ae.hoa, ie = 0 == ae.elx.length ? 0 : ae.elx, ne = 0 == ae.ely.length ? 0 : ae.ely, oe = n.outerWidth(!0), re = n.outerHeight(!0);
            0 == oe && 0 == re && (oe = r.ulw, re = r.ulh);
            var de = "off" !== I ? parseInt(ee, 0) * r.bw : parseInt(ee, 0), se = "off" !== I ? parseInt(te, 0) * r.bw : parseInt(te, 0), le = "grid" === k ? r.gridwidth[r.curWinRange] * r.bw : _, pe = "grid" === k ? r.gridheight[r.curWinRange] * r.bw : z;
            ...
            var he = n.data("lasttriggerstate"), ce = n.data("triggerstate"), ge = n.data("start") || 100, me = n.data("end"), ue = x ? 0 : "bytrigger" === ge || "sliderenter" === ge ? 0 : parseFloat(ge) / 1e3, ve = ie + u, fe = ne + w, we = n.css("z-Index");
            ...
            var ye = n.data("timeline") ? n.data("timeline").time() : 0, be = void 0 !== n.data("timeline") ? n.data("timeline").progress() : 0, xe = n.data("timeline") || new punchgs.TimelineLite({smoothChildTiming: !0});
            if (be = jQuery.isNumeric(be) ? be : 0, xe.pause(), 1 > be && 1 != n.data("outstarted") || 2 == L || x) {
                ...
                var We = new Object, Ce = void 0 != n.data("transform_in") ? n.data("transform_in").match(/\(R\)/gi) : !1;
                if (!n.data("$anims") || x || Ce) {
                    var je = i(), Re = i(), Ie = o(), ke = void 0 !== n.data("transform_hover") || void 0 !== n.data("style_hover");
                ...
                var _e = l(n.data("mask_in")), ze = new punchgs.TimelineLite;
                if (We.f.anim.x = We.f.anim.x * r.bw || d(We.f.anim.x, r, oe, re, fe, ve, "horizontal"), We.f.anim.y = We.f.anim.y * r.bw || d(We.f.anim.y, r, oe, re, fe, ve, "vertical"), 2 != L || x) {
                    ...
                    if (We.f.anim.visibility = "hidden", ze.eventCallback("onStart", function () {
                            punchgs.TweenLite.set(n, {visibility: "visible"}), n.data("iframes") && n.find("iframe").each(function () {
                    ...
                    } else xe.add(punchgs.TweenLite.set(j, {overflow: "visible"}, je.elemdelay), 0)
                }
            ...
            var r = new punchgs.TimelineLite, p = new punchgs.TimelineLite, h = new punchgs.TimelineLite, c = s(i(), a.data("transform_in"), 1 == o.sdir), g = a.data("transform_out") ? s(n(), a.data("transform_out"), 1 == o.sdir) : s(n(), a.data("transform_in"), 1 == o.sdir), m = a.data("splitout") && a.data("splitout").match(/words|chars|lines/g) ? a.data("mySplitText")[a.data("splitout")] : a, u = void 0 == a.data("endelementdelay") ? 0 : a.data("endelementdelay"), v = a.innerWidth(), f = a.innerHeight(), w = t.position();
    ...
    var i = function () {
        ...
        if ("off" === i && (r = 1, d = 1), "auto" == o.lineHeight && (o.lineHeight = o.fontSize + 4), !a.hasClass("tp-splitted")) {
            ...
            if (s && punchgs.TweenLite.set(a, o.styleProps), punchgs.TweenLite.set(a, {
                ...
                var l = "slide" == o.basealign ? e.ulw : e.gridwidth[e.curWinRange], p = "slide" == o.basealign ? e.ulh : e.gridheight[e.curWinRange], h = u(o.maxWidth, r, "none", l), c = u(o.maxHeight, d, "none", p), v = u(o.minWidth, r, "0px", l), f = u(o.minHeight, d, "0px", p);
        ...
        if (a.hasClass("rs-wave") && void 0 == a.data("loop-timeline")) {
            a.data("loop-timeline", new punchgs.TimelineLite);
            var g = void 0 == a.data("angle") ? 10 : parseInt(a.data("angle"), 0), m = void 0 == a.data("radius") ? 10 : parseInt(a.data("radius"), 0), n = void 0 == a.data("speed") ? -20 : a.data("speed"), o = void 0 == a.data("origin") ? "50% 50%" : a.data("origin"), u = o.split(" "), v = new Object;
            u.length >= 1 ? (v.x = u[0], v.y = u[1]) : (v.x = "50%", v.y = "50%"), g *= e, m *= e;
            var f = 0 - a.height() / 2 + m * (-1 + parseInt(v.y, 0) / 100), w = a.width() * (-.5 + parseInt(v.x, 0) / 100), y = {
                a: 0,
                ang: g,
                element: a,
                unit: m,
