...
!function () {
    ...
    jQuery.extend(!0, t, {
        resetVideo: function (t) {
            ...
            switch (clearTimeout(o.data("videoplaywait")), o.data("videotype")) {
                ...
                case"vimeo":
                    if (0 == o.find("iframe").length)o.append(o.data("videomarkup")), d(o, n, !0); else if (o.hasClass("rs-apiready")) {
                        var s = o.find("iframe").attr("id"), l = $f(s);
                ...
                case"html5":
                    ...
                    var p = o.find("video"), v = p[0], u = p.parent();
            ...
            var i = a.find("iframe, video"), o = e.split(":")[0], d = e.split(":")[1], n = a.closest(".tp-revslider-slidesli"), r = n.width() / n.height(), s = o / d, l = r / s * 100, p = s / r * 100;
            ...
            var s = o.data("videoattributes"), l = o.data("ytid"), p = o.data("vimeoid"), v = o.data("videpreload"), u = o.data("videomp4"), c = o.data("videowebm"), f = o.data("videoogv"), m = o.data("allowfullscreenvideo"), g = o.data("videocontrols"), h = "http", y = "loop" == o.data("videoloop") ? "loop" : "loopandnoslidestop" == o.data("videoloop") ? "loop" : "", w = void 0 != u || void 0 != c ? "html5" : void 0 != l && String(l).length > 1 ? "youtube" : void 0 != p && String(p).length > 1 ? "vimeo" : "none", b = "html5" == w && 0 == o.find("video").length ? "html5" : "youtube" == w && 0 == o.find("iframe").length ? "youtube" : "vimeo" == w && 0 == o.find("iframe").length ? "vimeo" : "none";
            switch (o.data("videotype", w), b) {
                case"html5":
                    ...
                    break;
                case"youtube":
                    h = "http", "https:" === location.protocol && (h = "https"), "none" == g && (s = s.replace("controls=1", "controls=0"), -1 == s.toLowerCase().indexOf("controls") && (s += "&controls=0"));
                    var x = e(o.data("videostartat")), L = e(o.data("videoendat"));
                    -1 != x && (s = s + "&start=" + x), -1 != L && (s = s + "&end=" + L);
                    var C = s.split("origin=" + h + "://"), V = "";
                    C.length > 1 ? (V = C[0] + "origin=" + h + "://", self.location.href.match(/www/gi) && !C[1].match(/www/gi) && (V += "www."), V += C[1]) : V = s;
                    var P = "true" === m || m === !0 ? "allowfullscreen" : "";
                    o.data("videomarkup", '<iframe style="visible:hidden" src="' + h + "://www.youtube.com/embed/" + l + "?" + V + '" ' + P + ' width="100%" height="100%" style="width:100%;height:100%"></iframe>');
                    break;
                case"vimeo":
                    "https:" === location.protocol && (h = "https"), o.data("videomarkup", '<iframe style="visible:hidden" src="' + h + "://player.vimeo.com/video/" + p + "?" + s + '" webkitallowfullscreen mozallowfullscreen allowfullscreen width="100%" height="100%" style="100%;height:100%"></iframe>')
            }
    ...
    var i = function (e, t, a) {
        ...
        var l = i.find("iframe"), p = "iframe" + Math.round(1e5 * Math.random() + 1), v = i.data("videoloop"), u = "loopandnoslidestop" != v;
        ...
        if (l.attr("id", p), n && i.data("startvideonow", !0), 1 !== i.data("videolistenerexist"))switch (i.data("videotype")) {
            case"youtube":
                var f = new YT.Player(p, {
                    events: {
                        onStateChange: function (t) {
                            var a = t.target.getVideoEmbedCode(), i = jQuery("#" + a.split('id="')[1].split('"')[0]), n = i.closest(".tp-simpleresponsive"), l = i.parent(), p = i.parent().data("player");
                            if (t.data == YT.PlayerState.PLAYING)punchgs.TweenLite.to(l.find(".tp-videoposter"), .3, {
                                ...
                                display: "block",
                                ease: punchgs.Power3.easeInOut
                            }), "mute" == l.data("volume") ? p.mute() : (p.unMute(), p.setVolume(parseInt(l.data("volume"), 0) || 75)), d.videoplaying = !0, r(l, d), n.trigger("stoptimer"), d.c.trigger("revolution.slide.onvideoplay", o(p, "youtube", l.data())); else {
                                if (0 == t.data && v) {
                                    var u = e(l.data("videostartat"));
                                    -1 != u && p.seekTo(u), p.playVideo()
                                }
                ...
                break;
            case"vimeo":
                for (var m, g = l.attr("src"), h = {}, y = g, w = /([^&=]+)=([^&]*)/g; m = w.exec(y);)h[decodeURIComponent(m[1])] = decodeURIComponent(m[2]);
                g = void 0 != h.player_id ? g.replace(h.player_id, p) : g + "&player_id=" + p;
                try {
                    g = g.replace("api=0", "api=1")
                } catch (b) {
                }
                g += "&api=1", l.attr("src", g);
                var f = i.find("iframe")[0], k = (jQuery("#" + p), $f(p));
        ...
        var l = d.find("video"), p = l[0], v = l.parent(), u = d.data("videoloop"), c = "loopandnoslidestop" != u;
        if (u = "loop" == u || "loopandnoslidestop" == u, v.data("metaloaded", 1), void 0 == l.attr("control") && (0 != d.find(".tp-video-play-button").length || a || d.append('<div class="tp-video-play-button"><i class="revicon-right-dir"></i><span class="tp-revstop">&nbsp;</span></div>'), d.find("video, .tp-poster, .tp-video-play-button").click(function () {
            ...
            })), 1 == d.data("forcecover") || d.hasClass("fullscreenvideo") || 1 == d.data("bgvideo"))if (1 == d.data("forcecover") || 1 == d.data("bgvideo")) {
            v.addClass("fullcoveredvideo");
            var f = d.data("aspectratio") || "4:3";
            t.prepareCoveredVideo(f, n, d)
        } else v.addClass("fullscreenvideo");
        var m = d.find(".tp-vid-play-pause")[0], g = d.find(".tp-vid-mute")[0], h = d.find(".tp-vid-full-screen")[0], y = d.find(".tp-seek-bar")[0], w = d.find(".tp-volume-bar")[0];
        void 0 != m && (i(m, "click", function () {
            ...
            var t = 100 / p.duration * p.currentTime, a = e(d.data("videoendat")), i = p.currentTime;
            if (y.value = t, 0 != a && Math.abs(a - i) <= .3 && a > i && 1 != d.data("nextslidecalled"))if (u) {
                p.play();
                var o = e(d.data("videostartat"));
                -1 != o && (p.currentTime = o)
            } else 1 == d.data("nextslideatend") && (d.data("nextslidecalled", 1), n.c.revnext()), p.pause()
            ...
            s(d, n), n.videoplaying = !1, s(d, n), n.c.trigger("starttimer"), n.c.trigger("revolution.slide.onvideostop", o(p, "html5", d.data())), 1 == d.data("nextslideatend") && n.c.revnext(), d.removeClass("videoisplaying")
        })
    }, r = function (e, a) {
