...
<hr>
    ...
    <span class="tp-monitor-performace-wrap">
			<span id="image-performace-bar" style="width: %overall_performance%%"
                  class="tp-monitor-performance-bar mo-%overall_color%-col"></span>
    ...
    <span style="float:left;width:165px">
			...
			<a class="button-primary revblue tp-monitor-showdetails" data-target="#performance_overall_details"
               style="float:right; width:160px;vertical-align:top"><i class="eg-icon-chart-bar"></i>Show Full Statistics</a>
		</span>
    <span style="float:right; width:165px">
			...
			<a class="button-primary revred tp-monitor-showdetails" data-target="#monitor-problems"
               style="float:right; width:160px;vertical-align:top;"><i class="eg-icon-info"></i>Show All Issues</a>
		</span>
    <span class="tp-clearfix" style="height:15px"></span>
<hr>
    <span class="tp-clearfix" style="height:25px"></span>
    ...
    <div id="performance_overall_details" style="display:none">
        ...
        if (!empty($used_images)) {
            ...
            <span class="tp-monitor-performace-wrap">
				<span id="image-performace-bar" style="width: %image_performance%%"
                      class="tp-monitor-performance-bar mo-%image_color%-col"></span>
				<span class="tp-monitor-slow"><?php echo __("Slow", 'revslider'); ?></span>
				<span class="tp-monitor-ok"><?php echo __("Ok", 'revslider'); ?></span>
				<span class="tp-monitor-fast"><?php echo __("Fast", 'revslider'); ?></span>
			</span>
            ...
            <span style="float:left;width:40%">
				...
				<span id="image_sub_size"
                      class="tp-monitor-total-subsize"><?php echo size_format($img_size, 2); ?></span>
				</span>
            <span style="float:left;width:60%; text-align:right;">
				<span class="tp-monitor-showdetails" data-target="#monitor-image-details"
                      data-open="</span><?php echo __("Hide Details", 'revslider'); ?>"
                      data-close="</span><?php echo __("Show Details", 'revslider'); ?>"><span
                        class="tp-monitor-openclose"></span><span
                        class="tp-show-inner-btn"><?php echo __("Show Details", 'revslider'); ?></span></span>
			</span>
            <span class="tp-clearfix" style="height:15px"></span>
            <!-- THE IMAGE LIST -->
        ...
        if (!empty($used_videos)) {
            ...
            <span class="tp-monitor-performace-wrap">
				<span id="video-performace-bar" style="width:50%"
                      class="tp-monitor-performance-bar mo-neutral-col"></span>
				<span class="tp-monitor-slow"><?php echo __("Slow", 'revslider'); ?></span>
				<span class="tp-monitor-ok"><?php echo __("Ok", 'revslider'); ?></span>
				<span class="tp-monitor-fast"><?php echo __("Fast", 'revslider'); ?></span>
			</span>
            ...
            <span style="float:left;width:40%; display:block">
                ...
                <?php if ($video_size > 0) { ?>
                    <span class="tp-monitor-imageicon"></span>
                    <span id="video_sub_size"
                          class="tp-monitor-total-subsize"><?php echo size_format($video_size, 2); ?></span>
                <?php } else { ?>
                    <span class="tp-monitor-imageicon"></span>
            ...
            <span style="float:left;width:60%; text-align:right;">
				<span class="tp-monitor-showdetails" data-target="#monitor-video-details"
                      data-open="</span><?php echo __("Hide Details", 'revslider'); ?>"
                      data-close="</span><?php echo __("Show Details", 'revslider'); ?>"><span
                        class="tp-monitor-openclose"></span><span
                        class="tp-show-inner-btn"><?php echo __("Show Details", 'revslider'); ?></span></span>
		...
		<span class="tp-monitor-performace-wrap">
			<span id="image-performace-bar" style="width:%css_performance%%"
                  class="tp-monitor-performance-bar mo-%css_color%-col"></span>
			<span class="tp-monitor-slow"><?php echo __("Slow", 'revslider'); ?></span>
			<span class="tp-monitor-ok"><?php echo __("Ok", 'revslider'); ?></span>
			<span class="tp-monitor-fast"><?php echo __("Fast", 'revslider'); ?></span>
		</span>
		...
		<span style="float:left;width:40%">
			...
			<span class="tp-monitor-cssicon"></span><span id="css_sub_size"
                                                          class="tp-monitor-total-subsize">%css_size%</span>
			</span>
		<span style="float:left;width:60%; text-align:right;">
			<span class="tp-monitor-showdetails" data-target="#monitor-CSS-details"
                  data-open="</span><?php echo __("Hide Details", 'revslider'); ?>"
                  data-close="</span><?php echo __("Show Details", 'revslider'); ?>"><span
                    class="tp-monitor-openclose"></span><span
                    class="tp-show-inner-btn"><?php echo __("Show Details", 'revslider'); ?></span></span>
        ...
        <span class="tp-monitor-performance-title"><?php echo __("jQuery Performance", 'revslider'); ?></span>
			<span class="tp-monitor-performace-wrap">
				<span id="video-performace-bar" style="width:%js_performance%%"
                      class="tp-monitor-performance-bar mo-%js_color%-col"></span>
				<span class="tp-monitor-slow"><?php echo __("Slow", 'revslider'); ?></span>
				<span class="tp-monitor-ok"><?php echo __("Ok", 'revslider'); ?></span>
				<span class="tp-monitor-fast"><?php echo __("Fast", 'revslider'); ?></span>
			</span>
        ...
        <!-- FULL SIZE OF SUBCATEGORY && SHOW/HIDE LIST -->
			...
			<span style="float:left;width:60%; text-align:right;">
				<span class="tp-monitor-showdetails" data-target="#monitor-jquery-details"
                      data-open="</span><?php echo __("Hide Details", 'revslider'); ?>"
                      data-close="</span><?php echo __("Show Details", 'revslider'); ?>"><span
                        class="tp-monitor-openclose"></span><span
                        class="tp-show-inner-btn"><?php echo __("Show Details", 'revslider'); ?></span></span>
        ...
        <span class="tp-monitor-performance-title"><?php echo __("Google Fonts Performance", 'revslider'); ?></span>
			<span class="tp-monitor-performace-wrap">
				<span id="video-performace-bar" style="width:%font_performance%%"
                      class="tp-monitor-performance-bar mo-%font_color%-col"></span>
				<span class="tp-monitor-slow"><?php echo __("Slow", 'revslider'); ?></span>
				<span class="tp-monitor-ok"><?php echo __("Ok", 'revslider'); ?></span>
				<span class="tp-monitor-fast"><?php echo __("Fast", 'revslider'); ?></span>
			</span>
        ...
        <!-- FULL SIZE OF SUBCATEGORY && SHOW/HIDE LIST -->
			...
			<span style="float:left;width:60%; text-align:right;">
				<span class="tp-monitor-showdetails" data-target="#monitor-fonts-details"
                      data-open="</span><?php echo __("Hide Details", 'revslider'); ?>"
                      data-close="</span><?php echo __("Show Details", 'revslider'); ?>"><span
                        class="tp-monitor-openclose"></span><span
                        class="tp-show-inner-btn"><?php echo __("Show Details", 'revslider'); ?></span></span>
...
?><!DOCTYPE html>
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css"
              href="<?php echo $path_fonts; ?>pe-icon-7-stroke/css/pe-icon-7-stroke.css">
        ...
        <script type="text/javascript"
                src="<?php echo $path_js; ?>extensions/revolution.extension.actions.min.js"></script>
        <script type="text/javascript"
                src="<?php echo $path_js; ?>extensions/revolution.extension.carousel.min.js"></script>
        <script type="text/javascript"
                src="<?php echo $path_js; ?>extensions/revolution.extension.kenburn.min.js"></script>
        <script type="text/javascript"
                src="<?php echo $path_js; ?>extensions/revolution.extension.layeranimation.min.js"></script>
        <script type="text/javascript"
                src="<?php echo $path_js; ?>extensions/revolution.extension.migration.min.js"></script>
        <script type="text/javascript"
                src="<?php echo $path_js; ?>extensions/revolution.extension.navigation.min.js"></script>
        <script type="text/javascript"
                src="<?php echo $path_js; ?>extensions/revolution.extension.parallax.min.js"></script>
        <script type="text/javascript"
                src="<?php echo $path_js; ?>extensions/revolution.extension.slideanims.min.js"></script>
        <script type="text/javascript"
                src="<?php echo $path_js; ?>extensions/revolution.extension.video.min.js"></script>
    </head>
    ...
    <?php if (!$export_real){ ?>
        ...
        <article class="content">
            ...
            <section class="header">
                ...
                <a class="button" style="float:right" href="http://www.themepunch.com/revsliderjquery-doc/get-started/"><i
                        class="pe-7s-help2"></i>Online Documentation</a>
        ...
        <article class="small-history">
            ...
            <p>The Slider below is a classic slideshow with timer, bullet and arrow navigation. Slider Revolution offers
                millions of layout combinations.</p>
        </article>
