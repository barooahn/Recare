...
class RevSliderOutput
{
    ...
    private $oneSlideMode = false;    //admin preview mode
    ...
    private function putJS($markup_export = false)
    {
        ...
        <script type="text/javascript">
            ...
            <?php } ?>
            var tpj = jQuery;
            <?php if($noConflict == "on"){ ?>tpj.noConflict();
            <?php } ?>
        ...
        if ($this->slider->getParam("custom_css", '') !== '') {
            if (!is_admin()) {
                ...
                ?>
                <style
                    type="text/css"><?php echo RevSliderCssParser::compress_css(stripslashes($this->slider->getParam('custom_css', ''))); ?></style><?php
                if ($markup_export === true) {
                    echo '<!-- /STYLE -->';
                }
            }
    ...
    public function putErrorMessage($message)
    {
        ...
        <div style="width:800px;height:300px;margin-bottom:10px;margin:0px auto;">
            <div
                style="margin: auto; line-height: 40px; font-size: 14px; color: #FFF; padding: 15px; background: #E74C3C; margin: 20px 0px;">
