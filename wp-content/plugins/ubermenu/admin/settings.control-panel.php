...
function ubermenu_get_settings_fields_instance($config_id)
{
    ...
    $settings = array(
        ...
        80 => array(
            ...
            'type' => 'radio',
            'desc' => __('Orient the menu vertically or horizontally', 'ubermenu'),
            'options' => array(
...
function ubermenu_migration_complete_panel()
{
    ...
    <div class="wrap ubermenu-wrap">
        ...
        <h2><strong>UberMenu</strong> Migration <span class="ubermenu-version">v<?php echo UBERMENU_VERSION; ?></span>
        </h2>
    ...
    <div class="wrap ubermenu-wrap">
        ...
        if (!$old_ops) {
            ...
            <form action="<?php echo admin_url('themes.php'); ?>" method="GET">
                ...
                <label><input type="checkbox" checked="checked" value="on" name="migrate_control_panel"/> Migrate
                    Control Panel</label>

                <p>This will migrate the settings from the UberMenu Control Panel, including the Style Generator
                    settings if you had your Style Application set to the Style Generator.</p>
...
{
    ?>
    <a class="button" href="<?php echo admin_url('themes.php?page=ubermenu-settings'); ?>">&laquo; Back to Control
        Panel</a>
    <?php
}
...
function ubermenu_reset_all_complete_panel()
{
    ...
    <div class="wrap ubermenu-wrap">
        ...
        <h2><strong>UberMenu</strong> Settings Reset <span
                class="ubermenu-version">v<?php echo UBERMENU_VERSION; ?></span></h2>
...
function ubermenu_check_menu_assignment()
{
    ...
    if ($display == 'on') {
        if (!has_nav_menu('ubermenu')) {
            ?>
            <div class="update-nag"><strong>Important!</strong> There is no menu assigned to the <strong>UberMenu
                    [Main]</strong> Menu Location. <a href="<?php echo admin_url('nav-menus.php?action=locations'); ?>">Assign
                    a menu</a></div>
            <br/><br/>
            <?php
        }
