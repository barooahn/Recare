    ...
    <div class="ubermenu-js-check">
        ...
        <div class="ubermenu-js-check-details">
            <p>
                ...
                This most commonly indicates that you have a javascript error on this page, which will need to be
                resolved in order to allow UberMenu to run.
            ...
            <div class="ubermenu-menu-item-panel-settings shift-clearfix">
                <form class="ubermenu-menu-item-settings-form" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="ubermenu-menu-item-save-button-wrapper">
                        ...
                        <a class="ubermenu-menu-item-settings-close" href="#"><i class="fa fa-times"></i> <span
							...
							<span class="ubermenu-menu-item-meta-ops">
								<span class="ubermenu-menu-item-setting">
									<label><input type="checkbox"
                                                  name="ubermenu-meta-save-defaults"/> <?php _e('Set as defaults', 'ubermenu'); ?>
                                    </label>
									<div class="ubermenu-menu-item-setting-tip"><i
                                            class="ubermenu-tip-icon fa fa-lightbulb-o"></i> <?php
								...
								<span class="ubermenu-menu-item-setting">
									<label><input type="checkbox"
                                                  name="ubermenu-meta-reset-defaults"/> <?php _e('Reset defaults', 'ubermenu'); ?>
                                    </label>
									<div class="ubermenu-menu-item-setting-tip"><i
                                            class="ubermenu-tip-icon fa fa-lightbulb-o"></i> <?php
                    ...
                    <?php foreach ($ordered_panels as $order => $panel_id):
                        ...
                        if (isset($panel['icon'])) $icon = '<i class="fa fa-' . $panel['icon'] . '"></i>';
                        ?>
                        <div class="ubermenu-menu-item-tab-content"
                             data-ubermenu-tab-content="<?php echo $panel_id; ?>"<?php
    ...
    switch ($type) {
            ...
            <div class="ubermenu-multicheck-wrap">
                ...
                <?php foreach ($ops as $_val => $_name):
                    ...
                    <label class="ubermenu-multicheck-label">
                        <input type="checkbox" class="checkbox ubermenu-multicheckbox"
                               id="" <?php echo "$data_setting $_name_att $_value_att ";
                        echo $checked; ?> />
                        <?php echo $_name; ?>
                    </label>
                <?php endforeach; ?>
        ...
        case 'select': ?>
            <select <?php echo $class; ?> <?php echo "$name $data_setting"; ?> >
                <?php foreach ($ops as $_val => $_name): ?>
                    <option
                        value="<?php echo $_val; ?>" <?php selected($default, $_val); ?> ><?php echo $_name; ?></option>
                <?php endforeach; ?>
            </select>
            <?php break;
        ...
        case 'radio': ?>
            <div
                class="ubermenu-radio-group <?php if (isset($setting['type_class'])) echo $setting['type_class']; ?> <?php if (count($ops) > 1) echo 'ubermenu-radio-multiple-subgroups'; ?>">
                    ...
                    <div class="ubermenu-radio-subgroup ubermenu-radio-subgroup-<?php echo $_group_id; ?>">
                        ...
                        <?php foreach ($group as $_val => $_data):
                            ...
                            <div class="ubermenu-radio-option">
                                <label
                                    class="ubermenu-radio-label shift-clearfix<?php if ($img || $img_icon) echo ' ubermenu-radio-label-with-image'; ?><?php if ($selected) echo ' ubermenu-radio-label-selected'; ?>">
                                    <input <?php echo $class; ?> type="radio"
                                                                 value="<?php echo $_val; ?>" <?php echo "$name $data_setting"; ?> <?php checked($default, $_val); ?>>
                ...
                <div class="ubermenu-icons shift-clearfix">
                    ...
                    <?php foreach ($ops as $_val => $data): if ($_val == '') continue; ?>
                        <span class="ubermenu-icon-wrap" title="<?php echo $data['title']; ?>"
                              data-ubermenu-search-terms="<?php echo strtolower($data['title']); ?>"><i
                                class="ubermenu-icon <?php echo $_val; ?>"
                                data-ubermenu-icon="<?php echo $_val; ?>"></i></span>
                    <?php endforeach; ?>
                    <span class="ubermenu-icon-wrap ubermenu-remove-icon" title="Remove Icon"><i class="ubermenu-icon"
                                                                                                 data-ubermenu-icon="">Remove
                            Icon</i></span>
                </div>
                <select <?php echo $class; ?> <?php echo "$name $data_setting"; ?> >
                    <?php foreach ($ops as $_val => $data): ?>
                        <option
                            value="<?php echo $_val; ?>" <?php selected($default, $_val); ?> ><?php echo $data['title']; ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            <?php break;
        ...
        case 'media': ?>
            <div class="ubermenu-media-wrapper">
                ...
                <input class="<?php echo $class_str; ?> ubermenu-media-id"
                       type="text" <?php echo "$name $value $data_setting"; ?> />
        ...
        case 'autocomplete': ?>
            ...
            <div class="ubermenu-autocomplete">
                ...
                <input class="ubermenu-menu-item-setting-input ubermenu-autocomplete-setting" placeholder="ID"
                       type="text" <?php echo "$name $value $data_setting"; ?> />
                    ...
                    <?php foreach ($ops as $_val => $_name): ?>
                        <span class="ubermenu-autocomplete-op" data-opname="<?php echo strtolower($_name); ?>"
                              data-val="<?php echo $_val; ?>"><span class="ubermenu-autocomplete-op-name"><?php
                                echo $_name; ?></span><span
                                class="ubermenu-autocomplete-op-val"><?php echo $_val; ?></span></span>
                    <?php endforeach; ?>
                </div>
...
function ubermenu_get_image_size_ops($exclude = array())
{
    ...
    foreach ($available_sizes as $s) {
        $o[$s] = array(
            'name' => ucfirst($s),
            'desc' => __('Registered image size ', 'ubermenu') . '<code>' . $s . '</code>',
        );
    }
