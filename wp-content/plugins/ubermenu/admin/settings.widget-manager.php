...
function ubermenu_widget_manager_panel()
{
    ...
    <div class="wrap ubermenu-wrap">
        ...
        <h2><strong>UberMenu</strong> Widget Manager <span
        ...
        <p>Note that if you re-save a menu item with the Custom Widget Area Setting, the widget area will be
            regenerated</p>
        ...
        <form>
            ...
            foreach ($menu_item_widget_areas as $menu_item_id => $widget_title) {
                ...
                ?>
                <div>
                    <label><input name="widget_area_id[]" type="checkbox" value="<?php echo $menu_item_id; ?>"/>
                        <strong><?php echo $widget_title . '</strong> [Menu Item ' . $menu_item_id . ']'; ?></label>
                </div>
                <?php
            }
