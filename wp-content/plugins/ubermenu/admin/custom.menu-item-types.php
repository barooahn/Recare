                    ...
                    <li>
                        <label class="menu-item-title um-tooltip-wrap">
                            <input type="checkbox" class="menu-item-checkbox"
                                   name="menu-item[<?php echo $_nav_menu_placeholder ?>][menu-item-label]"
                                   value="0"> <?php echo $item['label']; ?>
                        ...
                        <input type="hidden" class="menu-item-ubermenu-custom"
                               name="menu-item[<?php echo $_nav_menu_placeholder ?>][menu-item-ubermenu-custom]"
                               value="on">
        ...
        <p class="button-controls">
			...
			<span class="add-to-menu">
				<input type="submit" class="button-secondary submit-add-to-menu right" value="Add to Menu"
                       name="add-ubermenu-custom-menu-item" id="submit-ubermenu-custom-menu-metabox">
