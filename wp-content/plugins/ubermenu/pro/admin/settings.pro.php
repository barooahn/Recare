...
function ubermenu_kb_search()
{
    ...
    <div class="ubermenu-kb-search">
        <div class="search-topper"><a target="_blank" href="<?php echo UBERMENU_KB_URL; ?>"><i class="fa fa-search"></i>
                Search the Knowledgebase</a></div>
...
function ubermenu_settings_welcome()
{
    ...
    <div class="ubermenu-welcome <?php if (!$show_welcome) echo 'ubermenu-welcome-hide'; ?>">
        <div class="ubermenu-welcome-inner">
            ...
            <a class="ubermenu-welcome-dismiss" href="#"
               data-ubermenu-nonce="<?php echo wp_create_nonce('ubermenu-dismiss-welcome'); ?>">&times;</a>

            <div class="ubermenu-welcome-buttons">
                <a target="_blank" class="button button-primary" href="<?php echo UBERMENU_KB_URL; ?>"><i
                        class="fa fa-book"></i> Knowledgebase</a>
                <a target="_blank" class="button button-tertiary" href="<?php echo UBERMENU_VIDEOS_URL; ?>"><i
                        class="fa fa-video-camera"></i> Video Tutorials</a>
                <a target="_blank" class="button button-secondary" href="<?php echo UBERMENU_SUPPORT_URL; ?>"><i
                        class="fa fa-user-md"></i> Support Forum</a>
            </div>

            <p>Links to the Knowledgebase, Video Tutorials, and Support Forum will appear in the upper right
                of your Control Panel for easy access. The QuickStart video below will help you get up and running
                quickly.</p>

            <?php if ($show_welcome): ?>
                <iframe class="ubermenu-welcome-video" width="1000" height="563"
                        src="<?php echo UBERMENU_QUICKSTART_URL; ?>" data-src="<?php echo UBERMENU_QUICKSTART_URL; ?>"
                        frameborder="0" allowfullscreen></iframe>
            <?php else: ?>
                <iframe class="ubermenu-welcome-video" width="1000" height="563"
                        data-src="<?php echo UBERMENU_QUICKSTART_URL; ?>" frameborder="0" allowfullscreen></iframe>
            <?php endif; ?>
        </div>
    </div>
    <?php
