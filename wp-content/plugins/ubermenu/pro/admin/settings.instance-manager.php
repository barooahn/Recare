    ...
    <div class="ubermenu_instance_manager">
        ...
        <div class="ubermenu_instance_wrap ubermenu_instance_container_wrap">
            ...
            <div class="ubermenu_instance_container">
                ...
                <form class="ubermenu_instance_form">
                    <input class="ubermenu_instance_input" type="text" name="ubermenu_instance_id"
                           placeholder="configuration_id"/>
                ...
                <p class="ubermenu_instance_form_desc">Enter an ID for your new menu configuration. This ID will be used
                    when printing the menu,
                    and must contain only letters, hyphens, and underscores. <a class="ubermenu_instance_notice_close"
                                                                                href="#">close</a></p>
        ...
        <div class="ubermenu_instance_wrap ubermenu_instance_notice_wrap ubermenu_instance_notice_success">
            <div class="ubermenu_instance_notice">
                New menu created. <a href="<?php echo admin_url('themes.php?page=ubermenu-settings'); ?>"
                                     class="ubermenu_instance_button">Refresh Page</a>

                <p>Note: Any setting changes you've made have not been saved yet. <a
                        class="ubermenu_instance_notice_close" href="#">close</a></p>
            </div>
        </div>

        <div class="ubermenu_instance_wrap ubermenu_instance_notice_wrap ubermenu_instance_notice_error">
            <div class="ubermenu_instance_notice">
                New menu configuration creation failed. <span class="ubermenu-error-message">You may have a PHP error on your site which prevents AJAX requests from completing.</span>
                <a class="ubermenu_instance_notice_close" href="#">close</a>
            </div>
        </div>
        ...
        <div class="ubermenu_instance_wrap ubermenu_instance_notice_wrap ubermenu_instance_delete_notice_error">
            <div class="ubermenu_instance_notice">
                Menu Configuration deletion failed. <span class="ubermenu-delete-error-message">You may have a PHP error on your site which prevents AJAX requests from completing.</span>
                <a class="ubermenu_instance_notice_close" href="#">close</a>
            </div>
        </div>
