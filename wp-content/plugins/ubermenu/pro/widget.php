...
class UberMenu_Widget extends WP_Widget
{
    ...
    public function form($instance)
    {
        ...
        <p>
            <strong><label
                    for="<?php echo $this->get_field_id('config_id'); ?>"><?php _e('UberMenu Configuration:', 'ubermenu'); ?></label></strong>
            <select id="<?php echo $this->get_field_id('config_id'); ?>"
                    name="<?php echo $this->get_field_name('config_id'); ?>">
        ...
        <p>
            <strong><label
                    for="<?php echo $this->get_field_id('menu_id'); ?>"><?php _e('Menu (optional):', 'ubermenu'); ?></label></strong>
            <select id="<?php echo $this->get_field_id('menu_id'); ?>"
        ...
        <p>
            <strong><label
                    for="<?php echo $this->get_field_id('theme_location'); ?>"><?php _e('Theme Location:', 'ubermenu'); ?></label></strong>
            <select id="<?php echo $this->get_field_id('theme_location'); ?>"
                    name="<?php echo $this->get_field_name('theme_location'); ?>">
