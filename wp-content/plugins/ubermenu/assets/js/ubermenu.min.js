...
(function (d, g, f, k) {
    function p(a, c) {
        ...
        g.navigator.pointerEnabled ? (this.touchStart = "pointerdown", this.touchEnd = "pointerup", this.touchMove = "pointermove", this.suppress_clicks = !0) : g.navigator.msPointerEnabled ? (this.touchStart = "MSPointerDown", this.touchEnd = "MSPointerUp", this.touchMove = "MSPointerMove", this.suppress_clicks = !0) : (this.touchStart = "touchstart", this.touchEnd = "touchend", this.touchMove = "touchmove");
        ...
        this.log(e);
        var h = this.settings.android = /android/.test(e), r = this.settings.windowsmobile = /iemobile/.test(e);
        if (h || r)if (h && !(/chrome/.test(e) || /firefox/.test(e) || /opera/.test(e)) || r)this.transitions = !1, this.$ubermenu.removeClass("ubermenu-transition-slide").removeClass("ubermenu-transition-fade").removeClass("ubermenu-transition-shift").addClass("ubermenu-no-transitions").addClass("ubermenu-transition-none");
        ...
        var f = this.last_width = d(g).width(), k = b.$ubermenu.find(".ubermenu-item-level-0.ubermenu-align-right");
        k.size() && d(g).ubersmartresize(function () {
            f = d(g).width();
            b.last_width <= b.settings.breakpoint && f >= b.settings.breakpoint && (k.hide(), k[0].offsetHeight, k.show());
            b.last_width = f
        });
    ...
    p.prototype = {
        init: function () {
            ...
            if (this.settings.accessible) {
                ...
                d("body").on("keydown.ubermenu", function (c) {
                    9 == (c.keyCode || c.which) &&
                    (d("body").off("keydown.ubermenu"), a.initializeAccessibility())
                })
            }
            ...
            this.settings.reposition_on_load && d(g).load(function () {
                a.positionSubmenus()
            })
            ...
            if (this.settings.touchEvents) {
                ...
                this.$ubermenu.on("click", ".ubermenu-target", function (c) {
            ...
            if (this.settings.mouseEvents && !this.settings.clicktest && !this.settings.windowstest) {
                ...
                "click" == c ? this.suppress_clicks || (this.$ubermenu.on("click.ubermenu-submenu-toggle", ".ubermenu-item.ubermenu-has-submenu-drop:not([data-ubermenu-trigger]) > .ubermenu-target", function (b) {
                ...
                }), this.$ubermenu.on("click.ubermenu-click-target", ".ubermenu-item:not(.ubermenu-has-submenu-drop):not([data-ubermenu-trigger]) > .ubermenu-target",
                    function (b) {
                    ...
                    a.handleLink(b, this, a)
                })) : (this.$ubermenu.on("mouseenter.ubermenu-submenu-toggle", ".ubermenu-item.ubermenu-has-submenu-drop:not([data-ubermenu-trigger]) > .ubermenu-target",
                    function (b) {
                ...
                a.$ubermenu.find(".ubermenu-item[data-ubermenu-trigger]").each(function () {
                    ...
                    } else if ("hover_intent" == c)b.on("mouseenter.mouse_intent",
                        function (b) {
                            a.handleMouseIntent(b, this, a)
            ...
            if (this.settings.retractors) {
                ...
                this.touchenabled || "touch" != a.settings.retractor_display_strategy || (this.$ubermenu.find(".ubermenu-retractor-mobile").remove(), this.$ubermenu.find(".ubermenu-submenu-retractor-top").removeClass("ubermenu-submenu-retractor-top"))
            }
        }, initializeResponsiveToggle: function () {
            var a = this, c = ".ubermenu-responsive-toggle[data-ubermenu-target=" + a.$ubermenu.attr("id") +
                "], .ubermenu-responsive-toggle[data-ubermenu-target=_any_]";
            a.log("initializeResponsiveToggle " + this.toggleevent);
            d(f).on(this.toggleevent, c, function (b) {
                a.handleResponsiveToggle(b, this, a)
            })
        }, initializeTouchoffClose: function () {
            if (this.settings.touchOffClose) {
                var a = this;
                d(f).on(this.touchEnd + ".ubermenu_touchoff", function (c) {
                    a.handleTouchoffClose(c, this, a)
                });
                d(f).on("mouseup.ubermenu_clickoff", function (c) {
                    a.handleTouchoffClose(c, this, a)
                })
            }
            ...
            d(g).ubersmartresize(function () {
                a.$ubermenu.find(".ubermenu-tabs , .ubermenu-tab-content-panel , .ubermenu-tabs-group").css("min-height", !1);
                a.sizeTabs()
            });
            ...
            a.$ubermenu.find(".ubermenu-tabs-show-default > .ubermenu-tabs-group").each(function () {
                a.openSubmenu(d(this).find("> .ubermenu-tab").first(),
                    "tab default", a)
            })
        }, sizeTabs: function () {
            var a = d(g).width() < this.settings.breakpoint ? !0 : !1;
            this.$tab_blocks.each(function () {
                ...
                var h = d(this).find(" > .ubermenu-tabs-group > .ubermenu-tab > .ubermenu-tab-content-panel");
                h.each(function () {
                ...
                var g = d(this).find("> .ubermenu-tabs-group");
                c ? d(this).css("min-height", b + g.outerHeight()) : (g.outerHeight() > b && (b = d(this).outerHeight()), g.css("min-height", b));
                a ? (d(this).closest(".ubermenu-submenu-drop").css("min-height", b), h.css("min-height", !1)) : (d(this).closest(".ubermenu-submenu-drop").css("min-height", !1), h.css("min-height", b));
        ...
        handleClicks: function (a, c, b) {
            c = d(c);
            c.data("ubermenu-killClick") && (a.preventDefault(), a.stopPropagation());
            c.data("ubermenu-killClick", !1)
            ...
            b.log("touchstart " + a.type + " " + e.text(), a);
            e.on(b.touchEnd, function (a) {
                b.handleTap(a, this, b)
            });
            e.on(b.touchMove, function (a) {
                b.preventInteractionOnScroll(a,
                    this, b)
            });
            a.originalEvent.touches ? (e.data("ubermenu-startX", a.originalEvent.touches[0].clientX), e.data("ubermenu-startY", a.originalEvent.touches[0].clientY)) : a.originalEvent.clientY && (e.offset(), e.data("ubermenu-startX", a.originalEvent.clientX), e.data("ubermenu-startY", a.originalEvent.clientY))
            ...
            Math.abs(a.originalEvent.touches[0].clientY - c.data("ubermenu-startY")) > b.settings.moveThreshold ? (b.log("Preventing interaction on scroll, reset handlers (standard)"), b.resetHandlers(c)) : b.log("diff = " + Math.abs(a.originalEvent.touches[0].clientY - c.data("ubermenu-startY"))); else if (a.originalEvent.clientY) {
                var e = c.data(e);
                Math.abs(a.originalEvent.clientX - c.data("ubermenu-startX")) > b.settings.moveThreshold || Math.abs(a.originalEvent.clientY - c.data("ubermenu-startY")) > b.settings.moveThreshold ? (b.log("Preventing interaction on scroll, reset handlers (standard)"),
                    b.resetHandlers(c)) : b.log("diff = " + a.originalEvent.clientY + " - " + c.data("ubermenu-startY") + " = " + Math.abs(a.originalEvent.clientY - c.data("ubermenu-startY")))
            ...
            if (e.data("ubermenu-killTouch"))b.log("kill tap"), a.preventDefault(), a.stopPropagation(); else {
                ...
                h.hasClass("ubermenu-has-submenu-drop") ?
                    h.hasClass("ubermenu-active") ? (h.hasClass("ubermenu-tab") || b.closeSubmenu(h, "toggleUberMenuActive", b), b.handleLink(a, c, b, !0)) : b.openSubmenu(h, "toggle", b) : b.handleLink(a, c, b, !0)
            }
            e.data("ubermenu-killTouch", !1);
            b.log("reset handlers");
            b.resetHandlers(e)
            ...
            if (h.is("a")) {
                c = h.attr("href");
                var f = h.data("ubermenu-scrolltarget");
                if (f) {
                    var k = d(f).first();
                    if (0 < k.size())return d("html,body").animate({scrollTop: k.offset().top}, 1E3, "swing", function () {
                        b.closeSubmenu(h.parent(".menu-item"),
                            "handeLink")
                    }), !1;
                    c && -1 == c.indexOf("#") && (-1 == f.indexOf("#") && (f = "#" + f), g.location = c + f, a.preventDefault())
                }
                c ? e && a.isDefaultPrevented() && (b.log("default prevented, follow link"), "_blank" == h.attr("target") ? g.open(c, "_blank") : g.location = c) : a.preventDefault()
            }
        }, handleMouseClick: function (a, c, b) {
            b.log("handleMouseClick", a);
            var e = d(c), h = e.parent(".ubermenu-item");
            h.size() && (h.hasClass("ubermenu-active") ? (e.is("a") && b.handleLink(a, c, b), h.hasClass("ubermenu-tab") || b.closeSubmenu(h, "retract")) : h.hasClass("ubermenu-has-submenu-drop") &&
            (a.preventDefault(), b.closeSubmenuInstantly(h.siblings(".ubermenu-active")), b.openSubmenu(h, "click", b)))
            ...
            h.data("ubermenu-killHover") ? (b.log("killHover MouseIntent"), a.preventDefault(), a.stopPropagation()) : (s = a.pageX, t = a.pageY, e.on("mousemove.mouse_intent", b.trackMouse), e.data("mouse_intent_timer",
                setTimeout(function () {
            ...
            if (d.data("ubermenu-killHover"))b.log("Kill hover on IntentSuccess"), a.preventDefault(), a.stopPropagation(); else if (d.data("ubermenu-killHover", !1), b.triggerSubmenu(a, c, b), !c.hasClass("ubermenu-tab"))c.on("mouseleave.mouse_intent", function (a) {
            ...
            c.data("mouse_intent_timer", clearTimeout(c.data("mouse_intent_timer")));
            if (Math.abs(s - n) + Math.abs(t - q) < d.settings.intent_threshold)return c.off("mousemove.mouse_intent", d.track), c.data("mouse_intent_state", 1), b.apply(c, [a, c, d]);
            s = n;
            t = q;
            ...
            if (!b.events_disabled) {
                ...
                if (c.size() && !c.hasClass("ubermenu-active") && (b.triggerSubmenu(a, c, b), !c.hasClass("ubermenu-tab")))c.on("mouseleave.ubermenu-submenu-toggle", function (a) {
                    b.handleMouseout(a, this, b)
                })
            }
        }, handleMouseout: function (a, c, b) {
            b.log("handleMouseout, remove mouseout",
                a);
            ...
            d(c).off(b.touchEnd);
            b.log("handleSubmenuRetractorEnd " +
                a.find("> .ubermenu-target").text());
            return !1
            ...
            b.transitions &&
            (b.$ubermenu.addClass("ubermenu-in-transition"), b.$ubermenu.on(b.transitionend + "_toggleubermenu", function () {
            ...
            d(a.target).closest(".ubermenu").length || (b.log("touchoff close ", a), b.closeAllSubmenus() && (b.disableSubmenuToggleMouseEvents(), g.setTimeout(function () {
            ...
            "h" == a.orientation && a.$ubermenu.find(".ubermenu-submenu-drop.ubermenu-submenu-align-center").each(function () {
                ...
                var h = b.outerWidth(), f = c.outerWidth(), g = c.offset().left, c = e.width();
                e = e.offset().left;
                f = g + f / 2 - (e + h / 2);
                f = 0 < f ? f : 0;
                h > c ? f = (h - c) / -2 : f + h > c && (b.css({right: 0, left: "auto"}), f = !1);
                !1 !== f && b.css("left", f)
            })
    ...
    d.fn[l] = function (a) {
        ...
        if (a === k || "object" === typeof a)return this.each(function () {
            d.data(this, "plugin_" + l) || d.data(this, "plugin_" + l, new p(this, a))
        });
        if ("string" === typeof a && "_" !== a[0] &&
            "init" !== a) {
            var b;
            this.each(function () {
                var e = d.data(this, "plugin_" + l);
                e instanceof p && "function" === typeof e[a] && (b = e[a].apply(e, Array.prototype.slice.call(c, 1)));
                "destroy" === a && d.data(this, "plugin_" + l, null)
            });
            return b !== k ? b : this
        }
    }
...
jQuery(document).ready(function (d) {
    if ("." == window.location.hash.substring(1, 2)) {
        var g = d(window.location.hash.substring(1));
        g.size() && window.scrollTo(0, g.offset().top)
    }
    ...
    "undefined" !== typeof google && "undefined" !== typeof google.maps && "undefined" !== typeof google.maps.LatLng && d(".ubermenu-map-canvas").each(function () {
        var f = d(this), g = f.attr("data-zoom") ? parseInt(f.attr("data-zoom")) : 8, p = f.attr("data-lat") ? new google.maps.LatLng(f.attr("data-lat"),
            f.attr("data-lng")) : new google.maps.LatLng(40.7143528, -74.0059731), l = new google.maps.Map(this, {
            zoom: g,
            mapTypeId: google.maps.MapTypeId.ROADMAP,
            center: p
        });
        f.attr("data-address") ? (new google.maps.Geocoder).geocode({address: f.attr("data-address")}, function (d, g) {
            g == google.maps.GeocoderStatus.OK && (l.setCenter(d[0].geometry.location), p = d[0].geometry.location, new google.maps.Marker({
                map: l,
                position: d[0].geometry.location,
                title: f.attr("data-mapTitle")
            }))
        }) : new google.maps.Marker({map: l, position: p, title: f.attr("data-mapTitle")});
        var m = d(this).closest(".ubermenu-has-submenu-drop"), n = function () {
...
function uber_op(d, g, f) {
    if (!ubermenu_data.hasOwnProperty(d))return f;
    d = ubermenu_data[d];
...
(function (d, g) {
    var f = function (d, f, g) {
        var m;
        return function () {
            var n = this, q = arguments;
            m ? clearTimeout(m) : g && d.apply(n, q);
    ...
    jQuery.fn[g] = function (d) {
        return d ? this.bind("resize", f(d)) : this.trigger(g)
    }
})(jQuery, "ubersmartresize");
var uber_supports = function () {
    var d = document.createElement("div"), g = ["Khtml", "Ms", "O", "Moz", "Webkit"];
    return function (f) {
        var k = g.length;
        if (f in d.style)return !0;
        for (f = f.replace(/^[a-z]/, function (d) {
            return d.toUpperCase()
        }); k--;)if (g[k] + f in d.style)return !0;
        return !1
    }
}();
