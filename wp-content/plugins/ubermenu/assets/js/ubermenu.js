...
;(function ($, window, document, undefined) {
    ...
    function Plugin(element, options) {
        ...
        if (this.settings.debug && this.settings.debug_onscreen) {
            ...
            this.debug_target.on('click', function () {
                if ($(this).height() < 100) $(this).height('50%'); else $(this).height('50px');
            });
        }
        ...
        if ($right_items.size()) {
            $(window).ubersmartresize(function () {
                ...
                if (plugin.last_width <= plugin.settings.breakpoint &&
                    ...
                    $right_items.hide();
                    $right_items[0].offsetHeight;
                    $right_items.show(); //reflow
                }
    ...
    Plugin.prototype = {
        ...
        init: function () {
            ...
            /*
             this.$ubermenu.find( '.ubermenu-target' ).on( 'click' , function(e){
             e.preventDefault();
        ...
        initializeSubmenuToggleTouchEvents: function () {
            ...
            this.$ubermenu.on(this.touchStart, '.ubermenu-target', function (e) {
                plugin.handleTouchInteraction(e, this, plugin);
            });
            //this.$ubermenu.on( this.touchEnd ,   '.ubermenu-item' , this.handleSubmenuToggle );			//Added only on touchStart
            //this.$ubermenu.on( this.touchMove ,  '.ubermenu-item' , this.preventInteractionOnScroll );

            //Prevent "Ghost Clicks"
            this.$ubermenu.on('click', '.ubermenu-target', function (e) {
                plugin.handleClicks(e, this, plugin);
            });
        ...
        initializeSubmenuToggleMouseEvents: function (plugin) {
            ...
            if (trigger == 'click') {
                ...
                if (!this.suppress_clicks) {
                    ...
                    this.$ubermenu.on(evt, '.ubermenu-item.ubermenu-has-submenu-drop:not([data-ubermenu-trigger]) > .ubermenu-target', function (e) {
                        plugin.handleMouseClick(e, this, plugin);
                    });
                    this.$ubermenu.on('click.ubermenu-click-target', '.ubermenu-item:not(.ubermenu-has-submenu-drop):not([data-ubermenu-trigger]) > .ubermenu-target', function (e) {
                        plugin.handleLink(e, this, plugin);
                    });
                }
            }
            else if (trigger == 'hover_intent') {
                evt = 'mouseenter.mouse_intent';	// > .ubermenu-target
                this.$ubermenu.on(evt, '.ubermenu-item.ubermenu-has-submenu-drop:not([data-ubermenu-trigger])', function (e) {
                    plugin.handleMouseIntent(e, this, plugin);
                });
                this.$ubermenu.on('click.ubermenu-click-target', '.ubermenu-item:not([data-ubermenu-trigger]) > .ubermenu-target', function (e) {
                    plugin.handleLink(e, this, plugin);
                });
            }
            else {
                ...
                this.$ubermenu.on(evt, '.ubermenu-item.ubermenu-has-submenu-drop:not([data-ubermenu-trigger]) > .ubermenu-target', function (e) {
                    plugin.handleMouseover(e, this, plugin);
                });
                this.$ubermenu.on('click.ubermenu-click-target', '.ubermenu-item:not([data-ubermenu-trigger]) > .ubermenu-target', function (e) {
                    plugin.handleLink(e, this, plugin);
                });
            ...
            plugin.$ubermenu.find('.ubermenu-item[data-ubermenu-trigger]').each(function () {
                ...
                if (trigger == 'click') {
                    if (!this.suppress_clicks) {	//hmm
                        $li.on('click.ubermenu-submenu-toggle', '.ubermenu-target', function (e) {
                            plugin.handleMouseClick(e, this, plugin);
                        });
                    }
                }
                ...
                //Hover
                    ...
                    $li.on('mouseenter.ubermenu-submenu-toggle', '.ubermenu-target', function (e) {
                        plugin.handleMouseover(e, this, plugin);
                    });
                }
            });
        ...
        initializeRetractors: function () {
            ...
            this.$ubermenu.on('click', '.ubermenu-retractor', function (e) {
                plugin.handleSubmenuRetractorEnd(e, this, plugin);
            });

            //set up the retractors
            this.$ubermenu.on(this.touchStart, '.ubermenu-retractor', function (e) {
                plugin.handleSubmenuRetractorStart(e, this, plugin);
            });	// > .ubermenu-target

            //If this device does not support touch interactions, and the strategy is touch, remove the mobile retractors
            if (!this.touchenabled && plugin.settings.retractor_display_strategy == 'touch') {
                this.$ubermenu.find('.ubermenu-retractor-mobile').remove();
                this.$ubermenu.find('.ubermenu-submenu-retractor-top').removeClass('ubermenu-submenu-retractor-top');
            }
        ...
        initializeTouchoffClose: function () {
            ...
            var plugin = this;
            $(document).on(this.touchEnd + '.ubermenu_touchoff', function (e) {
                plugin.handleTouchoffClose(e, this, plugin);
            });
            $(document).on('mouseup.ubermenu_clickoff', function (e) {
                plugin.handleTouchoffClose(e, this, plugin);
            }); //use mouseup instead of click for firefox
        ...
        sizeTabs: function () {
            ...
            plugin.$tab_blocks.each(function () {
                ...
                if (( $(this).hasClass('ubermenu-tab-layout-top') ||
                    $(this).hasClass('ubermenu-tab-layout-bottom') ) && !responsive) {
        ...
        handleClicks: function (e, a, plugin) {
            ...
            //if( $li.data( 'ubermenu-killClick' ) ){
            if ($a.data('ubermenu-killClick')) {
                e.preventDefault();
                e.stopPropagation();
                //if( plugin.settings.debug )
                //console.log( 'killed click after touchend ', e );
            }

            //Reset flag in any event
            //$li.data( 'ubermenu-killClick' , false );
        ...
        handleTouchInteraction: function (e, target, plugin) {
            ...
            setTimeout(function () {
                $target.data('ubermenu-killClick', false).data('ubermenu-killHover', false);
            }, 1000);
            ...
            $target.on(plugin.touchEnd, function (e) {
                plugin.handleTap(e, this, plugin);
            });
            $target.on(plugin.touchMove, function (e) {
                plugin.preventInteractionOnScroll(e, this, plugin);
            });
        ...
        handleMouseIntentSuccess: function (e, $item, plugin) {
            ...
            if (!$item.hasClass('ubermenu-tab')) {
                $item.on('mouseleave.mouse_intent', function (e) {
                    plugin.handleMouseIntentLeave(e, this, plugin);
                });
            }
        },
        ...
        compare: function (e, $el, func, plugin) {
            ...
            if (( Math.abs(pX - cX) + Math.abs(pY - cY) ) < plugin.settings.intent_threshold) {
                ...
                $el.data('mouse_intent_timer', setTimeout(function () {
                    plugin.compare(e, $el, func, plugin);
                }, plugin.settings.intent_interval));
            }
        },
        ...
        handleMouseover: function (e, target, plugin) {
            ...
            if ($item.size()) {
                if (!$item.hasClass('ubermenu-active')) {
                    ...
                    if (!$item.hasClass('ubermenu-tab')) {
                        $item.on('mouseleave.ubermenu-submenu-toggle', function (e) {
                            plugin.handleMouseout(e, this, plugin);
                        });
                    }
                }
            }
