...
function ubermenu_item_save_padding($item_id, $setting, $val, &$saved_settings)
{
    ...
    if ($val || is_numeric($val)) {    //include '0'
        ...
        $selector =
            ".ubermenu .ubermenu-item-$item_id > .ubermenu-target," .
            ".ubermenu .ubermenu-item-$item_id > .ubermenu-content-block," .
            ".ubermenu .ubermenu-item-$item_id.ubermenu-custom-content-padded";
