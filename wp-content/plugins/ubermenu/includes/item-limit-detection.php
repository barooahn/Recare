    ...
    if ($r['suhosin_post_maxvars'] != '' ||
        ...
        if (!empty($message)):
            ...
            <div class="ubermenu-admin-notice ubermenu-admin-notice-warning ubermenu-admin-notice-menu-item-limit">
                ...
                <h3><a href="http://goo.gl/DBZJxI"><?php _e('Menu Item Limit Warning', 'ubermenu'); ?> <i
                ...
                <table>
                    ...
                    <?php if ($r['suhosin_post_maxvars'] != ''): ?>
                        <tr>
                            <td>suhosin.post.max_vars</td>
                            <td><?php echo $r['suhosin_post_maxvars']; ?></td>
                        </tr>
                    <?php endif; ?>
