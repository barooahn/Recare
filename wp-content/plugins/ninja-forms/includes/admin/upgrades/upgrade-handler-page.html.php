            ...
            <div id="nf_upgrade_<?php echo $upgrade->name ?>">
                <dl class="menu-item-bar nf_upgrade">
                    <dt class="menu-item-handle">
                        <span
                            class="item-title ninja-forms-field-title nf_upgrade__name"><?php echo $upgrade->nice_name; ?></span>
                                <span class="item-controls">
                                    <span class="item-type">
                                        <span class="item-type-name nf_upgrade__status">
                                            ...
                                            <!-- Status: PROCESSING -->
                                            <span class="spinner"
                                                  style="display: none;margin-top: -1.5px;margin-right: -2px;"></span>
                                            <!-- Status: COMPLETE -->
                ...
                <div class="menu-item-settings menu-item-settings--nf-upgrade type-class inside" style="display: none;">
                    ...
                    <div class="nf-upgrade-handler__errors"
                         style="display: none; box-sizing: border-box; border: 1px solid #DEDEDE; padding-left: 5px; margin-right: 10px; border-radius: 3px; background-color: #EDEDED;">
...
<div class="nf-upgrade-complete-buttons" style="display: none;">
    <div id="nf-admin-modal-update">
        <a class="button-primary"
           href="<?php echo admin_url('admin.php?page=ninja-forms'); ?>"><?php _e('Go to Forms', 'ninja-forms'); ?></a>
    </div>
