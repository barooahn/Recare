...
class NF_Welcome
{
        ...
        <div class="wrap about-wrap">
            ...
            <div class="changelog">
                ...
                <div class="about-overview">
                    <iframe width="640" height="360" src="//www.youtube.com/embed/todRiV7Cel0" frameborder="0"
    ...
    public function tabs()
    {
        ...
        <h2 class="nav-tab-wrapper">
            <a class="nav-tab <?php echo $selected == 'nf-about' ? 'nav-tab-active' : ''; ?>"
               href="<?php echo esc_url(admin_url(add_query_arg(array('page' => 'nf-about'), 'index.php'))); ?>">
                <?php _e("What's New", 'ninja-forms'); ?>
            </a>
            <a class="nav-tab <?php echo $selected == 'nf-getting-started' ? 'nav-tab-active' : ''; ?>"
               href="<?php echo esc_url(admin_url(add_query_arg(array('page' => 'nf-getting-started'), 'index.php'))); ?>">
                <?php _e('Getting Started', 'ninja-forms'); ?>
            </a>
            <a class="nav-tab <?php echo $selected == 'nf-credits' ? 'nav-tab-active' : ''; ?>"
               href="<?php echo esc_url(admin_url(add_query_arg(array('page' => 'nf-credits'), 'index.php'))); ?>">
        ...
        <div class="wrap about-wrap">
            ...
            <div class="changelog">
                ...
                <div class="feature-section">
                    ...
                    <img style="width: 500px; height: 292px;"
                         src="<?php echo NF_PLUGIN_URL . 'assets/images/screenshots/ss-new-form.png'; ?>"
                         class="nf-welcome-screenshots">
    ...
    public function credits_screen()
    {
        ...
        <div class="wrap about-wrap">
            ...
            <div
                class="about-text"><?php printf(__('Thank you for updating to the latest version! Ninja Forms %s is primed to make your experience managing submissions an enjoyable one!', 'ninja-forms'), $display_version); ?></div>
    ...
    public function welcome()
    {
        ...
        if (!$upgrade) { // First time install
            wp_safe_redirect(admin_url('index.php?page=nf-getting-started'));
            exit;
        } else { // Update
            wp_safe_redirect(admin_url('index.php?page=nf-about'));
            exit;
        }
    }
}
