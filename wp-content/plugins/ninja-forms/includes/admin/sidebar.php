    ...
    <div id="side-sortables" class="meta-box-sortables ui-sortable">
        ...
        if (isset($ninja_forms_sidebars[$current_page][$current_tab]) AND is_array($ninja_forms_sidebars[$current_page][$current_tab])) {
			...
			<span class="item-controls">
				<a class="item-edit metabox-item-edit" id="edit_id"
                   title="<?php _e('Edit Menu Item', 'ninja-forms'); ?>"
                   href="#"><?php _e('Edit Menu Item', 'ninja-forms'); ?></a>
			</span>
                                        ...
                                        if (isset($option['display_function']) AND !empty($option['display_function'])) {
                                            ...
                                            switch ($option['type']) {
                                                case 'checkbox':
                                                    ...
                                                    <label
                                                        for="<?php echo $name; ?>"><?php _e($option['label'], 'ninja-forms'); ?></label>
                                                    <?php
                                                    break;
                                                case 'radio':
                                                    ?>
                                            ...
                                            if (isset($option['help']) AND !empty($option['help'])) {
                                                ...
                                                <a href="#" class="tooltip">
                                                    <img id="" class='ninja-forms-help-text'
                                                         src="<?php echo NINJA_FORMS_URL; ?>images/question-ico.gif"
                                                         title="">
								    <span>
