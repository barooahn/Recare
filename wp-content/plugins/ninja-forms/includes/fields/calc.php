...
function ninja_forms_field_calc_edit($field_id, $data)
{
    ...
    <div class="ninja-forms-calculations <?php echo $field_class; ?>">
        <div class="label">
            <?php _e('Field Operations', 'ninja-forms'); ?> - <a href="#" name=""
                                                                 id="ninja_forms_field_<?php echo $field_id; ?>_add_calc"
                                                                 class="ninja-forms-field-add-calc"
                                                                 rel="<?php echo $field_id; ?>"><?php _e('Add Operation', 'ninja-forms'); ?></a>
...
function ninja_forms_field_calc_display($field_id, $data, $form_id = '')
{
    ...
    ?>
    <input type="hidden" name="ninja_forms_field_<?php echo $field_id; ?>" value="<?php echo $default_value; ?>"
    ...
    switch ($calc_display_type) {
        case 'text':
            ?>
            <input type="text" id="ninja_forms_field_<?php echo $field_id; ?>"
                   name="ninja_forms_field_<?php echo $field_id; ?>"
                   value="<?php echo $default_value; ?>" <?php echo $disabled; ?> class="<?php echo $field_class; ?>"
...
function ninja_forms_output_field_calc_row($field_id, $c = array(), $x = 0)
{
    ...
    ?>
    <div id="ninja_forms_field_<?php echo $field_id; ?>_calc_row_<?php echo $x; ?>" class="ninja-forms-calc-row"
         rel="<?php echo $x; ?>">
        <a href="#" id="ninja_forms_field_<?php echo $field_id; ?>_remove_calc" name="<?php echo $x; ?>"
           rel="<?php echo $field_id; ?>" class="ninja-forms-field-remove-calc">X</a>
        ...
        <select name="ninja_forms_field_<?php echo $field_id; ?>[calc][<?php echo $x; ?>][field]"
                class="ninja-forms-calc-select">
            ...
            foreach ($fields as $field) {
                ...
                if ($field['id'] != $field_id AND $process_field) {
                    ?>
                    <option
                        value="<?php echo $field['id']; ?>" <?php selected($calc_field, $field['id']); ?>><?php echo $field['id']; ?>
