...
<style>
    ...
    table.dup-sys-info-results td:first-child {
        width: 200px
    }

    /* -----------------------------
    PACKAGE OPTS*/
    form#dup-form-opts label {
        line-height: 22px
    }

    form#dup-form-opts input[type=checkbox] {
        margin-top: 3px
    }

    form#dup-form-opts fieldset {
        border-radius: 4px;
    ...
    form#dup-form-opts textarea, input[type="text"] {
        width: 100%
    }

    form#dup-form-opts textarea#filter-dirs {
        height: 85px
    }

    form#dup-form-opts textarea#filter-exts {
        height: 27px
    }

    textarea#package_notes {
        height: 37px;
    }
    ...
    /*ARCHIVE SECTION*/
    form#dup-form-opts div.tabs-panel {
        max-height: 550px;
        padding: 10px;
        min-height: 280px
    }

    form#dup-form-opts ul li.tabs {
        font-weight: bold
    }
    ...
    span#dup-archive-filter-file {
        color: #A62426;
        display: none
    }

    span#dup-archive-filter-db {
        color: #A62426;
        display: none
    }

    div#dup-file-filter-items, div#dup-db-filter-items {
        padding: 2px 0px 0px 15px;
        font-stretch: ultra-condensed;
        font-family: Calibri;
    }

    label.dup-enable-filters {
        display: inline-block;
    ...
    table.dbmysql-compatibility td {
        padding: 2px 20px 2px 2px
    }

    /*INSTALLER SECTION*/
    div.dup-installer-header-1 {
        font-weight: bold;
        padding-bottom: 2px;
        width: 100%
    }

    div.dup-installer-header-2 {
        font-weight: bold;
    ...
    <tr valign="top">
        ...
        <td class="dup-toolbar-btns">
            <a id="dup-pro-create-new" href="?page=duplicator" class="add-new-h2"><i
                    class="fa fa-archive"></i> <?php _e("All Packages", 'duplicator'); ?></a> &nbsp;
...
<div class="dup-box">
    ...
    <div class="dup-box-panel" style="<?php echo ($dup_tests['Success']) ? 'display:none' : ''; ?>">
        ...
        <div class='dup-sys-req'>
            ...
            <div class="dup-sys-info dup-info-box">
                <table class="dup-sys-info-results">
                    ...
                    <tr>
                        <td><?php _e('Function', 'duplicator'); ?> <a
                                href="http://php.net/manual/en/function.file-get-contents.php" target="_blank">file_get_contents</a>
                        </td>
                        <td><?php echo $dup_tests['PHP']['FUNC_1'] ?></td>
                    </tr>
                    <tr>
                        <td><?php _e('Function', 'duplicator'); ?> <a
                                href="http://php.net/manual/en/function.file-put-contents.php" target="_blank">file_put_contents</a>
                        </td>
                        <td><?php echo $dup_tests['PHP']['FUNC_2'] ?></td>
                    </tr>
                    <tr>
                        <td><?php _e('Function', 'duplicator'); ?> <a
                                href="http://php.net/manual/en/mbstring.installation.php" target="_blank">mb_strlen</a>
                        </td>
        ...
        <div class='dup-sys-req'>
            <div class='dup-sys-title'>
                <a><?php _e('Permissions', 'duplicator'); ?></a>

                <div><?php echo $dup_tests['IO']['ALL']; ?></div>
            </div>
            <div class="dup-sys-info dup-info-box">
        ...
        <div class='dup-sys-req'>
            <div class='dup-sys-title'>
                <a><?php _e('Reserved Files', 'duplicator'); ?></a>

                <div><?php echo $dup_tests['RES']['INSTALL']; ?></div>
            </div>
            <div class="dup-sys-info dup-info-box">
                ...
                <?php else:
                    ...
                    ?>
                    <form method="post"
                          action="admin.php?page=duplicator-tools&tab=cleanup&action=installer&_wpnonce=<?php echo $duplicator_nonce; ?>">
                        ...
                        <br/><input type='submit' class='button action'
                                    value='<?php _e('Remove Files Now', 'duplicator') ?>'
