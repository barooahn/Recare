...
<style>
    ...
    div#dup-progress-area div.inner {
        padding: 10px;
        line-height: 22px
    }

    div#dup-progress-area h2.title {
        background-color: #efefef;
        margin: 0px
    }

    div#dup-progress-area span.label {
        font-weight: bold
    }
    ...
    div.dup-msg-success-stats {
        color: #999;
        margin: 10px 0px 0px 0px
    }

    div.dup-msg-success-links {
    ...
    div#dup-progress-area div.done-title {
        font-size: 22px;
        font-weight: bold;
...
<form id="form-duplicator" method="post" action="?page=duplicator">
    ...
    <div id="dup-progress-bar-area">
        <div class="dup-progress-title"><i class="fa fa-cog fa-spin"></i> <?php _e('Building Package', 'duplicator'); ?>
        </div>
    ...
    <div id="dup-progress-area" class="dup-panel" style="display:none">
        <div class="dup-panel-title dup-box-title-fancy"><b
                style="font-size:18px"><?php _e('Build Status', 'duplicator'); ?></b></div>
        <div class="dup-panel-panel">
            ...
            <div id="dup-msg-error" style="display:none">
                <div class="done-title"><i class="fa fa-chain-broken"></i> <?php _e('Build Interrupt', 'duplicator'); ?>
                </div>
                ...
                <input type="button" style="margin-right:10px;" class="button"
                       value="<?php _e('Diagnose', 'duplicator'); ?>"
                       onclick="window.open('http://lifeinthegrid.com/support/knowledgebase.php?article=12#faq-trouble-timeout', '_blank');return false;"/>
                <input type="button" class="button" value="<?php _e('Try Again', 'duplicator'); ?>"
                       onclick="window.location = 'admin.php?page=duplicator&tab=new1'"/>
                <fieldset>
                ...
                <div id="dup-logs">
                    <div style="font-weight:bold">
                        <i class="fa fa-list-alt"></i> <a href='javascript:void(0)' style="color:#A62426"
                                                          onclick='Duplicator.OpenLogWindow()'> <?php _e('Package Log', 'duplicator'); ?> </a>
                    </div>
                    <br/>
                </div>
