...
<style>
    ...
    div#dup-msg-error-response-text {
        max-height: 350px;
        overflow-y: scroll;
    ...
    div.dup-scan-title a {
        display: inline-block;
        min-width: 200px;
        padding: 3px;
    }

    div.dup-scan-title a:focus {
        outline: 1px solid #fff;
        box-shadow: none
    }

    div.dup-scan-title div {
        display: inline-block;
    }
    ...
    /*DATABASE*/
    table#dup-scan-db-details {
        line-height: 14px;
        margin: 15px 0px 0px 5px;
        width: 98%
    }

    table#dup-scan-db-details td {
        padding: 0px;
    }

    table#dup-scan-db-details td:first-child {
        font-weight: bold;
        white-space: nowrap;
        width: 90px
    }

    div#dup-scan-db-info {
        margin: 0px 0px 0px 10px
    }

    div#data-db-tablelist {
        max-height: 300px;
        overflow-y: scroll
    }

    div#data-db-tablelist div {
        padding: 0px 0px 0px 15px;
    }

    div#data-db-tablelist span {
        display: inline-block;
        min-width: 75px
    }
    ...
    div#dup-scan-warning-continue {
        display: none;
        text-align: center;
        padding: 0 0 15px 0
    }

    div#dup-scan-warning-continue div.msg1 label {
        font-size: 16px;
        color: maroon
    }

    div#dup-scan-warning-continue div.msg2 {
        padding: 2px
    }

    div#dup-scan-warning-continue div.msg2 label {
...
<table id="dup-toolbar">
    <tr valign="top">
        ...
        <td class="dup-toolbar-btns">
            <a id="dup-pro-create-new" href="?page=duplicator" class="add-new-h2"><i
                    class="fa fa-archive"></i> <?php DUP_Util::_e("All Packages"); ?></a> &nbsp;
...
<form id="form-duplicator" method="post" action="?page=duplicator&tab=new3">
    <div id="dup-progress-area">
        ...
        <div id="dup-progress-bar-area">
            <div class="dup-progress-title"><i
                    class="fa fa-spinner fa-spin"></i> <?php DUP_Util::_e('Scanning Site'); ?></div>
        ...
        <div id="dup-msg-success" style="display:none">
            <div style="text-align:center">
                <div class="dup-hdr-success"><i
                        class="fa fa-check-square-o fa-lg"></i> <?php DUP_Util::_e('Scan Complete'); ?></div>
            ...
            <div class="dup-panel">
                <div class="dup-panel-title">
                    ...
                    <div style="float:right; margin:-1px 10px 0px 0px">
                        <small><a href="?page=duplicator-tools&tab=diagnostics"
                                  target="_blank"><?php DUP_Util::_e('Diagnostics'); ?></a></small>
                    </div>
                ...
                <div class="dup-panel-panel">
                    ...
                    <div>
                        <div class='dup-scan-title'>
                            <a><?php DUP_Util::_e('Web Server'); ?></a>
            ...
            <h2 style="font-size:18px; font-weight:bold; margin:-15px 0 0 10px"><i class="fa fa-file-archive-o"></i>&nbsp;<?php DUP_Util::_e('Archive'); ?>
            </h2>
            ...
            <div class="dup-panel">
                ...
                <div class="dup-panel-panel">
                    ...
                    <div>
                        <div class='dup-scan-title'>
                            <a><?php DUP_Util::_e('Name Checks'); ?></a>
                        ...
                        <div class='dup-scan-info dup-info-box'>
                            ...
                            <a href="javascript:void(0)"
                               onclick="jQuery('#data-arc-names-data').toggle()">[<?php DUP_Util::_e('Show Paths'); ?>
                                ]</a>
                    ...
                    <div>
                        <div class='dup-scan-title'>
                            <a><?php DUP_Util::_e('Large Files'); ?></a>
                        ...
                        <div class='dup-scan-info  dup-info-box'>
                            ...
                            <br/>
                            <a href="javascript:void(0)"
                               onclick="jQuery('#data-arc-big-data').toggle()">[<?php DUP_Util::_e('Show Paths'); ?>
                                ]</a>
                        ...
                        <div>
                            ...
                            <div class='dup-scan-info  dup-info-box'>
                                ...
                                <small>
                                    ...
                                    ?>
                                    <a href="<?php echo DUPLICATOR_SITE_URL ?>/wp-admin/admin-ajax.php?action=duplicator_package_scan"
                                       target="dup_report"><?php DUP_Util::_e('[view json report]'); ?></a>
                                </small>
                                <br/>
                            </div>
                        </div>
                ...
                <div class="dup-panel-panel" id="dup-scan-db">
                    ...
                    <table id="dup-scan-db-details">
                        <tr>
                            <td><b><?php DUP_Util::_e('Name:'); ?></b></td>
                            <td><?php echo DB_NAME; ?> </td>
                        </tr>
                        <tr>
                            <td><b><?php DUP_Util::_e('Host:'); ?></b></td>
            ...
            <div id="dup-scan-warning-continue">
                <div class="msg1">
                    <input type="checkbox" id="dup-scan-warning-continue-checkbox"
                           onclick="Duplicator.Pack.WarningContinue(this)"/>
                    <label
                        for="dup-scan-warning-continue-checkbox"><?php DUP_Util::_e('A warning status was detected, are you sure you want to continue?'); ?></label>
                </div>
                <div class="msg2">
        ...
        <div id="dup-msg-error" style="display:none">
            <div class="dup-hdr-error"><i class="fa fa-exclamation-circle"></i> <?php DUP_Util::_e('Scan Error'); ?>
            </div>
            <i><?php DUP_Util::_e('Please try again!'); ?></i><br/>

            <div style="text-align:left">
                <b><?php DUP_Util::_e("Server Status:"); ?></b> &nbsp;
                <div id="dup-msg-error-response-status" style="display:inline-block"></div>
                <br/>
    ...
    <div class="dup-button-footer" style="display:none">
        <input type="button" value="&#9668; <?php DUP_Util::_e("Back") ?>"
               onclick="window.location.assign('?page=duplicator&tab=new1')" class="button button-large"/>
        <input type="button" value="<?php DUP_Util::_e("Rescan") ?>" onclick="Duplicator.Pack.Rescan()"
               class="button button-large"/>
        <input type="submit" value="<?php DUP_Util::_e("Build") ?> &#9658" class="button button-primary button-large"
               id="dup-build-button"/>
...
<script type="text/javascript">
    jQuery(document).ready(function ($) {
        ...
        Duplicator.Pack.LoadScanStatus = function (status) {
            ...
            switch (status) {
                case false :
                    result = '<div class="dup-scan-warn"><i class="fa fa-exclamation-triangle"></i></div>';
                    break;
                case 'Warn' :
                    result = '<div class="dup-scan-warn"><i class="fa fa-exclamation-triangle"></i> Warn</div>';
                    break;
                case true :
                    result = '<div class="dup-scan-good"><i class="fa fa-check"></i></div>';
                    break;
                case 'Good' :
                    result = '<div class="dup-scan-good"><i class="fa fa-check"></i> Good</div>';
                    break;
                default :
