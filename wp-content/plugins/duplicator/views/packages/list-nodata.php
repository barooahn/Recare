    ...
    <?php if ($show_notice01)  : ?>
        <div id="dup-notice-01" class='dup-notice-msg'>
            ...
            <label for="dup-notice01-chk">
                <input type="checkbox" class="dup-notice-chk" id="dup-notice01-chk" name="dup-notice01-chk"
                       onclick="Duplicator.UI.SaveViewStateByPost('dup-notice01-chk', 1); jQuery('#dup-notice-01').hide()"/>
