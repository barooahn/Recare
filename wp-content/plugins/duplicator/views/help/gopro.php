...
<style>
    ...
    div.dup-compare-area div.feature div.info {
        display: none;
    ...
    div.dup-gopro-header b {
        font-size: 35px
    }

    a.dup-check-it-btn {
        box-shadow: 5px 5px 5px 0px #999 !important;
...
<div class="dup-pro-area">
    ...
    <p style="text-align:center">
        <a href="http://snapcreek.com/duplicator?free-go-pro" target="_blank"
