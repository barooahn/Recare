...
<style>
    div#dup-refresh-count {
        display: inline-block
    }

    table#dup-log-panels {
        width: 100%;
    }
    ...
    td#dup-log-panel-left div.name {
        float: left;
        margin: 0px 0px 5px 5px;
        font-weight: bold
    }

    td#dup-log-panel-left div.opts {
        float: right;
    }

    td#dup-log-panel-right {
        vertical-align: top;
        padding-left: 15px;
        max-width: 375px
    }

    div.dup-log-file-list a, span {
        display: inline-block;
        white-space: nowrap;
    ...
    label#dup-auto-refresh-lbl {
        display: inline-block;
    }

    iframe#dup-log-content {
        padding: 5px;
        background: #fff;
        min-height: 500px;
        width: 99%;
...
<form id="dup-form-logs" method="post" action="">
    ...
    <?php if (!$logfound)  : ?>
        <div style="padding:20px">
            ...
            <?php _e("Try to create a package, since no log files were found in the snapshots directory with the extension *.log", 'duplicator') ?>
            .<br/><br/>
            ...
            - <?php _e("The snapshots directory does not have the correct permissions to write files.  Try setting the permissions to 755", 'duplicator') ?>
            . <br/>
            - <?php _e("The process that PHP runs under does not have enough permissions to create files.  Please contact your hosting provider for more details", 'duplicator') ?>
            . <br/>
        </div>
        ...
        <table id="dup-log-panels">
            <tr>
                <td id="dup-log-panel-left">
                    ...
                    <div class="opts"><a href="javascript:void(0)" id="dup-options"><?php _e("Options", 'duplicator') ?>
                ...
                <td id="dup-log-panel-right">
                    ...
                    <div class="dup-opts-items">
                        <input type="button" class="button" id="dup-refresh"
                               value="<?php _e("Refresh", 'duplicator') ?>"/> &nbsp;
