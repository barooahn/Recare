...
<style type="text/css">
    ...
    table.dup-reset-opts td:first-child {
        font-weight: bold
    }

    table.dup-reset-opts td {
        padding: 10px
    }

    form#dup-settings-form {
...
<form id="dup-settings-form" action="?page=duplicator-tools&tab=cleanup" method="post">
    ...
    <?php if ($_GET['action'] != 'display')  : ?>
        <div id="message" class="updated below-h2">
            ...
            <?php if ($_GET['action'] == 'installer') : ?>
                ...
                <i><br/>
                    <?php DUP_Util::_e('If the installer files did not successfully get removed, then you WILL need to remove them manually') ?>
                    . <br/>
                    <?php DUP_Util::_e('Please remove all installer files to avoid leaving open security issues on your server') ?>
                    . <br/><br/>
                </i>
    ...
    <h3><?php DUP_Util::_e('Data Cleanup') ?>
        <hr size="1"/>
    </h3>
    <table class="dup-reset-opts">
        <tr style="vertical-align:text-top">
            <td>
                <a class="button button-small dup-fixed-btn"
                   href="?page=duplicator-tools&tab=cleanup&action=installer&_wpnonce=<?php echo $nonce; ?>">
            ...
            <td>
                ...
                <a href="javascript:void(0)"
                   onclick="jQuery('#dup-tools-delete-moreinfo').toggle()">[<?php DUP_Util::_e("more info"); ?>]</a>
                <br/>
        ...
        <tr>
            <td><a class="button button-small dup-fixed-btn" href="javascript:void(0)"
                   onclick="Duplicator.Tools.DeleteLegacy()"><?php DUP_Util::_e("Delete Legacy Data"); ?></a></td>
            <td><?php DUP_Util::_e("Removes all legacy data and settings prior to version"); ?>
                [<?php echo DUPLICATOR_VERSION ?>].
            </td>
        </tr>
        <tr>
            <td><a class="button button-small dup-fixed-btn" href="javascript:void(0)"
                   onclick="Duplicator.Tools.ClearBuildCache()"><?php DUP_Util::_e("Clear Build Cache"); ?></a></td>
