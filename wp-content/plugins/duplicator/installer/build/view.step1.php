...
<form id='dup-step1-input-form' method="post" class="content-form" parsley-validate>
    ...
    <?php if ($total_req == 'Fail')  : ?>
        ...
        <i id="dup-step1-sys-req-msg">
            This installation will not be able to proceed until the system requirements pass. Please validate your
            system requirements by clicking on the button above.
            In order to get these values to pass please contact your server administrator, hosting provider or visit the
            online FAQ.
        </i><br/>
    ...
    <?php else : ?>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="dbhost" id="dbhost" parsley-required="true"
                           value="<?php echo htmlspecialchars($GLOBALS['FW_DBHOST']); ?>" placeholder="localhost"
                           style="width:410px"/>
                    <input id="dup-step1-dbport-btn" type="button" onclick="Duplicator.togglePort()" style=""
                           value="Port: <?php echo htmlspecialchars($GLOBALS['FW_DBPORT']); ?>"/>
        ...
        <div id="dup-step1-dbconn">
            ...
            <div id="dup-step1-dbconn-status" style="display:none">
                ...
                <small><a href="javascript:void()" onclick="$('#dup-step1-dbconn-status').hide(1000)">Hide Connection
                        Details</a></small>
            </div>
        </div>
        ...
        <div id='dup-step1-cpanel' style="display:none">
            <div style="padding:10px 0px 0px 10px;line-height:22px">
                &raquo; Check out the <a href="http://lifeinthegrid.com/duplicator-tutorials" target="_blank">video
                    tutorials &amp; guides</a> <br/>
                &raquo; Get help from our <a href="http://lifeinthegrid.com/labs/duplicator/resources/" target="_blank">resources
                    page</a>
            </div>
        </div><br/><br/>
        ...
        <div id='dup-step1-adv-opts' style="display:none">
            <table class="dup-step1-inputs">
                <tr>
                    <td colspan="2"><input type="checkbox" name="zip_manual" id="zip_manual" value="1"/> <label
                            for="zip_manual">Manual package extraction</label></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2"><input type="checkbox" name="dbnbsp" id="dbnbsp" value="1"/> <label for="dbnbsp">Fix
                            non-breaking space characters</label></td>
                </tr>
                <tr>
                    <td style="width:130px">MySQL Charset</td>
                    <td><input type="text" name="dbcharset" id="dbcharset" value="<?php echo $_POST['dbcharset'] ?>"/>
                    </td>
                </tr>
                <tr>
                    <td>MySQL Collation</td>
                    <td><input type="text" name="dbcollate" id="dbcollate" value="<?php echo $_POST['dbcollate'] ?>"/>
                </tr>
            </table>
        </div>
        ...
        <div id="dup-step1-warning">
            ...
            <p>
                <b>Disclaimer:</b>
                This plugin require above average technical knowledge. Please use it at your own risk and always back up
                your database and files beforehand using another backup
                system besides the Duplicator. If you're not sure about how to use this tool then please enlist the
                guidance of a technical professional. <u>Always</u> test
            ...
            <p>
                ...
                that already exists will permanently DELETE all data in that database. This tool is designed to populate
                and fill a database with NEW data from a duplicated
                database using the SQL script in the package name above.
            </p>

            <p>
                <b>Setup:</b>
                Only the archive and installer.php file should be in the install directory, unless you have manually
                extracted the package and checked the
                'Manual Package Extraction' checkbox. All other files will be OVERWRITTEN during install. Make sure you
                have full backups of all your databases and files
                before continuing with an installation.</p>

            <p>
                <b>Manual Extraction:</b>
                Manual extraction requires that all contents in the package are extracted to the same directory as the
                installer.php file.
                Manual extraction is only needed when your server does not support the ZipArchive extension. Please see
        ...
        <div id="dup-step1-warning-check">
            ...
            <label for="accept-warnings">I have read all warnings &amp; notices</label><br/>
...
<form id='dup-step1-result-form' method="post" class="content-form" style="display:none">
    ...
    <div id="ajaxerr-area" style="display:none">
        ...
        <div style="padding: 0px 10px 10px 0px;">
            <div id="ajaxerr-data">An unknown issue has occurred with the file and database setup process. Please see
                the installer-log.txt file for more details.
            </div>
            <div style="text-align:center; margin:10px auto 0px auto">
                <input type="button" onclick='Duplicator.hideErrorResult()' value="&laquo; Try Again"/><br/><br/>
                <i style='font-size:11px'>See online help for more details at <a href='http://lifeinthegrid.com/support'
...
<div id="dup-step1-dialog" title="System Status" style="display:none">
    <div id="dup-step1-dialog-data" style="padding: 0px 10px 10px 10px;">
        ...
        <table style="width:100%">
            ...
            <tr>
                <td><a href="http://us2.php.net/manual/en/mysqli.installation.php" target="_blank">MySQLi Support</a>
                </td>
        ...
        <br/>
        Need an <a href='http://lifeinthegrid.com/duplicator-hosts' target='_blank'>approved</a> Duplicator hosting
        provider?
