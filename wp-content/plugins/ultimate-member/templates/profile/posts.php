        ...
        <?php if ($ultimatemember->shortcodes->loop->found_posts >= 10) { ?>
            ...
            <div class="um-load-items">
                <a href="#" class="um-ajax-paginate um-button" data-hook="um_load_posts"
                   data-args="post,10,10,<?php echo um_user('ID'); ?>"><?php _e('load more posts', 'ultimatemember'); ?></a>
            </div>
...
<?php } else { ?>
    ...
    <div class="um-profile-note">
        <span><?php echo (um_profile_id() == get_current_user_id()) ? __('You have not created any posts.', 'ultimatemember') : __('This user has not created any posts.', 'ultimatemember'); ?></span>
    </div>
