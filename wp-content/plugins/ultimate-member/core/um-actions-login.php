...
function um_add_submit_button_to_login($args)
{
    ...
    <div class="um-col-alt">
        ...
        <?php if (isset($args['secondary_btn']) && $args['secondary_btn'] != 0) { ?>
            ...
            <div class="um-left um-half"><input type="submit" value="<?php echo $primary_btn_word; ?>"
                                                class="um-button"/></div>
            <div class="um-right um-half"><a href="<?php echo $secondary_btn_url; ?>"
                                             class="um-button um-alt"><?php echo $secondary_btn_word; ?></a></div>
...
function um_after_login_submit($args)
{
    ...
    <div class="um-col-alt-b">
        <a href="<?php echo um_get_core_page('password-reset'); ?>"
           class="um-link-alt"><?php _e('Forgot your password?', 'ultimatemember'); ?></a>
    </div>
