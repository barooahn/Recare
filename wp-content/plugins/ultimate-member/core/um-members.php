    ...
    function show_filter($filter)
    {
        ...
        switch ($type) {
            ...
            case 'select':
                ...
                <select name="<?php echo $filter; ?>" id="<?php echo $filter; ?>" class="um-s1" style="width: 100%"
                        data-placeholder="<?php echo stripslashes($attrs['label']); ?>">
                    ...
                    <?php foreach ($attrs['options'] as $k => $v) {
                        ...
                        <option
                            value="<?php echo $opt; ?>" <?php um_select_if_in_query_params($filter, $opt); ?>><?php echo $v; ?></option>
            ...
            case 'text':
                ...
                <input type="text" name="<?php echo $filter; ?>" id="<?php echo $filter; ?>"
                       placeholder="<?php echo isset($attrs['label']) ? $attrs['label'] : ''; ?>"
                       value="<?php um_queried_search_value($filter); ?>"/>
