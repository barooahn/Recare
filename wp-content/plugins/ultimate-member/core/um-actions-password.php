...
function um_reset_password_form()
{
    ...
    <div class="um-col-alt um-col-alt-b">
        ...
        <div class="um-center"><input type="submit" value="<?php _e('Reset my password', 'ultimatemember'); ?>"
                                      class="um-button"/></div>
...
function um_change_password_form()
{
    ...
    <div class="um-col-alt um-col-alt-b">
        ...
        <div class="um-center"><input type="submit" value="<?php _e('Change my password', 'ultimatemember'); ?>"
                                      class="um-button"/></div>
