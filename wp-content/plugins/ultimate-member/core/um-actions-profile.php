...
function um_profile_header_cover_area($args)
{
    ...
    if ($args['cover_enabled'] == 1) {
        ...
        <div
            class="um-cover <?php if (um_profile('cover_photo') || ($default_cover && $default_cover['url'])) echo 'has-cover'; ?>"
                ...
                <?php } elseif ($default_cover && $default_cover['url']) {
                    ...
                    if (!isset($ultimatemember->user->cannot_edit)) { ?>
                        ...
                        <a href="#" class="um-cover-add um-manual-trigger" data-parent=".um-cover"
                           data-child=".um-btn-auto-width"><span class="um-cover-add-i"><i class="um-icon-plus um-tip-n"
                                                                                           title="<?php _e('Upload a cover photo', 'ultimatemember'); ?>"></i></span></a>
            ...
            <?php } else if ($ultimatemember->fields->editing == true && $args['show_bio']) { ?>
                ...
                <div class="um-meta-text">
                    <textarea id="um-meta-bio"
                              ...
                              placeholder="<?php _e('Tell us a bit about yourself...', 'ultimatemember'); ?>"
...
function um_profile_navbar($args)
{
    ...
    <div class="um-profile-nav">
        ...
        <?php foreach ($tabs as $id => $tab) {
            ...
            <div
                class="um-profile-nav-item um-profile-nav-<?php echo $id; ?> <?php if (!um_get_option('profile_menu_icons')) {
                    echo 'without-icon';
                ...
                <a href="<?php echo $nav_link; ?>" title="<?php echo $tab['name']; ?>">
                    ...
                    <?php if (isset($tab['notifier']) && $tab['notifier'] > 0) { ?>
                        <span
                            class="um-tab-notifier uimob500-show uimob340-show uimob800-show"><?php echo $tab['notifier']; ?></span>
                    <?php } ?>
