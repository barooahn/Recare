            ...
            foreach (self::$fields as $_key => $label) :
                ...
                <div class="description-wide um-nav-mode">
                    ...
                    <p class="description">
                        ...
                        <label><input type="radio" name="<?php echo $name; ?>"
                                      value="0" <?php if (!isset($value) || $value == '') echo 'checked="checked"'; ?> />
                            Everyone</label>&nbsp;&nbsp;

                        <label><input type="radio" name="<?php echo $name; ?>" value="1" <?php checked(1, $value); ?> />
                            Logged Out Users</label>&nbsp;&nbsp;

                        <label><input type="radio" name="<?php echo $name; ?>" value="2" <?php checked(2, $value); ?> />
                    ...
                    <p class="description">
                        ...
                        <?php foreach ($ultimatemember->query->get_roles() as $role_id => $role) { ?>
                            <label><input type="checkbox" name="<?php echo $name; ?>[]"
                                          value="<?php echo $role_id; ?>" <?php if ((is_array($value) && in_array($role_id, $value)) || (isset($value) && $role_id == $value)) echo 'checked="checked"'; ?> /> <?php echo $role; ?>
                            </label>&nbsp;&nbsp;
                        <?php } ?>
