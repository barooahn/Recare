...
<div class="um-admin-metabox">
    ...
    <div class="">
        ...
        <p>
            <label
                class="um-admin-half"><?php _e('Link to WordPress role', 'ultimatemember'); ?><?php $this->tooltip(__('Users who get this community role will be assigned this WordPress role automatically', 'ultimatemember')); ?></label>
        ...
        <p><a href="<?php echo $url; ?>"
              class="button"><?php _e('Sync / update all existing users', 'ultimatemember'); ?></a></p>
