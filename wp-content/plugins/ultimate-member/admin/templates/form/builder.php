...
<div class="um-admin-builder" data-form_id="<?php echo $UM_Builder->form_id; ?>">
    ...
    <div class="um-admin-drag-ctrls-demo um-admin-drag-ctrls">
        ...
        <a href="#" class="active" data-modal="UM_preview_form" data-modal-size="smaller"
           data-dynamic-content="um_admin_preview_form" data-arg1="<?php the_ID(); ?>"
           data-arg2=""><?php _e('Live Preview', 'ultimatemember'); ?></a>
    ...
    <div class="um-admin-drag">
        ...
        <div class="um-admin-drag-addrow um-admin-tipsy-n" title="<?php _e('Add Master Row', 'ultimatemember'); ?>"
             data-row_action="add_row"><i class="um-icon-plus"></i></div>
