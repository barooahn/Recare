    ...
    function restrict_manage_users()
    {
        ...
        <div style="float:right;margin:0 4px">
            ...
            <select name="um_filter_role[]" id="um_filter_role" class="" style="width: 120px">
                ...
                foreach ($roles as $role => $role_name) { ?>
                    <option
                        value="<?php echo urlencode($role); ?>" <?php selected($role, $um_filter_role); ?>><?php echo $role_name; ?></option>
                <?php } ?>
            </select>
        ...
        <div style="float:right;margin:0 4px">
            ...
            <label class="screen-reader-text"
                   for="um_change_role"><?php _e('Community role&hellip;', 'ultimatemember'); ?></label>
            ...
            <input name="um_changeit" id="um_changeit" class="button" value="<?php _e('Change', 'ultimatemember'); ?>"
                   type="submit"/>
