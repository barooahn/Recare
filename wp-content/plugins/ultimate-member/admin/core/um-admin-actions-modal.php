...
{ ?>
    ...
    <div class="um-admin-success-block"></div> <?php }
...
function um_admin_add_conditional_support($form_id, $field_args, $in_edit, $edit_array)
{
    ...
    <div class="um-admin-btn-toggle">
        ...
        <?php if ($in_edit) {
            ...
            <a href="#"><i class="um-icon-plus"></i><?php _e('Manage conditional fields support'); ?>
            </a> <?php $metabox->tooltip('Here you can setup conditional logic to show/hide this field based on specific fields value or conditions'); ?>
        <?php } else { ?>
            <a href="#"><i class="um-icon-plus"></i><?php _e('Add conditional fields support'); ?>
            </a> <?php $metabox->tooltip('Here you can setup conditional logic to show/hide this field based on specific fields value or conditions'); ?>
        <?php } ?>

        <div class="um-admin-btn-content">

            <p class="um-admin-reset-conditions"><a href="#"
                                                    class="button button-primary"><?php _e('Reset all rules', 'ultimatemember'); ?></a>
            </p>
            ...
            if (isset($edit_array['conditions'])) {
                ...
                foreach ($edit_array['conditions'] as $k => $arr) {
                    ...
                    <div class="um-admin-cur-condition">
                        ...
                        <?php if ($k == '') { ?>
                            <p><a href="#" class="um-admin-new-condition button um-admin-tipsy-n"
                                  title="Add new condition"><i class="um-icon-plus"
                                                               style="margin-right:0!important"></i></a></p>
                        <?php } else { ?>
                            <p><a href="#" class="um-admin-remove-condition button um-admin-tipsy-n"
                                  title="Remove condition"><i class="um-icon-close"
                                                              style="margin-right:0!important"></i></a></p>
                        <?php } ?>
                ...
                <div class="um-admin-cur-condition">
                    ...
                    <p><a href="#" class="um-admin-new-condition button um-admin-tipsy-n" title="Add new condition"><i
                                class="um-icon-plus" style="margin-right:0!important"></i></a></p>
    ...
    switch ($act_id) {
        ...
        case 'um_admin_fonticon_selector':
            ...
            <div class="um-admin-metabox">
                <p class="_icon_search"><input type="text" name="_icon_search" id="_icon_search" value=""
                                               placeholder="<?php _e('Search Icons...', 'ultimatemember'); ?>"/></p>
            </div>

            <div class="um-admin-icons">
                <?php foreach ($ultimatemember->icons->all as $icon) { ?>
                    <span data-code="<?php echo $icon; ?>" title="<?php echo $icon; ?>" class="um-admin-tipsy-n"><i
                ...
                if ($ultimatemember->builtin->core_fields) {
                    foreach ($ultimatemember->builtin->core_fields as $field_type => $array) {
                        ...
                        if (isset($array['in_fields']) && $array['in_fields'] == false) {
                            ...
                            <a href="#" class="button" data-modal="UM_add_field" data-modal-size="normal"
                               data-dynamic-content="um_admin_new_field_popup" data-arg1="<?php echo $field_type; ?>"
                               data-arg2="<?php echo $arg2 ?>"><?php echo $array['name']; ?></a>
                ...
                if ($ultimatemember->builtin->predefined_fields) {
                    foreach ($ultimatemember->builtin->predefined_fields as $field_key => $array) {
                        ...
                        if (!isset($array['account_only']) && !isset($array['private_use'])) {
                            ...
                            <a href="#" class="button" data-silent_action="um_admin_add_field_from_predefined"
                               data-arg1="<?php echo $field_key; ?>"
                               data-arg2="<?php echo $arg2; ?>"><?php echo um_trim_string(stripslashes($array['title']), 20); ?></a>
            ...
            <div class="um-admin-btns">
                ...
                if ($ultimatemember->builtin->custom_fields) {
                    foreach ($ultimatemember->builtin->custom_fields as $field_key => $array) {
                        ...
                        <a href="#" class="button with-icon" data-silent_action="um_admin_add_field_from_list"
                           data-arg1="<?php echo $field_key; ?>"
                           data-arg2="<?php echo $arg2; ?>"><?php echo um_trim_string(stripslashes($array['title']), 20); ?>
        ...
        case 'um_admin_edit_field_popup':
            ...
            if (!isset($col1)) {
                ...
                <?php if (isset($metabox->edit_array['in_group'])) { ?>
                    <input type="hidden" name="_in_row" id="_in_row"
                           value="<?php echo $metabox->edit_array['in_row']; ?>"/>
                    <input type="hidden" name="_in_sub_row" id="_in_sub_row"
                           value="<?php echo $metabox->edit_array['in_sub_row']; ?>"/>
                    <input type="hidden" name="_in_column" id="_in_column"
                           value="<?php echo $metabox->edit_array['in_column']; ?>"/>
                    <input type="hidden" name="_in_group" id="_in_group"
                           value="<?php echo $metabox->edit_array['in_group']; ?>"/>
                <?php } ?>
                ...
                <input type="hidden" name="_metakey" id="_metakey"
                       value="<?php echo $metabox->edit_array['metakey']; ?>"/>

                <input type="hidden" name="_position" id="_position"
                       value="<?php echo $metabox->edit_array['position']; ?>"/>

                <?php if (isset($args['mce_content'])) { ?>
                    <div class="dynamic-mce-content"><?php echo $metabox->edit_array['content']; ?></div><?php } ?>
                ...
                <div class="um-admin-half">
                    ...
                    <?php if (isset($col1)) {
                        foreach ($col1 as $opt) $metabox->field_input($opt);
                    } ?>
                ...
                <div class="um-admin-half um-admin-right">
                    ...
                    <?php if (isset($col2)) {
                        foreach ($col2 as $opt) $metabox->field_input($opt);
                    } ?>
                ...
                <?php if (isset($col3)) {
                    foreach ($col3 as $opt) $metabox->field_input($opt);
                } ?>

                <div class="um-admin-clear"></div>

                <?php if (isset($col_full)) {
                    foreach ($col_full as $opt) $metabox->field_input($opt);
                } ?>
