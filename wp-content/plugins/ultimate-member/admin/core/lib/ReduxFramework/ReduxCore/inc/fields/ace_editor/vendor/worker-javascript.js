    ...
    n.exports = function r(t, n, i) {
            ...
            var r = e("underscore"), i = e("events"), s = e("./vars.js"), o = e("./messages.js"), u = e("./lex.js").Lexer, a = e("./reg.js"), f = e("./state.js").state, l = e("./style.js"), c = function () {
                ...
                function Yt() {
                    ...
                    if (f.tokens.next.value === "[") {
                        ...
                        while (f.tokens.next.value !== "}")rt(","), e = _t(), f.tokens.next.value === ":" ? (rt(":"), i()) : n.push({
                            id: e,
                            token: f.tokens.curr
                        });
                        rt("}")
                ...
                var e, t, n = {
                    ...
                    eqeqeq: !0,
                    strict: !0
                }, v = {eqeq: "eqeqeq", windows: "wsh", sloppy: "strict"}, m = {
                    nomen: !0,
                    onevar: !0,
                    passfail: !0,
                    white: !0,
                ...
                nn.exps = !0, dt("class", function () {
                    ...
                    return w[t] === "const" && K("E011", null, t), et(t, {
                        type: "unction",
                        token: f.tokens.curr
                    }), Jt(t, {statement: !0}, e), f.tokens.next.id === "(" && f.tokens.next.line === f.tokens.curr.line && G("E039"), this
                    ...
                    es5: !0,
                    strictOnly: !0
                }), bt("import", {es5: !0}), bt("int"), bt("interface", {
                    es5: !0,
                    strictOnly: !0
                }), bt("long"), bt("native"), bt("package", {es5: !0, strictOnly: !0}), bt("private", {
                    es5: !0,
                    strictOnly: !0
                }), bt("protected", {es5: !0, strictOnly: !0}), bt("public", {
                    es5: !0,
                    strictOnly: !0
                }), bt("short"), bt("static", {
                    es5: !0,
                    strictOnly: !0
                }), bt("super", {es5: !0}), bt("synchronized"), bt("transient"), bt("volatile");
                var on = function () {
                    var e, t, n = -1, i = 0, s = {};
                    ...
                    e:while (this.peek() !== t) {
                        while (this.peek() === "") {
                            ...
                            if (!this.nextLine())return this.trigger("error", {
                                ...
                                line: r,
                                character: i
                            }), {type: l.StringLiteral, value: n, isUnclosed: !0, quote: t};
        ...
        9: [function (e, t, n) {
            ...
            n.reservedVars = {arguments: !1, NaN: !1}, n.ecmaIdentifiers = {
                ...
                opera: !1,
                prompt: !1
            }, n.worker = {importScripts: !0, postMessage: !0, self: !0}, n.nonstandard = {
                escape: !1,
                unescape: !1
            }, n.couch = {
                require: !1,
