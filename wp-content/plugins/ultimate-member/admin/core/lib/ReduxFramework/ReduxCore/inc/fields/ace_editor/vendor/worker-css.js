...
(function (e) {
            ...
            var e = new EventTarget, t, n = {
                ...
                _font_face: function () {
                    ...
                    e.mustMatch(Tokens.FONT_FACE_SYM), t = e.token().startLine, n = e.token().startCol, this._readWhitespace(), this.fire({
                        ...
                        line: t,
                        col: n
                    }), this._readDeclarations(!0), this.fire({type: "endfontface", line: t, col: n})
                },
                _viewport: function () {
                    var e = this._tokenStream, t, n;
                    e.mustMatch(Tokens.VIEWPORT_SYM), t = e.token().startLine, n = e.token().startCol, this._readWhitespace(), this.fire({
                        ...
                        line: t,
                        col: n
                    }), this._readDeclarations(!0), this.fire({type: "endviewport", line: t, col: n})
                },
    ...
    var CSSLint = function () {
        ...
        return r.version = "@VERSION@", r.addRule = function (t) {
            ...
            var s = 0, o, u, a, f = new parserlib.css.Parser({
                starHack: !0,
                ieFilters: !0,
                underscoreHack: !0,
                strict: !1
