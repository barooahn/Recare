...
!function (e, t) {
    ...
    r(l, [], function () {
        ...
        return l.prototype = {
            setCursorLocation: function (e, t) {
                ...
                if (n.caretPositionFromPoint)i = n.caretPositionFromPoint(e, t), r = n.createRange(),
                    r.setStart(i.offsetNode, i.offset), r.collapse(!0); else if (n.caretRangeFromPoint)r = n.caretRangeFromPoint(e, t); else if (n.body.createTextRange) {
                    r = n.body.createTextRange();
                    try {
                        r.moveToPoint(e, t), r.collapse(!0)
                    } catch (o) {
            ...
            function o(o) {
                ...
                if (R = s.getRng(!0), !o.isDefaultPrevented()) {
                    ...
                    if (new t(a).normalize(R), D = R.startContainer, L = R.startOffset, V = (l.force_p_newlines ? "p" : "") || l.forced_root_block, V = V ? V.toUpperCase() : "", H = a.doc.documentMode, P = o.shiftKey, 1 == D.nodeType && D.hasChildNodes() && (U = L > D.childNodes.length - 1, D = D.childNodes[Math.min(L, D.childNodes.length - 1)] || D, L = U && 3 == D.nodeType ? D.nodeValue.length : 0), B = S(D)) {
                        ...
                        V && M === i.getBody() || (V = V || "P",
                            C() ? T() : C(!0) ? (O = M.parentNode.insertBefore(x(), M), m(O), v(M)) : (A = R.cloneRange(), A.setEndAfter(M), I = A.extractContents(), N(I), O = I.firstChild, a.insertAfter(I, M), g(O), k(M), a.isEmpty(M) && b(M), a.isEmpty(O) ? (a.remove(O), T()) : v(O)), a.setAttrib(O, "id", ""), i.fire("NewBlock", {newBlock: O}), c.add())
                    }
                }
            }
        ...
        return function (l) {
            ...
            var j = s.each, K = l.$, Y = e.BACKSPACE, G = e.DELETE, X = l.dom, J = l.selection, Q = l.settings, Z = l.parser, ee = l.serializer, te = a.gecko, ne = a.ie, re = a.webkit, ie = "data:text/mce-internal,", oe = ne ? "Text" : "URL";
        ...
        return e.extend({
            recalc: function (e) {
                var t, n, r, i, o, a, s, l, c, u, d, f, h, p, m, g, v, y, b, x, C, w, _, E = [], N = [], S, k, T, R, A, B;
