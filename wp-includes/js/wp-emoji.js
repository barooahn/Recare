        ...
        function parse(object, args) {
            ...
            params = {
                ...
                callback: function (icon, options) {
                    ...
                    if (!settings.supports.flag && settings.supports.simple && settings.supports.unicode8 && settings.supports.diversity && !/^1f1(?:e[6-9a-f]|f[0-9a-f])-1f1(?:e[6-9a-f]|f[0-9a-f])$/.test(icon)) {
